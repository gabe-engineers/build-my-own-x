...
def check_significant_strides(a: TensorLikeType, b: TensorLikeType, *, only_cuda=..., allow_rhs_unbacked=...) -> tuple[bool, int | None]:
    ...
...
def reduction_dtypes(arg, output_dtype_kind: REDUCTION_OUTPUT_TYPE_KIND, dtype: torch.dtype | None = ...) -> tuple[torch.dtype, torch.dtype | None]:
    ...

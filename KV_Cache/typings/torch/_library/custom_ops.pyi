...
log = ...
@overload
def custom_op(name: str, fn: None = ..., /, *, mutates_args: str | Iterable[str], device_types: device_types_t = ..., schema: str | None = ..., tags: Sequence[_C.Tag] | None = ...) -> Callable[[Callable[..., object]], CustomOpDef]:
    ...

@overload
def custom_op(name: str, fn: Callable[..., object], /, *, mutates_args: str | Iterable[str], device_types: device_types_t = ..., schema: str | None = ..., tags: Sequence[_C.Tag] | None = ...) -> CustomOpDef:
    ...

@exposed_in("torch.library")
def custom_op(name: str, fn: Callable | None = ..., /, *, mutates_args: str | Iterable[str], device_types: device_types_t = ..., schema: str | None = ..., tags: Sequence[_C.Tag] | None = ...) -> Union[Callable[[Callable[..., object]], CustomOpDef], CustomOpDef]:
...
class CustomOpDef:
    ...
    """
    def __init__(self, namespace: str, name: str, schema: str, fn: Callable, tags: Sequence[_C.Tag] | None = ...) -> None:
        ...

...
ReconstructFn: TypeAlias = Callable[[OpaqueBase, Callable[[OpaqueBase], "Proxy | None"], "PythonKeyTracer"], "Proxy | None",]
@dataclass
...
def register_opaque_type(cls: Any, *, typ: str, hoist=..., guard_fn: Any = ..., members: dict[str, MemberType] | None = ..., reconstruct_fn: ReconstructFn | None = ...) -> None:
    """

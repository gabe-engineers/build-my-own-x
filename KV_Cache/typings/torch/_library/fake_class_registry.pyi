...
class FakeScriptObject:
    def __init__(self, wrapped_obj: Any, script_class_name: str, x: torch.ScriptObject | None) -> None:
        ...
...
def maybe_to_fake_obj(fake_mode, x: Any) -> FakeScriptObject | torch.ScriptObject:
    ...

def register_fake_class(qualname, fake_class: HasStaticMethodFromReal | None = ...): # -> Callable[..., HasStaticMethodFromReal] | HasStaticMethodFromReal:

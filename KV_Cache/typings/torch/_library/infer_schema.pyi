...
def derived_types(base_type: type | typing._SpecialForm, cpp_type: str, list_base: bool, optional_base_list: bool, optional_list_base: bool): # -> list[tuple[type | _SpecialForm | GenericAlias, str]]:
    ...

...
def aten_group_norm(input: TFloat, num_groups: int, weight: TFloat | None = ..., bias: TFloat | None = ..., eps: float = ..., cudnn_enabled: bool = ...) -> TFloat:
...
def aten_rms_norm(input: TFloat, normalized_shape: Sequence[int], weight: TFloat | None = ..., eps: float | None = ...) -> TFloat:
...
def aten_scaled_dot_product_attention_23(query: TFloat, key: TFloat, value: TFloat, attn_mask: TFloat | None = ..., dropout_p: float = ..., is_causal: bool = ..., scale: float | None = ..., enable_gqa: bool = ...) -> TFloat:

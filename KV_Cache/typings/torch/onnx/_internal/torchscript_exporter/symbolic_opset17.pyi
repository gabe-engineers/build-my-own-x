...
def layer_norm(g: jit_utils.GraphContext, input: _C.Value, normalized_shape: Sequence[int], weight: _C.Value, bias: _C.Value, eps: float, cudnn_enable: bool): # -> Value | tuple[Value, ...]:
    ...
...
def stft(g: jit_utils.GraphContext, input: _C.Value, n_fft: int, hop_length: int | None = ..., win_length: int | None = ..., window: _C.Value | None = ..., normalized: bool = ..., onesided: bool | None = ..., return_complex: bool | None = ..., align_to_window: bool | None = ...) -> _C.Value:

...
class GraphContext:
    ...
    def op(self, opname: str, *raw_args: torch.Tensor | _C.Value, outputs: int = ..., **kwargs): # -> Value | tuple[Value, ...]:
    ...
    def aten_op(self, operator: str, *args, overload_name: str = ..., **kwargs): # -> Value | tuple[Value, ...]:
    ...
    at = ...
    def onnxscript_op(self, onnx_fn, *raw_args: torch.Tensor | _C.Value, outputs: int = ..., **kwargs): # -> Value | tuple[Value, ...]:

...
@symbolic_helper.parse_args("v", "i", "none")
def log_softmax(g: jit_utils.GraphContext, input, dim, dtype=...): # -> Value | tuple[Value, ...]:
    ...
...
def unsafe_split(g: jit_utils.GraphContext, self, split_size_or_sizes, dim, _outputs=...): # -> Value | tuple[Value, ...] | list[Any] | list[Value | tuple[Value, ...]]:
    ...

@_onnx_symbolic("aten::unsafe_split_with_sizes")
def unsafe_split_with_sizes(g: jit_utils.GraphContext, self, split_sizes, dim, _outputs=...): # -> Value | tuple[Value, ...] | list[Any] | list[Value | tuple[Value, ...]]:
    ...

@_onnx_symbolic("aten::tensor_split")
@symbolic_helper.parse_args("v", "v", "i", "i")
def tensor_split(g: jit_utils.GraphContext, self, indices_or_sections, dim, _outputs=...): # -> list[Any] | Value | tuple[Value, ...]:
    ...
...
def nonzero_numpy(g: jit_utils.GraphContext, input, _outputs=...): # -> Value | tuple[Value, ...] | list[Value | tuple[Value, ...]]:
    ...
...
def fake_quantize_per_channel_affine(g: jit_utils.GraphContext, inputs, scale, zero_point, axis, quant_min=..., quant_max=...): # -> Value | tuple[Value, ...]:
    ...

@_onnx_symbolic("aten::fake_quantize_per_tensor_affine")
@symbolic_helper.parse_args("v", "v", "v", "i", "i")
def fake_quantize_per_tensor_affine(g: jit_utils.GraphContext, inputs, scale, zero_point, quant_min=..., quant_max=...): # -> Value | tuple[Value, ...]:
    ...

@_onnx_symbolic("aten::unflatten")
def unflatten(g: jit_utils.GraphContext, input, dim, unflattened_size): # -> Value | tuple[Value, ...] | None:
    ...
...
def tile(g: jit_utils.GraphContext, self, dims): # -> Value | tuple[Value, ...]:
    ...

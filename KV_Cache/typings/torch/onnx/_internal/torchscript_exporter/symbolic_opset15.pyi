...
def aten__is_(g: jit_utils.GraphContext, self, other): # -> Value | tuple[Value, ...]:
    ...

@_onnx_symbolic("aten::__isnot_")
@opset9.wrap_logical_op_with_negation
def aten__isnot_(g: jit_utils.GraphContext, self, other): # -> Value | tuple[Value, ...]:
    ...
...
def prim_unchecked_cast(g: jit_utils.GraphContext, self): # -> Value | tuple[Value, ...]:
    ...

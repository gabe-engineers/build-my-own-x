...
def slice(g: jit_utils.GraphContext, self, *args): # -> Value | tuple[Value, ...]:
    ...

@_onnx_symbolic("aten::flip")
@symbolic_helper.parse_args("v", "is")
def flip(g: jit_utils.GraphContext, input, dims): # -> Value | tuple[Value, ...]:
    ...

@_onnx_symbolic("aten::fmod")
def fmod(g: jit_utils.GraphContext, input, other): # -> Value | tuple[Value, ...]:
    ...

@_onnx_symbolic("aten::embedding_bag")
@symbolic_helper.parse_args("v", "v", "v", "i", "i", "i", "v", "i", "i")
def embedding_bag(g: jit_utils.GraphContext, embedding_matrix, indices, offsets, scale_grad_by_freq, mode, sparse, per_sample_weights, include_last_offset, padding_idx): # -> tuple[Value | tuple[Value, ...], None, None, None]:
    ...
...
def isinf(g: jit_utils.GraphContext, input): # -> Value | tuple[Value, ...]:
    ...

@_onnx_symbolic("aten::isfinite")
def isfinite(g: jit_utils.GraphContext, input): # -> Value | tuple[Value, ...]:
    ...
...
def nan_to_num(g: jit_utils.GraphContext, input, nan, posinf, neginf): # -> Value | tuple[Value, ...]:
    ...

...
def vector_norm(x: TensorLikeType, ord: float | int = ..., dim: DimsType | None = ..., keepdim: bool = ..., *, dtype: torch.dtype | None = ...) -> Tensor:
    ...

@out_wrapper(exact_dtype=True)
def matrix_norm(A: TensorLikeType, ord: float | str = ..., dim: DimsType = ..., keepdim: bool = ..., *, dtype: torch.dtype | None = ...) -> TensorLikeType:
    ...

@out_wrapper(exact_dtype=True)
def norm(A: TensorLikeType, ord: float | str | None = ..., dim: DimsType | None = ..., keepdim: bool = ..., *, dtype: torch.dtype | None = ...) -> TensorLikeType:
    ...

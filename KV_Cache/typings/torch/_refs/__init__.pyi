...
@out_wrapper()
def nan_to_num(a: TensorLikeType, nan: NumberType | None = ..., posinf: NumberType | None = ..., neginf: NumberType | None = ...) -> TensorLikeType:
    ...
...
@out_wrapper()
def div(a: TensorLikeType | NumberType, b: TensorLikeType | NumberType, *, rounding_mode: str | None = ...): # -> TensorLikeType | Any | None:
    """
...
def clamp(a: TensorLikeType, min: TensorOrNumberLikeType | None = ..., max: TensorOrNumberLikeType | None = ...) -> TensorLikeType:
    ...
...
def sum(a: TensorLikeType, dim: int | None | list[int] = ..., keepdim: bool = ..., *, dtype: torch.dtype | None = ..., out: Tensor | None = ...) -> TensorLikeType:
    ...
...
def prod(a: TensorLikeType, dim: int | None | list[int] = ..., keepdim: bool = ..., *, dtype=..., out: Tensor | None = ...) -> TensorLikeType:
    ...

@register_decomposition(aten.amin)
def amin(a: TensorLikeType, dim: DimsType | None = ..., keepdim: bool = ..., *, out: Tensor | None = ...) -> TensorLikeType:
    ...

@register_decomposition(aten.amax)
def amax(a: TensorLikeType, dim: DimsType | None = ..., keepdim: bool = ..., *, out: Tensor | None = ...) -> TensorLikeType:
    ...

@register_decomposition(aten.var)
@out_wrapper()
def var(a: TensorLikeType, dim: DimsType | None = ..., unbiased: bool | None = ..., keepdim: bool = ..., *, correction: NumberType | None = ...) -> TensorLikeType:
    ...

@register_decomposition(aten.std)
@out_wrapper()
def std(a: TensorLikeType, dim: int | None | list[int] = ..., unbiased: bool | None = ..., keepdim: bool = ..., *, correction: NumberType | None = ...) -> TensorLikeType:
    ...

@register_decomposition(aten.mean)
def mean(a: TensorLikeType, dim: DimsType | None = ..., keepdim: bool = ..., *, dtype=..., out=...) -> TensorLikeType:
    ...

@register_decomposition(aten.std_mean)
@out_wrapper("out0", "out1")
def std_mean(a: TensorLikeType, dim: DimsType | None = ..., *, unbiased: bool | None = ..., keepdim: bool = ..., correction: NumberType | None = ...): # -> tuple[TensorLikeType, TensorLikeType]:
    ...

@register_decomposition(aten.var_mean)
@out_wrapper("out0", "out1")
def var_mean(a: TensorLikeType, dim: DimsType | None = ..., unbiased: bool | None = ..., keepdim: bool = ..., *, correction: NumberType | None = ...): # -> tuple[TensorLikeType, TensorLikeType]:
    ...
...
def as_strided(a: TensorLikeType, size: ShapeType, stride: StrideType, storage_offset: int | None = ...) -> TensorLikeType:
    ...

@register_decomposition(aten.as_strided_scatter)
@out_wrapper()
def as_strided_scatter(input: TensorLikeType, src: TensorLikeType, size: ShapeType, stride: StrideType, storage_offset: int | None = ...) -> TensorLikeType:
    ...
...
def istft(input: Tensor, n_fft: int, hop_length: int | None = ..., win_length: int | None = ..., window: Tensor | None = ..., center: bool = ..., normalized: bool = ..., onesided: bool | None = ..., length: int | None = ..., return_complex=...) -> Tensor:
    ...
...
@out_wrapper()
def index_fill(x: TensorLike, dim: int, index: TensorLike, value: NumberType | TensorLike): # -> TensorLike | Any:
    ...

@register_decomposition(aten.index_fill_)
def index_fill_(x: TensorLike, dim: int, index: TensorLike, value: NumberType | TensorLike): # -> TensorLike | Any:
    ...
...
def tensor_split(a: TensorLikeType, indices_or_sections: Tensor | DimsType, dim: int = ...) -> tuple[TensorLikeType, ...]:
    ...
...
def cumsum(a: TensorLikeType, dim: int, *, dtype: torch.dtype | None = ..., out: Tensor | None = ...) -> TensorLikeType:
    ...

@register_decomposition(aten.cumprod)
def cumprod(a: TensorLikeType, dim: int, *, dtype: torch.dtype | None = ..., out: Tensor | None = ...) -> TensorLikeType:
    ...
...
@out_wrapper()
def empty(*shape, dtype: torch.dtype | None = ..., layout: torch.layout = ..., device: DeviceLikeType | None = ..., requires_grad: bool = ..., pin_memory: bool = ..., memory_format: torch.memory_format = ...) -> TensorLikeType:
    ...

@out_wrapper()
def empty_permuted(shape, physical_layout, dtype: torch.dtype | None = ..., layout: torch.layout = ..., device: DeviceLikeType | None = ..., requires_grad: bool = ..., pin_memory: bool = ...) -> TensorLikeType:
    ...

@register_decomposition(aten.new_empty)
@out_wrapper()
def new_empty(a: TensorLikeType, size: ShapeType, *, dtype: torch.dtype | None = ..., layout: torch.layout | None = ..., device: DeviceLikeType | None = ..., pin_memory: bool = ...) -> TensorLikeType:
    ...

@register_decomposition(aten.new_empty_strided)
@out_wrapper()
def new_empty_strided(a: TensorLikeType, size: ShapeType, stride: StrideType, *, dtype: torch.dtype | None = ..., layout: torch.layout | None = ..., device: DeviceLikeType | None = ..., pin_memory: bool = ...) -> TensorLikeType:
    """
...
@out_wrapper()
def zeros(*size, dtype: torch.dtype | None = ..., layout: torch.layout = ..., device: DeviceLikeType | None = ..., pin_memory: bool = ..., requires_grad: bool = ...) -> TensorLikeType:
    ...

@register_decomposition(aten.new_zeros)
@out_wrapper()
def new_zeros(a: TensorLikeType, size: ShapeType, *, dtype: torch.dtype | None = ..., layout: torch.layout | None = ..., device: DeviceLikeType | None = ..., pin_memory: bool = ..., requires_grad: bool = ...) -> TensorLikeType:
    ...

@register_decomposition(aten.ones.default)
@out_wrapper()
def ones(*size, dtype: torch.dtype | None = ..., layout: torch.layout = ..., device: DeviceLikeType | None = ..., pin_memory: bool = ..., requires_grad: bool = ...) -> TensorLikeType:
    ...

@register_decomposition(aten.new_ones)
@out_wrapper()
def new_ones(a: TensorLikeType, size: ShapeType, *, dtype: torch.dtype | None = ..., layout: torch.layout | None = ..., device: DeviceLikeType | None = ..., pin_memory: bool = ..., requires_grad: bool = ...) -> TensorLikeType:
    ...

@register_decomposition(aten.new_full)
@out_wrapper()
def new_full(a: TensorLikeType, size: ShapeType, fill_value: NumberType, *, dtype: torch.dtype | None = ..., layout: torch.layout | None = ..., device: DeviceLikeType | None = ..., pin_memory: bool = ...) -> TensorLikeType:
    ...

@aten.empty.out.py_impl(DispatchKey.CompositeImplicitAutograd)
def empty_out(size: TensorLikeType, out: TensorLikeType, memory_format: torch.memory_format | None = ...) -> TensorLikeType:
    ...

@register_decomposition(aten.empty_like)
@out_wrapper()
def empty_like(a: TensorLikeType, *, dtype: torch.dtype | None = ..., device: DeviceLikeType | None = ..., layout: torch.layout | None = ..., pin_memory: bool = ..., requires_grad: bool = ..., memory_format: torch.memory_format = ...) -> TensorLikeType:
    ...

@register_decomposition([aten.arange.start_step, aten.arange.start_out])
@out_wrapper()
def arange(start: NumberType = ..., end: NumberType | None = ..., step: NumberType = ..., *, dtype: torch.dtype | None = ..., layout: torch.layout = ..., device: DeviceLikeType | None = ..., pin_memory: bool = ..., requires_grad: bool = ...) -> TensorLikeType:
    ...
...
@out_wrapper()
def linspace(start: NumberType | TensorLikeType, end: NumberType | TensorLikeType, steps: NumberType, *, dtype: torch.dtype | None = ..., device: DeviceLikeType | None = ..., layout: torch.layout = ..., pin_memory: bool = ..., requires_grad: bool = ...) -> TensorLikeType:
    ...

@register_decomposition(aten.logspace)
@out_wrapper()
def logspace(start: NumberType | TensorLikeType, end: NumberType | TensorLikeType, steps: NumberType, base: NumberType = ..., *, dtype: torch.dtype | None = ..., device: DeviceLikeType | None = ..., layout: torch.layout = ..., pin_memory: bool = ..., requires_grad: bool = ...) -> TensorLikeType:
    ...
...
def meshgrid(*tensors: TensorLikeType | list[TensorLikeType] | tuple[TensorLikeType], indexing: str) -> list[TensorLikeType]:
    ...
...
@out_wrapper()
def empty_strided(shape: ShapeType | tuple[ShapeType], strides: StrideType, *, dtype: torch.dtype | None = ..., device: DeviceLikeType | None = ..., layout: torch.layout = ..., requires_grad: bool = ..., pin_memory: bool = ...) -> TensorLikeType:
    ...

@register_decomposition(aten.eye)
@out_wrapper()
def eye(n: int, m: int | None = ..., *, dtype: torch.dtype | None = ..., layout: torch.layout = ..., device: DeviceLikeType | None = ..., pin_memory: bool = ..., requires_grad: bool = ...) -> TensorLikeType:
    """
...
@out_wrapper()
def full(shape: ShapeType, fill_value: NumberType, *, dtype: torch.dtype | None = ..., layout: torch.layout = ..., device: DeviceLikeType | None = ..., pin_memory: bool = ..., requires_grad: bool = ...) -> TensorLikeType:
    ...

def full_like(a: TensorLikeType, fill_value: NumberType, *, dtype: torch.dtype | None = ..., layout: torch.layout | None = ..., device: DeviceLikeType | None = ..., pin_memory: bool = ..., requires_grad: bool = ..., memory_format: torch.memory_format = ...) -> TensorLikeType:
    ...

@register_decomposition(aten.zeros_like)
@out_wrapper()
def zeros_like(a: TensorLikeType, *, dtype: torch.dtype | None = ..., layout: torch.layout | None = ..., device: DeviceLikeType | None = ..., pin_memory: bool = ..., requires_grad: bool = ..., memory_format: torch.memory_format = ...) -> TensorLikeType:
    ...

@register_decomposition(aten.ones_like)
@out_wrapper()
def ones_like(a: TensorLikeType, *, dtype: torch.dtype | None = ..., layout: torch.layout | None = ..., device: DeviceLikeType | None = ..., pin_memory: bool = ..., requires_grad: bool = ..., memory_format: torch.memory_format = ...) -> TensorLikeType:
    ...

@register_decomposition(aten.randn.default)
@out_wrapper()
def randn(*shape, dtype: torch.dtype | None = ..., device: DeviceLikeType | None = ..., layout: torch.layout | None = ..., requires_grad: bool = ..., pin_memory: bool = ...) -> TensorLikeType:
    ...

def scalar_tensor(a: NumberType, *, dtype: torch.dtype | None = ..., layout: torch.layout = ..., device: DeviceLikeType | None = ..., pin_memory: bool = ...) -> TensorLikeType:
    ...
...
@out_wrapper(exact_dtype=True)
def norm(input: TensorLikeType, p: float | str | None = ..., dim: DimsType | None = ..., keepdim: bool = ..., *, dtype: torch.dtype | None = ...) -> TensorLikeType:
    ...

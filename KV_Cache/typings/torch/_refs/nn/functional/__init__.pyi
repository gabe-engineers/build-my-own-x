...
def layer_norm(input: Tensor, normalized_shape: ShapeType, weight: Tensor | None = ..., bias: Tensor | None = ..., eps: float = ...) -> Tensor:
    """
...
def softmax(a: TensorLikeType, dim: int | None = ..., _stacklevel: int = ..., dtype: torch.dtype | None = ...) -> TensorLikeType:
    ...

def softmin(a: TensorLikeType, dim: int | None = ..., _stacklevel: int = ..., dtype: torch.dtype | None = ...) -> TensorLikeType:
    ...
...
@out_wrapper()
@elementwise_type_promotion_wrapper(type_promoting_args=("a", ), type_promotion_kind=ELEMENTWISE_TYPE_PROMOTION_KIND.DEFAULT)
def softplus(a: TensorLikeType, beta: NumberType | None = ..., threshold: NumberType = ..., inplace: bool = ...) -> TensorLikeType:
    """
...
def l1_loss(input: TensorLikeType, target: TensorLikeType, size_average: bool | None = ..., reduce: bool | None = ..., reduction: str = ...) -> TensorLikeType:
    """
...
@elementwise_type_promotion_wrapper(type_promoting_args=("input", "target"), type_promotion_kind=ELEMENTWISE_TYPE_PROMOTION_KIND.COMPLEX_TO_FLOAT)
def smooth_l1_loss(input: TensorLikeType, target: TensorLikeType, size_average: bool | None = ..., reduce: bool | None = ..., reduction: str = ..., beta: float = ...) -> TensorLikeType:
    """
    Reference implementation of torch.nn.functional.smooth_l1_loss
    """
    ...

def log_softmax(a: TensorLikeType, dim: int | None = ..., _stacklevel: int = ..., dtype: torch.dtype | None = ...) -> TensorLikeType:
    ...
...
@elementwise_type_promotion_wrapper(type_promoting_args=("input", "target"), type_promotion_kind=ELEMENTWISE_TYPE_PROMOTION_KIND.COMPLEX_TO_FLOAT)
def mse_loss(input: TensorLikeType, target: TensorLikeType, size_average: bool | None = ..., reduce: bool | None = ..., reduction: str = ...) -> TensorLikeType:
    ...
...
def nll_loss(input: TensorLikeType, target: TensorLikeType, weight: TensorLikeType | None = ..., size_average: bool | None = ..., ignore_index: int = ..., reduce: bool | None = ..., reduction: str = ...) -> TensorLikeType:
    """
...
def huber_loss(input: TensorLikeType, target: TensorLikeType, reduction: str | int = ..., delta: float = ...) -> TensorLikeType:
    """
...
@out_wrapper()
@elementwise_type_promotion_wrapper(type_promoting_args=("a", ), type_promotion_kind=ELEMENTWISE_TYPE_PROMOTION_KIND.DEFAULT)
def threshold(a: TensorLikeType, threshold: NumberType, value: bool | int | float, inplace: bool = ...) -> TensorLikeType:
    """
    Reference implementation of torch.nn.functional.threshold
    """
    ...

def triplet_margin_loss(anchor: TensorLikeType, positive: TensorLikeType, negative: TensorLikeType, margin: float = ..., p: float = ..., eps: float = ..., swap: bool = ..., size_average: bool | None = ..., reduce: bool | None = ..., reduction: str = ...) -> TensorLikeType:
    ...
...
def poisson_nll_loss(input: TensorLikeType, target: TensorLikeType, log_input: bool = ..., full: bool = ..., size_average: bool | None = ..., eps: float = ..., reduce: bool | None = ..., reduction: str = ...) -> TensorLikeType:
    """

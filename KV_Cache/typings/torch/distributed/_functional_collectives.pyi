...
RANK_TYPES = (list[int] | list[list[int]] | dist.ProcessGroup | DeviceMesh | tuple["dist.tensor.DeviceMesh", int] | c10d.GroupName)
...
def isend_inplace(tensor: torch.Tensor, dst: int, tag: int = ..., group: dist.ProcessGroup | None = ..., group_dst: int = ...): # -> Tensor:
    ...

def irecv_inplace(tensor: torch.Tensor, src: int, tag: int = ..., group: dist.ProcessGroup | None = ..., group_src: int = ...): # -> Tensor:
    ...

def batch_p2p_ops_inplace(op_list: list[str], peer_list: list[int], tag_list: list[int], tensors: list[torch.Tensor], group_name: RANK_TYPES): # -> list[Tensor]:
    ...

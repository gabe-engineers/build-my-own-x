...
from ._fsdp_common import DataParallelMeshInfo, FSDPMeshInfo, ShardPlacementFnResult

_orig_param_uid_counter = ...
lib = ...
...
class FSDPParam:
    ...
    _unsharded_dtensor_spec: (DTensorSpec | None)
    all_gather_outputs: list[torch.Tensor]
    _extensions_data: ExtensionsData
    _unsharded_inner_tensors: list[torch.Tensor]
    _orig_param_uid: int
    def __init__(self, param: nn.Parameter, module_info: ParamModuleInfo, mesh_info: DataParallelMeshInfo, post_forward_mesh_info: FSDPMeshInfo | None, device: torch.device, shard_placement_fn: Callable[[nn.Parameter], ShardPlacementFnResult] | None, mp_policy: MixedPrecisionPolicy, offload_policy: OffloadPolicy) -> None:
        ...

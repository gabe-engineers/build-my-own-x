...
from ._fsdp_api import AllGather, DataParallelMeshDims, MixedPrecisionPolicy, OffloadPolicy, ReduceScatter
...
@overload
def fully_shard(module: nn.Module, *, mesh: DeviceMesh | None = ..., reshard_after_forward: bool | int | None = ..., shard_placement_fn: Callable[[nn.Parameter], ShardPlacementFnResult] | None = ..., mp_policy: MixedPrecisionPolicy = ..., offload_policy: OffloadPolicy = ..., ignored_params: set[nn.Parameter] | None = ..., dp_mesh_dims: DataParallelMeshDims | None = ...) -> FSDPModule:
    ...

@overload
def fully_shard(module: list[nn.Module], *, mesh: DeviceMesh | None = ..., reshard_after_forward: bool | int | None = ..., shard_placement_fn: Callable[[nn.Parameter], ShardPlacementFnResult] | None = ..., mp_policy: MixedPrecisionPolicy = ..., offload_policy: OffloadPolicy = ..., ignored_params: set[nn.Parameter] | None = ..., dp_mesh_dims: DataParallelMeshDims | None = ...) -> list[FSDPModule]:
    ...

@contract(state_cls=FSDPState)
def fully_shard(module, *, mesh: DeviceMesh | None = ..., reshard_after_forward: bool | int | None = ..., shard_placement_fn: Callable[[nn.Parameter], ShardPlacementFnResult] | None = ..., mp_policy: MixedPrecisionPolicy = ..., offload_policy: OffloadPolicy = ..., ignored_params: set[nn.Parameter] | None = ..., dp_mesh_dims: DataParallelMeshDims | None = ...): # -> Module:
    """
...
class FSDPModule:
    ...
    def set_symm_mem_for_comm(self, backend: Literal["NCCL"] = ...) -> None:
        """
...
class _UnshardHandleImpl(UnshardHandle):
    def __init__(self, fsdp_param_groups: list[FSDPParamGroup] | None) -> None:
        ...

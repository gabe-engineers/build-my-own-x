...
class SymmMemAllocMixin:
    def __init__(self, group: dist.ProcessGroup, backend: Literal["NCCL"] = ..., *args: Any, **kwargs: Any) -> None:
        ...
...
class SymmMemAllGather(SymmMemAllocMixin, AllGather):
    def __init__(self, group: dist.ProcessGroup, backend: Literal["NCCL"] = ...) -> None:
        ...

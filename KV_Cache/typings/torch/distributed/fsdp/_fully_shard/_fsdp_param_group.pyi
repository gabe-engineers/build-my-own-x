...
from ._fsdp_common import DataParallelMeshInfo, FSDPMeshInfo, ShardPlacementFnResult, TrainingState, _dynamo_disable
...
class FSDPParamGroup:
    ...
    def __init__(self, params: list[nn.Parameter], modules: tuple[nn.Module, ...], mesh_info: DataParallelMeshInfo, post_forward_mesh_info: FSDPMeshInfo | None, device: torch.device, shard_placement_fn: Callable[[nn.Parameter], ShardPlacementFnResult] | None, mp_policy: MixedPrecisionPolicy, offload_policy: OffloadPolicy) -> None:
        ...
    
    def lazy_init(self): # -> None:
        ...
    
    def set_symm_mem(self, backend: Literal["NCCL"] = ...) -> None:
        ...

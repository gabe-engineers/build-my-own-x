...
@_exception_logger
def all_reduce(tensor, op=..., group=..., async_op: bool = ...): # -> _IllegalWork | Work | None:
    """
...
@_exception_logger
def all_gather(tensor_list, tensor, group=..., async_op=...): # -> Work | None:
    """
...
@_exception_logger
def all_gather_into_tensor(output_tensor, input_tensor, group=..., async_op=...): # -> _IllegalWork | Work | None:
    """
...
@_exception_logger
def reduce_scatter_tensor(output, input, op=..., group=..., async_op=...): # -> _IllegalWork | Work | None:
    """
...
@_exception_logger
def all_to_all_single(output, input, output_split_sizes=..., input_split_sizes=..., group=..., async_op: bool = ...): # -> Work | None:
    """
...
@_exception_logger
def barrier(group: ProcessGroup | None = ..., async_op: bool = ..., device_ids=..., timeout: timedelta | None = ...): # -> Work | None:
    """
...
@_time_logger
def new_group(ranks=..., timeout=..., backend=..., pg_options=..., use_local_synchronization: bool = ..., group_desc=..., device_id: torch.device | None = ..., sort_ranks: bool = ...): # -> None:
    """
...
def record_comm(name: str): # -> Generator[None, Any, None]:

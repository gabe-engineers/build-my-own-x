...
if not is_available():
    ...
    class DeviceMesh(OpaqueBase):
        ...
        _layout: _MeshLayout
        _root_mesh: DeviceMesh | None = ...
        _thread_id: int | None
        _flatten_mapping: dict[str, DeviceMesh]
        _pg_registry: dict[str, ProcessGroup]
        def __init__(self, device_type: str, mesh: torch.Tensor | ArrayLike | None = ..., *, mesh_dim_names: tuple[str, ...] | None = ..., backend_override: tuple[BackendConfig, ...] | None = ..., _init_backend: bool = ..., _rank: int | None = ..., _layout: _MeshLayout | None = ..., _rank_map: torch.Tensor | None = ..., _root_mesh: DeviceMesh | None = ...) -> None:
            ...
        ...
        @staticmethod
        def from_group(group: ProcessGroup | list[ProcessGroup], device_type: str, mesh: torch.Tensor | ArrayLike | None = ..., *, mesh_dim_names: tuple[str, ...] | None = ...) -> DeviceMesh:
            """
...
_distributed_opaque_types_registered = ...

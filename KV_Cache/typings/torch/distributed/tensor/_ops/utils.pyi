...
def expand_to_full_mesh_op_strategy(mesh: DeviceMesh, op_schema: OpSchema, single_mesh_dim_strategies: list[PlacementList], *, output_tensor_meta: TensorMeta | Sequence[TensorMeta | None] | None = ..., input_index: int = ..., inplace_op: bool = ..., allow_unbacked_sharding: bool | None = ..., allow_uneven_sharding: bool = ..., is_valid_strategy_cb: Callable[[list[DTensorSpec], DTensorSpec | tuple[DTensorSpec | None, ...]], bool] | None = ..., different_mesh_args: list[int] | None = ...) -> OpStrategy:
    """

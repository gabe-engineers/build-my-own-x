...
def scaled_mm_single_dim_strategy(op: OpOverload, args_schema: ArgsType, kwargs_schema: KwargsType) -> list[list[Placement | _ShardingPlaceholder]]:
    ...
...
@register_single_dim_strategy(aten.constant_pad_nd.default, schema_info=RuntimeSchemaInfo(1))
def constant_pad_nd_single_dim_strategy(op: OpOverload, args_schema: ArgsType, kwargs_schema: KwargsType) -> list[list[Placement | _ShardingPlaceholder]]:
    ...

...
def local_map(func: Callable | None = ..., out_placements: OutputPlacements = ..., in_placements: InputPlacements = ..., in_grad_placements: InputPlacements = ..., device_mesh: DeviceMesh | None = ..., *, redistribute_inputs: bool = ...): # -> Callable[..., ... | partial[PyTree | Any]] | partial[PyTree | Any]:
    """

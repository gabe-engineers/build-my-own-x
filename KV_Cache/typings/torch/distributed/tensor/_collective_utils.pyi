...
def pad_tensor(tensor: torch.Tensor, pad_dim: int, pad_size: IntLikeType) -> torch.Tensor:
    ...

@maybe_run_for_local_tensor
def unpad_tensor(tensor: torch.Tensor, pad_dim: int, pad_size: IntLikeType) -> torch.Tensor:
    ...

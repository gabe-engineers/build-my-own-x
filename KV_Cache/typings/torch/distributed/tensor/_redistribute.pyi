...
class DTensorRedistributePlanner:
    ...
    def get_logical_shape(self, src_state: DTensorRedistributePlanner.DistState, mesh_dim: int, full_tensor_shape: tuple[int, ...]) -> list[IntLikeType]:
        ...
...
class Redistribute(torch.autograd.Function):
    ...
    @staticmethod
    def backward(ctx, grad_output: dtensor.DTensor): # -> tuple[Any, None, None, None, None, None]:
        ...
...
class NestedRedistribute(torch.autograd.Function):
    ...
    """
    @staticmethod
    def forward(ctx, grad_output: dtensor.DTensor, previous_spec: DTensorSpec, async_op: bool = ..., forward_dtype: torch.dtype | None = ..., backward_dtype: torch.dtype | None = ...): # -> DTensor:
        ...
    
    @staticmethod
    def backward(ctx, grad2_output: dtensor.DTensor): # -> tuple[Any, None, None, None, None, None]:
        ...

...
class _ToTorchTensor(torch.autograd.Function):
    ...
    @staticmethod
    def backward(ctx, grad_output: torch.Tensor | None): # -> tuple[None, None] | tuple[DTensor, None]:
        ...
...
class _FromTorchTensor(torch.autograd.Function):
    @staticmethod
    def forward(ctx, input: torch.Tensor, device_mesh: DeviceMesh, placements: tuple[Placement, ...], run_check: bool, shape: torch.Size | None = ..., stride: tuple[int, ...] | None = ..., grad_placements: tuple[Placement, ...] | None = ...) -> DTensor:
        ...
    
    @staticmethod
    def backward(ctx, grad_output: DTensor | None): # -> tuple[None, None, None, None, None, None, None] | tuple[Tensor, None, None, None, None, None, None]:
        ...
...
class DTensor(torch.Tensor):
    ...
    * :class:`Partial`: Tensor is pending reduction on the devices of the ``DeviceMesh`` dimension
    ...
    def __tensor_flatten__(self): # -> tuple[list[str], tuple[tuple[Placement, ...], TensorMeta | None, ShardOrder, bool]]:
        """
    ...
    @staticmethod
    def from_local(local_tensor: torch.Tensor, device_mesh: DeviceMesh | None = ..., placements: Sequence[Placement] | None = ..., *, run_check: bool = ..., shape: torch.Size | None = ..., stride: tuple[int, ...] | None = ..., grad_placements: Sequence[Placement] | None = ...) -> DTensor:
        """

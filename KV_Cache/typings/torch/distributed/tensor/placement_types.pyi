...
class Shard(torch._C._distributed.Shard):
    ...
    def local_shard_size_and_offset(curr_local_size: IntLikeType, num_chunks: int, rank: _RankTypeT) -> tuple[_RankTypeT, _RankTypeT]:
        """
    ...
    def __fx_repr__(self): # -> tuple[str, dict[Any, Any]]:
        """
...
class _StridedShard(torch._C._distributed.StridedShard):
    ...
    @maybe_run_for_local_tensor
    def local_shard_size_and_offset(self, curr_local_size: IntLikeType, num_chunks: int, rank: RankType, return_first_offset: bool = ...) -> tuple[int, list[int] | int]:
        """
...
class Replicate(torch._C._distributed.Replicate):
    ...
    def __fx_repr__(self): # -> tuple[LiteralString, dict[Any, Any]]:
        """

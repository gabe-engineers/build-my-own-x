...
class XPUGraph(_XPUGraph):
    ...
    def capture_begin(self, pool: _POOL_HANDLE | None = ...) -> None:
...
class graph:
    ...
    """
    default_capture_stream: torch.xpu.Stream | None = ...
    def __init__(self, xpu_graph: XPUGraph, pool: _POOL_HANDLE | None = ..., stream: torch.xpu.Stream | None = ...) -> None:
        ...

...
class SparseSemiStructuredTensor(torch.Tensor):
    ...
    @classmethod
    def from_dense(cls, original_tensor: torch.Tensor, alg_id: int = ...) -> SparseSemiStructuredTensor:
        ...
    


def to_sparse_semi_structured(original_tensor: torch.Tensor, transposed: bool = ..., alg_id: int = ...) -> SparseSemiStructuredTensor:
    """
...
class SparseSemiStructuredTensorCUTLASS(SparseSemiStructuredTensor):
    ...
    @classmethod
    def from_dense(cls, original_tensor: torch.Tensor, alg_id: int = ...) -> SparseSemiStructuredTensorCUTLASS:
        ...
...
class SparseSemiStructuredTensorCUSPARSELT(SparseSemiStructuredTensor):
    ...
    _DTYPE_SHAPE_CONSTRAINTS = ...
    @classmethod
    def from_dense(cls, original_tensor: torch.Tensor, alg_id: int = ...) -> SparseSemiStructuredTensorCUSPARSELT:
        ...
...
_cutlass_mm_registered = ...
_cusparselt_mm_registered = ...

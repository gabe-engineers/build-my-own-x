...
class WhileLoopOp(HigherOrderOperator):
    ...
    def __call__(self, cond_fn: Callable, body_fn: Callable, carried_inputs: tuple[torch.Tensor | int | float | bool], additional_inputs: tuple[torch.Tensor | torch.SymInt | int, ...], /): # -> Any:
        ...

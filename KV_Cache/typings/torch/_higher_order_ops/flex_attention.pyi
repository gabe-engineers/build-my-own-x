...
class FlexAttentionAutogradOp(torch.autograd.Function):
    ...
    @staticmethod
    def backward(ctx: Any, grad_out: Tensor, grad_logsumexp: Tensor, grad_max_scores: Tensor) -> tuple[Tensor | None, ...]:
        ...

...
def auto_functionalized_dense(_mutable_op: OpOverload, _only_clone_these_tensors: tuple[str, ...] | None = ..., **kwargs: Any) -> tuple[Any, tuple[Tensor, ...]]:
    ...
...
def auto_functionalized_v2_dense(_mutable_op: _MutableOpType, _only_clone_these_bases: tuple[int, ...] | None = ..., **kwargs: Any) -> tuple[Any, tuple[Tensor, ...]]:
    ...

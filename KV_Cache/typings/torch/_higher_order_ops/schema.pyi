...
class HopArgumentInfoGen:
    @staticmethod
    def from_example(example_value: Any, *, name: str = ..., default_value: Any | None = ..., is_mutated: bool = ..., kw_only: bool = ...) -> HopArgumentInfo:
        ...
...
class HopSchemaGenerator:
    ...
    def add_arg(self, name: str, example_value: Any, default_value: Any | None = ..., is_mutated: bool = ..., kw_only: bool = ...) -> None:
        ...

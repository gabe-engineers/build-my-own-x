...
def wrap_torch_function(dispatcher: Callable[_P, Iterable[Any]]) -> Callable[[Callable[_P, _R]], Callable[_P, _R]]:
...
def handle_torch_function(public_api: Callable[_P, _R], relevant_args: Iterable[Any], *args: _P.args, **kwargs: _P.kwargs) -> _R:

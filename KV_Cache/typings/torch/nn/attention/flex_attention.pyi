...
from typing_extensions import Never, NotRequired, Self, TypedDict, deprecated
...
class _MaskModWrapper:
    ...
    """
    __slots__ = ...
    def __init__(self, fn, closure_spec=...) -> None:
        ...
...
class BlockMask:
    ...
    **Details**
    ...
    @overload
    def as_tuple(self, flatten: Literal[True] = ...) -> tuple[int, int, Tensor, Tensor, Tensor | None, Tensor | None, Tensor | None, Tensor | None, Tensor | None, Tensor | None, int, int, _mask_mod_signature,]:
        ...
    
    @overload
    def as_tuple(self, flatten: Literal[False]) -> tuple[tuple[int, int], Tensor, Tensor, Tensor | None, Tensor | None, Tensor | None, Tensor | None, Tensor | None, Tensor | None, int | tuple[int, int], _mask_mod_signature,]:
        ...
    
    def as_tuple(self, flatten: bool = ...) -> tuple[Any, ...]:
        """
    ...
    def to_string(self, grid_size: int | tuple[int, int] = ..., limit: int = ...) -> str:
...
@overload
def flex_attention(query: Tensor, key: Tensor, value: Tensor, score_mod: _score_mod_signature | None = ..., block_mask: BlockMask | None = ..., scale: float | None = ..., enable_gqa: bool = ..., return_lse: Literal[False] = ..., kernel_options: FlexKernelOptions | None = ..., *, return_aux: None = ...) -> Tensor:
    ...

@overload
@deprecated("return_lse is deprecated and will be removed in v2.10. " "Use return_aux=AuxRequest(lse=True) instead.", category=FutureWarning)
def flex_attention(query: Tensor, key: Tensor, value: Tensor, score_mod: _score_mod_signature | None = ..., block_mask: BlockMask | None = ..., scale: float | None = ..., enable_gqa: bool = ..., return_lse: Literal[True] = ..., kernel_options: FlexKernelOptions | None = ..., *, return_aux: None = ...) -> tuple[Tensor, Tensor]:
    ...

@overload
def flex_attention(query: Tensor, key: Tensor, value: Tensor, score_mod: _score_mod_signature | None = ..., block_mask: BlockMask | None = ..., scale: float | None = ..., enable_gqa: bool = ..., return_lse: bool = ..., kernel_options: FlexKernelOptions | None = ..., *, return_aux: AuxRequest) -> tuple[Tensor, AuxOutput]:
    ...

@overload
def flex_attention(query: Tensor, key: Tensor, value: Tensor, score_mod: _score_mod_signature | None = ..., block_mask: BlockMask | None = ..., scale: float | None = ..., enable_gqa: bool = ..., return_lse: Literal[True] = ..., kernel_options: FlexKernelOptions | None = ..., *, return_aux: AuxRequest) -> Never:
    ...

...
class _BucketCapacityConfig:
    ...
    @classmethod
    def create(cls, bucket_cap_mb: int | None, bucket_cap_mb_list: list[int] | None, use_python_reducer: bool) -> _BucketCapacityConfig:
    ...
    def compute_bucket_size_limits(self, static_graph: bool, find_unused_parameters: bool) -> tuple[list[int], list[int]]:

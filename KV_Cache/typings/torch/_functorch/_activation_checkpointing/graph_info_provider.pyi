...
class GraphInfoProvider:
    ...
    def __init__(self, graph_nodes_in_order: list[str], graph_edges: list[tuple[str, str]], all_recomputable_banned_nodes: list[str], all_node_runtimes: dict[str, float] | None = ..., all_node_memories: dict[str, float] | None = ..., recorded_knapsack_input_memories: list[float] | None = ..., recorded_knapsack_input_runtimes: list[float] | None = ..., joint_graph: Graph | None = ...) -> None:
        ...

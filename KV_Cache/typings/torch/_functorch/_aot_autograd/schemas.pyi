...
class MemoryFormatMeta:
    ...
    @staticmethod
    def from_tensor(t: torch.Tensor, force_use_memory_format: bool = ...) -> MemoryFormatMeta | None:
        ...
...
class SubclassCreationMeta:
    ...
    memory_format: MemoryFormatMeta | None = ...
    def compute_outer_size_and_stride(self, all_args: Sequence[torch.Tensor | IntLikeType | OpaqueBase], *, curr_start_idx: int) -> tuple[Iterable[IntLikeType | None], Iterable[IntLikeType | None],]:
        ...
    
    def creation_fn(self, all_args: Sequence[torch.Tensor | IntLikeType | OpaqueBase], *, is_runtime: bool) -> torch.Tensor:
        ...
...
class ViewAndMutationMeta:
    ...
    num_tensors_saved_with_no_vc_check: int | None = ...
    ...
    mutated_inp_stream_indices: list[int | None] | None = ...
    compile_id_str: str | None = ...
    tangent_source_stack_traces: list[str | None] | None = ...
    def __post_init__(self) -> None:
        ...
...
class GraphSignature:
    ...
    @classmethod
    def from_tracing_metadata(cls, *, in_spec: pytree.TreeSpec, out_spec: pytree.TreeSpec, graph_input_names: list[str], graph_output_names: list[str], view_mutation_metadata: ViewAndMutationMeta, named_parameters: list[str], named_buffers: list[str], num_user_inputs: int, num_user_outputs: int, trace_joint: bool, loss_index: int | None, backward_signature: BackwardSignature | None) -> GraphSignature:
        ...
...
class JointTraceFn(Protocol):
    ...
    def __call__(self, primals: list[FxValue], tangents: list[FxValue]) -> tuple[tuple[list[FxValue], list[Tensor | None]], tuple[list[AOTOutput], list[AOTOutput | None]],]:
        ...

...
class _AutogradRngStateTracker:
    ...
    curr_fwd_iter: Any = ...
    backward_state_position: int = ...
    pending_forwards: set[int] = ...
...
class AOTDispatchAutograd:
    @staticmethod
    def process_runtime_tangent(x: Any, meta: PlainTensorMeta | SubclassCreationMeta, tangent_idx: int | None = ..., tangent_desc: Any | None = ..., compile_id_str: str | None = ..., tangent_stack_trace: str | None = ...) -> tuple[Any, list[Any]]:
        ...

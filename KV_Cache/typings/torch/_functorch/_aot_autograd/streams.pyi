...
def populate_stream_timeline(stream_to_timeline: dict[int | None, IndexedDict[Node, float]], graph: Graph, stream_index: int | None) -> IndexedDict[Node, float]:
    ...

def handle_synced_deallocation(graph: Graph, stream_to_exec_trace: dict[int | None, IndexedDict[Node, float]], node: Node, last_usage: Node) -> None:
    ...

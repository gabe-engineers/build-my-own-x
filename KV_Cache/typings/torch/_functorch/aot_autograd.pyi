...
def autograd_cache_key(graph, example_inputs, ignore_shape_env: bool, decompositions, compiler_config_extra: CompilerConfigExtra, keep_inference_input_mutations: bool = ..., disable_functionalization: bool = ...): # -> tuple[str, list[str]]:
    ...

def prepare_aot_config(mod: nn.Module, args: Iterable[Any], decompositions: dict[OpOverload, Callable[..., Any]] | None, keep_inference_input_mutations: bool, ignore_shape_env: bool, *, force_non_lazy_backward_lowering: bool = ..., disable_functionalization: bool = ..., _disable_torch_fn_metadata_mode: bool = ...) -> tuple[list[torch.nn.Parameter | Tensor], list[str], list[str], list[Any], list[Any], AOTConfig,]:
    ...

def prepare_aot_module_simplified(mod: nn.Module, args: Iterable[Any], kwargs: dict[str, Any] | None, decompositions: dict[OpOverload, Callable[..., Any]] | None, keep_inference_input_mutations: bool, ignore_shape_env: bool, flatten: bool, *, force_non_lazy_backward_lowering: bool = ..., disable_functionalization: bool = ..., _record_nn_module_stack: bool = ..., _disable_torch_fn_metadata_mode: bool = ...) -> tuple[Any, list[torch.nn.Parameter | Tensor], list[str], list[str], FakifiedFlatArgs, list[Any], AOTConfig, FakeTensorMode, ShapeEnv | None, pytree.TreeSpec | None, PytreeThunk | None, list[int],]:
    ...

def aot_module_simplified(mod: torch.fx.GraphModule | torch._dynamo.utils.GmWrapper, args: Sequence[Any], fw_compiler: AOTDispatchCompiler, bw_compiler: AOTDispatchCompiler | None = ..., partition_fn: Callable[..., Any] = ..., decompositions: dict[OpOverload, Callable[..., Any]] | None = ..., keep_inference_input_mutations: bool = ..., inference_compiler: AOTDispatchCompiler | None = ..., compiler_config_extra: CompilerConfigExtra | None = ..., ignore_shape_env: bool = ..., disable_functionalization: bool = ..., pre_grad_passes: Callable[[torch.fx.GraphModule, Sequence[InputType]], torch.fx.GraphModule] | None = ..., compile_region_name: str | None = ...) -> Callable[..., Any]:
    """

...
def quantize_activation_fw(graph: torch.fx.Graph, num_fwd_outputs: int = ...) -> None:
    ...

def quantize_activation_bw(graph: torch.fx.Graph) -> None:
    ...

def perform_fp8_activation_quantization(fwd_module: fx.GraphModule, bwd_module: fx.GraphModule, bwd_module_inputs: dict[str, fx.Node], num_fwd_outputs: int = ...) -> None:
    ...

def enable_activation_quantization(saved_values: list[fx.Node], fwd_module: fx.GraphModule, bwd_module: fx.GraphModule, static_lifetime_input_nodes: OrderedSet[fx.Node] | None = ..., num_fwd_outputs: int = ...) -> None:
    ...

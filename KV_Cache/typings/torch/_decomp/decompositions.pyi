...
@out_wrapper("grad_input")
@pw_cast_for_opmath
def binary_cross_entropy_backward(grad_output: Tensor, self: Tensor, target: Tensor, weight: Tensor | None = ..., reduction: int = ...) -> Tensor:
    ...
...
def slice_forward(self: Tensor, dim: int = ..., start: int | None = ..., end: int | None = ..., step: int = ...): # -> Tensor:
    ...

@register_decomposition(aten.slice_scatter)
@out_wrapper()
def slice_scatter(input: Tensor, src: Tensor, dim: int = ..., start: int | None = ..., end: int | None = ..., step: int = ...): # -> Tensor | Any:
    ...
...
def split_with_sizes_copy(self: Tensor, split_sizes: list[int], dim: int = ..., out: list[Tensor] | None = ...) -> list[Tensor] | None:
    ...
...
def cudnn_batch_norm(input: Tensor, weight: Tensor, bias: Tensor | None, running_mean: Tensor | None, running_var: Tensor | None, training: bool, exponential_average_factor: float, epsilon: float): # -> tuple[Any, Any, Any, Tensor] | tuple[Any, Tensor, Tensor, Tensor]:
    ...
...
def miopen_batch_norm_backward(input: Tensor, grad_output: Tensor, weight: Tensor, running_mean: Tensor | None, running_var: Tensor | None, save_mean: Tensor | None, save_var: Tensor | None, epsilon: float): # -> Any:
    ...

@register_decomposition(aten.cudnn_batch_norm_backward)
@out_wrapper("out0", "out1", "out2")
def cudnn_batch_norm_backward(input: Tensor, grad_output: Tensor, weight: Tensor, running_mean: Tensor | None, running_var: Tensor | None, save_mean: Tensor | None, save_var: Tensor | None, epsilon: float, reserveSpace: Tensor): # -> Any:
    ...

@register_decomposition(aten._adaptive_avg_pool2d)
@out_wrapper()
@pw_cast_for_opmath
def adaptive_avg_pool2d(input: Tensor, output_size: tuple[int, int]): # -> Tensor | SymFloat | NotImplementedType:
    ...
...
@out_wrapper()
def uniform(x: Tensor, low: bool | int | float = ..., high: bool | int | float = ..., generator: torch.Generator | None = ...): # -> Any:
    ...
...
@out_wrapper(preserve_memory_format=True, exact_dtype=True)
def upsample_nearest2d(input: Tensor, output_size: list[int], scales_h: float | None = ..., scales_w: float | None = ...) -> Tensor:
    ...
...
@out_wrapper(preserve_memory_format=True, exact_dtype=True)
def upsample_nearest3d(input: Tensor, output_size: list[int], scales_d: float | None = ..., scales_h: float | None = ..., scales_w: float | None = ...) -> Tensor:
    ...
...
def upsample_lanczos2d_aa_vec(input, output_size, align_corners, scale_factors): # -> Any:
    ...

@register_decomposition([aten.upsample_linear1d.default, aten.upsample_linear1d.out])
@out_wrapper()
def upsample_linear1d(input: Tensor, output_size: list[int], align_corners: bool, scales_w: float | None = ...) -> Tensor:
    ...
...
@out_wrapper()
def upsample_bilinear2d(input: Tensor, output_size: list[int], align_corners: bool, scales_h: float | None = ..., scales_w: float | None = ...) -> Tensor:
    ...

@register_decomposition([aten.upsample_trilinear3d.default, aten.upsample_trilinear3d.out])
@out_wrapper()
def upsample_trilinear3d(input: Tensor, output_size: list[int], align_corners: bool, scales_d: float | None = ..., scales_h: float | None = ..., scales_w: float | None = ...) -> Tensor:
    ...
...
def nll_loss_forward(self: Tensor, target: Tensor, weight: Tensor | None, reduction: int, ignore_index: int) -> tuple[Tensor, Tensor]:
    ...

@register_decomposition(aten.nll_loss2d_forward)
@out_wrapper("output", "total_weight")
def nll_loss2d_forward(self: Tensor, target: Tensor, weight: Tensor | None, reduction: int, ignore_index: int) -> tuple[Tensor, Tensor]:
    ...
...
@out_wrapper()
@pw_cast_for_opmath
def upsample_bicubic2d_default(input: Tensor, output_size: tuple[int, int], align_corners: bool, scale_h: float | None = ..., scale_w: float | None = ...) -> Tensor:
    ...
...
@out_wrapper()
@pw_cast_for_opmath
def upsample_bicubic2d_vec(a: Tensor, output_size: tuple[int, int] | None, align_corners: bool, scale_factors: tuple[float, float] | None = ...) -> Tensor:
    ...
...
@out_wrapper()
def arange_default(end: NumberType, *, dtype: torch.dtype | None = ..., layout: torch.layout = ..., device: torch.device | None = ..., pin_memory: bool = ...): # -> Any:
    ...

@register_decomposition([aten.arange.start])
def arange_start(start: NumberType, end: NumberType, *, dtype: torch.dtype | None = ..., layout: torch.layout = ..., device: torch.device | None = ..., pin_memory: bool = ...): # -> Any:
    ...
...
@out_wrapper()
def multi_margin_loss(input: Tensor, target: Tensor, p: NumberType = ..., margin: NumberType = ..., weight: Tensor | None = ..., reduction: int = ...) -> Tensor:
    ...
...
def scaled_dot_product_flash_attention_for_cpu(query: Tensor, key: Tensor, value: Tensor, dropout_p: float = ..., is_causal: bool = ..., *, attn_mask: Tensor | None = ..., scale: float | None = ...) -> tuple[Tensor, Tensor]:
    ...
...
def max_pool2d_with_indices_backward(grad_output: Tensor, self: Tensor, kernel_size, stride, padding, dilation, ceil_mode: bool, indices: Tensor): # -> NotImplementedType | Tensor:
    """
...
@out_wrapper()
def hann_window(window_length: int, *, dtype: torch.dtype | None = ..., layout: torch.layout | None = ..., device: torch.device | None = ..., pin_memory: bool | None = ...) -> Tensor:
...
@out_wrapper()
def hann_window_periodic(window_length: int, periodic: bool = ..., *, dtype: torch.dtype | None = ..., layout: torch.layout | None = ..., device: torch.device | None = ..., pin_memory: bool | None = ...) -> Tensor:
...
def one_hot(self: Tensor, num_classes: int = ...) -> Tensor:
    ...

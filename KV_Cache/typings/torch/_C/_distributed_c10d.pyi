...
class ProcessGroup:
    ...
    def split_group(self, new_ranks: list[int], timeout: timedelta | None = ..., opts: Backend.Options | None = ..., group_name: GroupName | None = ..., group_desc: str | None = ...) -> ProcessGroup | None:
        ...
    
    def merge_remote_group(self, store: Store, size: int, timeout: timedelta, group_name: GroupName | None = ..., group_desc: str | None = ...) -> ProcessGroup:
        ...

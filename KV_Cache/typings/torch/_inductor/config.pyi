...
pre_grad_custom_pass: torch._inductor.custom_graph_pass.CustomGraphPassType = ...
...
keep_addmm_fused_for_half_dtypes = ...
use_mixed_mm = ...
...
bucket_all_gathers_bucket_mode: Literal["default", "custom_ops", "custom_ops_multidtype"] = ...
bucket_reduce_scatters_fx: Literal["none", "all"] = ...
bucket_reduce_scatters_fx_bucket_size_determinator: Callable[[int], int] | None = ...
bucket_reduce_scatters_bucket_mode: Literal["default", "custom_ops", "custom_ops_multidtype"] = ...
bucket_all_reduces_fx: Literal["none", "all"] = ...
bucket_all_reduces_fx_bucket_size_determinator: Callable[[int], int] | None = ...
estimate_op_runtime = ...
...
cudagraph_policy: CUDAGraphPolicy | None = ...
...
nvgemm_max_profiling_configs: int | None = ...
...
delay_realize_cheap_outputs: bool = ...
fallback_random = ...
align_random_eager = ...
fallback_embedding_bag_byte_unpack = ...
implicit_fallbacks = ...
assume_unaligned_fallback_output = ...
inductor_choices_class: Callable[[], InductorChoices] | None = ...
aggressive_fusion = ...
debug_fusion: bool = ...
...
max_fusion_unique_io_buffers: int | None = ...
...
class aten_distributed_optimizations:
    ...
    collective_bucketing: bool | None = ...
    insert_overlap_deps: bool | None = ...
    max_compute_pre_fetch: int | None = ...
    compute_overlap_multipler: float | None = ...
    custom_runtime_estimation: Callable[[torch.fx.Node], float | None] | None = ...
    collective_estimator: Literal["analytical", "benchmark"] = ...
    compute_estimator: Literal["analytical", "benchmark"] = ...
    max_memory_increase_gb: float | None = ...
    max_memory_increase_ratio: float | None = ...
    max_in_flight_gb: float | None = ...
    max_coll_distance: int | None = ...
    log_final_collectives_estimations: bool = ...
    bucket_exposed_first: bool | None = ...
    bucket_only_internode_comms: bool = ...
    enable_fusion_regions: bool | None = ...
    bucket_mode: (Literal["default", "custom_ops", "custom_ops_multidtype", "coalesced"] | None) = ...
    prioritize_bucketing_during_scheduling: bool = ...
    spmd_check: bool = ...
    spmd_mismatch: Literal["warn", "error"] = ...
    overlap_scheduling_autofix_cycles: bool = ...
...
class cpp:
    ...
    use_two_step_variance_threshold = ...
...
class triton:
    ...
    mix_order_reduction_split_size: int | None = ...
...
class aot_inductor:
    ...
    package_constants_on_disk_format: str | None = ...
    ...
    enable_lto = ...
    link_libtorch: bool = ...
    cross_target_platform: str | None = ...
    aoti_shim_library: str | list[str] | None = ...
    aoti_shim_library_path: str | None = ...
...
class test_configs:
    ...
    force_custom_op_decomposition: bool | None = ...
    force_no_impl_grouping: bool = ...

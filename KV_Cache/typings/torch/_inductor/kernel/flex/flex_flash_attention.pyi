...
def create_flex_flash_attention_backward_kernel(query: TensorBox, key: TensorBox, value: TensorBox, out: TensorBox, logsumexp: TensorBox, grad_out: TensorBox, scale: float, kernel_options: dict[str, Any], sparse_q_block_size: int, sparse_kv_block_size: int, fw_subgraph_buffer: SubgraphResults | None = ..., joint_subgraph_buffer: Any | None = ..., score_mod_other_buffers: list[TensorBox] | None = ..., mask_graph_buffer: SubgraphResults | None = ..., q_num_blocks: TensorBox | None = ..., q_indices: TensorBox | None = ..., full_q_num_blocks: TensorBox | None = ..., full_q_indices: TensorBox | None = ...) -> tuple[TensorBox | ShapeAsConstantBuffer, TensorBox, TensorBox, tuple]:

...
def flex_attention(query, key, value, subgraph, block_mask, scale, kernel_options: dict[str, Any], score_mod_other_buffers, mask_mod_other_buffers): # -> tuple[TensorBox | Any | ShapeAsConstantBuffer] | tuple[Any, Any] | tuple[TensorBox, TensorBox] | tuple[TensorBox | Any | ShapeAsConstantBuffer, TensorBox, TensorBox]:
...
def get_bwd_subgraph_outputs(subgraph_buffer: SubgraphResults, mask_graph_buffer: SubgraphResults, joint_outputs: JointOutputResult) -> list[ComputedBuffer | TensorBox | None]:
    ...

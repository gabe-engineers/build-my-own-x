...
def get_fwd_subgraph_outputs(subgraph_buffer: SubgraphResults, mask_graph_buffer: SubgraphResults) -> list[ComputedBuffer | None]:
    ...
...
def create_placeholder(name: str, dtype: torch.dtype, device: torch.device, size: list[int] | None = ...) -> TensorBox:

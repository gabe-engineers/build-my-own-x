...
def tuned_addmm(inp, mat1, mat2, *, alpha=..., beta=..., layout=...): # -> Any | TensorBox | ShapeAsConstantBuffer:
    """
...
def mm_autoheuristic(mat1, mat2, m, n, k, choices, name, input_nodes, ops, precondition, top_k: int | None = ..., always_included=...): # -> list[ChoiceCaller] | ChoiceCaller | None:
    ...

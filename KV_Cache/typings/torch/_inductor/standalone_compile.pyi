...
def standalone_compile(gm: GraphModule, example_inputs: Sequence[InputType], *, dynamic_shapes: Any, options: Any, aot: bool = ..., donate_graph_module: bool = ...) -> CompiledArtifact:
    """
    Implementation of torch.inductor.standalone_compile
    """
    ...

def autograd_cache_key(graph, example_inputs, dynamic_shapes: Any, aot: bool = ...): # -> tuple[str, list[str]]:
    ...

...
def compute_memory_timeline(nodes: list[BaseSchedulerNode], name_to_freeable_input_buf: dict[str, FreeableInputBuffer], graph_outputs: OrderedSet[str]) -> tuple[list[BufferInfo], dict[BaseSchedulerNode, int], dict[FreeableInputBuffer | SchedulerBuffer, BaseSchedulerNode],]:
    """
...
def estimate_peak_memory_allocfree(nodes: list[BaseSchedulerNode], name_to_freeable_input_buf: dict[str, FreeableInputBuffer], graph_outputs: OrderedSet[str]) -> tuple[int, list[tuple[int, int]], dict[BaseSchedulerNode, SNodeMemory], dict[FreeableInputBuffer | SchedulerBuffer, BaseSchedulerNode],]:
    """

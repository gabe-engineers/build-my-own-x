...
from typing import Any, Concatenate, Generic, Literal, NamedTuple, Protocol, TYPE_CHECKING, TypeAlias, TypeGuard, TypeVar
...
def dominated_nodes(initial_queue: Iterable[torch.fx.Node], skip_filter: Callable[[Any], bool] | None = ...) -> OrderedSet[torch.fx.Node]:
...
def fresh_cache(cache_entries: dict[str, Any] | None = ..., dir: str | None = ..., delete: bool = ...) -> Iterator[None]:
    """
...
def argsort_sym(shape_env: ShapeEnv, seq: Sequence[int | torch.SymInt | sympy.Expr], *, reverse: bool = ...) -> list[int]:
    ...
...
class IndentedBuffer:
    ...
    def get_lines_ref(self): # -> list[DeferredLineBase | LineContext | str]:
        ...
...
def get_tma_workspace_arg(num_tma_descriptors: int, device: torch.device, num_programs: int | None = ...) -> WorkspaceArg:
    """Builds and returns a WorkspaceArg for the device side TMA workspace buffer."""
    ...

def get_default_kpack(block_k: int = ...) -> int:
    ...

def use_triton_template(layout: Layout, *, enable_int32: bool = ..., enable_float8: bool = ..., check_max_autotune: bool = ...) -> bool:
    ...

def can_use_tma(*matrices: IRNode, output_layout: Layout | None = ..., add_guards: bool = ...) -> bool:
    """
...
def use_blackwell_cutedsl_grouped_mm(mat_a: Any, mat_b: Any, layout: Layout, a_is_2d: bool, b_is_2d: bool, offs: Any | None, bias: Any | None, scale_result: Any | None) -> bool:
    """
...
def use_nv_universal_gemm_template(layout: Layout, m: _IntLike, n: _IntLike, k: _IntLike, mat_a: IRNode, mat_b: IRNode, offs: IRNode | None = ..., g: _IntLike | None = ...) -> bool:
    """
...
def use_cpp_gemm_template(layout: Layout, mat1: IRNode, mat2: IRNode, mat2_transposed: bool = ..., require_constant_mat2: bool = ..., is_woq_int4: bool = ..., q_group_size: int | None = ...) -> bool:
    ...
...
def contains_collective(snode: BaseSchedulerNode, filter_fn: Callable[[BaseSchedulerNode], bool] | None = ...) -> bool:
    ...
...
def copy_misaligned_inputs(new_inputs: list[InputType], check_inputs_idxs: Sequence[int], return_pair_idxs: OrderedSet[int] | None = ...) -> tuple[list[torch.Tensor], list[torch.Tensor]]:
    """
...
def get_current_backend(device_type: str | None = ...) -> str:
    ...
...
def infer_scale_swizzle(mat: torch.Tensor, scale: torch.Tensor) -> tuple[Any | None, Any | None]:
    """
...
def infer_scale_swizzle_ir(mat: Buffer, scale: Buffer, transpose: bool = ...) -> tuple[Any | None, Any | None]:
    """

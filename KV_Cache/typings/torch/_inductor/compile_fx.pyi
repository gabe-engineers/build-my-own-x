...
if TYPE_CHECKING or not config.is_fbcode():
    ...
    ...
if TYPE_CHECKING:
    CompileFxOutput = (Callable[[list[object]], Sequence[torch.Tensor]] | str | list[str] | Weights)
...
def split_const_gm(gm: GraphModule, skip_constructor: bool = ..., lifted_constant_names: list[str] | None = ..., skip_folding_node_fn: Callable[[torch.fx.Node], bool] | None = ...) -> tuple[GraphModule, dict[str, int]]:
    """
...
class _CompileFxCallable(Protocol):
    def __call__(self, gm: GraphModule, example_inputs: Sequence[InputType], compile_region_name: str | None = ..., **kwargs: Unpack[_CompileFxKwargs]) -> OutputCode:
        ...
    


def compile_fx_inner(gm: GraphModule, example_inputs: Sequence[InputType], compile_region_name: str | None = ..., **kwargs: Unpack[_CompileFxKwargs]) -> OutputCode:
    ...
...
def fx_codegen_and_compile(gm: GraphModule, example_inputs: Sequence[InputType], inputs_to_check: Sequence[int], compile_region_name: str | None = ..., **graph_kwargs: Unpack[_CompileFxKwargs]) -> OutputCode:
    ...
...
def compile_fx_aot(model_: GraphModule, example_inputs_: list[InputType], inner_compile: _CompileFxCallable = ..., config_patches: dict[str, Any] | None = ...) -> list[str | Weights] | str | GraphModule:
    ...
...
def cudagraph_annotation_context(cudagraphs: BoxedBool) -> contextlib.AbstractContextManager[None]:
    ...
...
def create_compiler_config_extra(gm: GraphModule | GmWrapper) -> CompilerConfigExtra:
    ...
...
def compile_fx(model_: GraphModule, example_inputs_: Sequence[InputType], inner_compile: Callable[..., OutputCode] = ..., config_patches: dict[str, Any] | None = ..., decompositions: dict[OpOverload, Callable[..., Any]] | None = ..., ignore_shape_env: bool = ..., compile_region_name: str | None = ...) -> CompileFxOutput:
    """
...
def autograd_cache_key(graph, example_inputs, ignore_shape_env: bool, decompositions=...): # -> tuple[str, list[str]]:
    ...

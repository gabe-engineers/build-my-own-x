...
class OpsHandler(Generic[T]):
    ...
    def to_dtype(self, x: T, dtype: torch.dtype, src_dtype: torch.dtype | None = ..., use_compute_types: bool = ...) -> T:
        """
    ...
    def bucketize(self, values: T, boundaries: tuple[str, sympy.Expr, sympy.Expr, sympy.Expr], boundary_indices: T, indexing_dtype: torch.dtype, right: bool, sorter: tuple[str, sympy.Expr] | None = ..., sorter_indices: T | None = ...) -> T:
        ...
    ...
    def inline_asm_elementwise(self, *inputs: T, asm: str, constraints: str | None = ..., dtype: torch.dtype = ..., is_pure: bool = ..., pack: int = ..., input_dtypes: tuple[torch.dtype, ...] | None = ...) -> T:
        ...

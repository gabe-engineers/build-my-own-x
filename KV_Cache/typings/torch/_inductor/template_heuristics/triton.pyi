...
from ..kernel.mm import blackwell_ws_persistent_device_tma_mm_template, mm_template, persistent_mm_template, persistent_tma_mm_template, scaled_mm_device_tma_epilogue_scaling_template, scaled_mm_device_tma_main_loop_scaling_template
...
@register_template_heuristic(persistent_mm_template.uid, "cuda", register=torch.version.hip is not None)
class PersistentMMTemplateConfigHeuristic(MMTemplateConfigMixin, ROCmConfigHeuristic):
...
@register_template_heuristic(persistent_mm_template.uid, "cuda", register=torch.version.hip is not None, op_name="addmm")
class ROCmAddMMPersistentTemplateConfigHeuristic(AddMMConfigMixin, PersistentMMTemplateConfigHeuristic):

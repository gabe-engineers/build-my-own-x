...
log = ...
def compile(gm: torch.fx.GraphModule, example_inputs: list[InputType], options: dict[str, Any] | None = ...): # -> CompileFxOutput:
    """
...
def aoti_compile_and_package(exported_program: ExportedProgram, _deprecated_unused_args=..., _deprecated_unused_kwargs=..., *, package_path: FileLike | None = ..., inductor_configs: dict[str, Any] | None = ...) -> str:
    """
...
def aot_compile(gm: torch.fx.GraphModule, args: tuple[Any, ...], kwargs: dict[str, Any] | None = ..., *, options: dict[str, Any] | None = ...) -> str | list[str | Weights] | torch.fx.GraphModule:
    """
...
def standalone_compile(gm: torch.fx.GraphModule, example_inputs: list[InputType], *, dynamic_shapes: Literal["from_example_inputs", "from_tracing_context", "from_graph"] = ..., options: dict[str, Any] | None = ..., aot: bool = ..., donate_graph_module: bool = ...) -> CompiledArtifact:
    """

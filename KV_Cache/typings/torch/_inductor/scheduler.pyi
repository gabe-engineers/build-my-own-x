...
class FusionResult:
    should_fuse: bool | None = ...
    callable_fn: Callable[[], bool] | None = ...
    future: LambdaFuture | None = ...
    ...
    @classmethod
    def from_callable(cls, callable_fn: Callable[[], bool], future: LambdaFuture | None = ...): # -> FusionResult:
        ...
...
class SchedulerNode(BaseSchedulerNode):
    ...
    def recompute_size_and_body(self, extra_indexing_constraints: tuple[dict[Any, Any], list[Any]] | None = ..., recompute_sizes_body_func: Callable[..., Any] | None = ...) -> None:
        ...
...
class FusedExternTritonKernelSchedulerNode(FusedSchedulerNode):
    def __init__(self, scheduler: Scheduler, kernel_node: ExternKernelSchedulerNode, fused_epilogue: SchedulerNode) -> None:
        ...
    
    @classmethod
    def epilogue_fuse(cls, node1: ExternKernelSchedulerNode, node2: SchedulerNode) -> FusedSchedulerNode:
        ...
...
class ForeachKernelSchedulerNode(FusedSchedulerNode):
    ...
    def __init__(self, scheduler: Scheduler, snodes: list[BaseSchedulerNode], use_custom_partition_algo: bool, prev_node_1: BaseSchedulerNode | None = ..., prev_node_2: BaseSchedulerNode | None = ..., enable_autotune: bool = ...) -> None:
        ...
...
class Scheduler:
    ...
    def generate_kernel_code_from_nodes(self, nodes: Sequence[BaseSchedulerNode], benchmark_kernel: bool, hint_override: int | None = ...) -> str:
        """
        Benchmark fused list of nodes and return the execution time
        in milliseconds on randomly generated inputs.
        """
    ...
    def compile_kernel(self, nodes: Sequence[BaseSchedulerNode], hint_override: int | None = ...) -> tuple[LambdaFuture | None, ModuleType]:
        ...
    ...
    def get_expand_dim_for_pointwise_nodes(self, node1: BaseSchedulerNode, node2: BaseSchedulerNode) -> tuple[int, SchedulerNode, sympy.Expr] | None:
        """
    ...
    def fusable_stardep_write_and_read_on_empty_tensor(self, read: Dep, write: StarDep, writing_node: ir.Operation | None) -> bool:
        ...
    
    def dep_size_hint(self, dep: Dep, count_bytes: bool = ...) -> int:
        ...
    
    def score_fusion_memory(self, node1: BaseSchedulerNode, node2: BaseSchedulerNode, count_bytes: bool = ..., return_is_mix_order_reduction: bool = ..., allow_mix_order_reduction: bool = ...) -> int | tuple[int, int, bool]:
        """
    ...
    def codegen_extern_call(self, scheduler_node: BaseSchedulerNode) -> None:
        ...
    ...
    def benchmark_combo_kernel(self, node_list: Sequence[BaseSchedulerNode], node_benchmark_results) -> tuple[float, float, list[str | None]]:
        """
        Benchmark fused list of nodes and return the execution time
        in milliseconds on randomly generated inputs.
        """
...
class BaseScheduling:
    ...
    def codegen_comment(self, node_schedule: Sequence[BaseSchedulerNode], kernel_name: str | None = ...) -> None:
        ...

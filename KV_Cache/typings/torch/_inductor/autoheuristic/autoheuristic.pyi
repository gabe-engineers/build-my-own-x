...
class AutoHeuristic:
    ...
    def __init__(self, fallback: Callable[[], Choice], choices: list[Choice], feedback: LocalFeedback | None, context: AHContext, name: str, augment_context: list[AHOperation] | None = ..., precondition: Callable[[AHMetadata, AHContext], bool] | None = ...) -> None:
        """
...
class AutoHeuristicSelectAlgorithm(AutoHeuristic):
    ...
    """
    def __init__(self, fallback: Callable[[], ChoiceCaller | None], choices: list[ChoiceCaller], input_nodes: list[Any], context: AHContext, name: str, augment_context: list[AHOperation] | None = ..., precondition: Callable[[AHMetadata, AHContext], bool] | None = ...) -> None:
        """
    ...
    def get_top_k_choices_caller(self, top_k: int, always_included: list[str] | None = ...) -> list[ChoiceCaller] | None:
        ...

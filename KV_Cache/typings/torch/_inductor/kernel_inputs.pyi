...
class KernelInputs(ABC):
    ...
    """
    def __init__(self, input_nodes: list[Any], scalars: dict[str, float | int] | None = ..., out_dtype: torch.dtype | None = ...) -> None:
        """
...
class MMKernelInputs(KernelInputs):
    ...
    """
    def __init__(self, input_nodes: list[Any], scalars: dict[str, float | int] | None = ..., out_dtype: torch.dtype | None = ..., mat1_idx: int = ..., mat2_idx: int = ...) -> None:
        """
        Initialize with a tuple of input nodes.

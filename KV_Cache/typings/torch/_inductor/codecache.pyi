...
class FxGraphCachePickler(pickle.Pickler):
    ...
    """
    def __init__(self, gm: torch.fx.GraphModule, has_user_defined_triton_kernels: bool = ..., device_id_agnostic: bool = ...) -> None:
        """
...
_warned_pre_grad_pass_missing_uuid: OrderedSet[str] = ...
...
class CppPythonBindingsCodeCache(CppCodeCache):
    cache: dict[str, Callable[[], CDLL | ModuleType]] = ...
    _loaded_module_names: OrderedSet[str] = ...
    @staticmethod

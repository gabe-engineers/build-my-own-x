...
backend = ...
_debug_nodes_cache: bool | OrderedSet[str] | None = ...
_debug_nodes_env_value_cache: str | None = ...
...
class Match:
    ...
    def __init__(self, ctx: MatchContext, pattern: PatternExpr, args: Sequence[Any] | None = ..., kwargs: dict[str, Any] | None = ...) -> None:
        ...
    ...
    def replace_by_example(self, replacement_fn: ReplaceFn, args: Sequence[Any], trace_fn: TraceFn | None = ..., run_functional_passes: bool = ...) -> None:
...
class MatchContext:
    ...
    def __init__(self, outputs: list[PatternExpr | None], pattern_to_node: dict[PatternExpr, torch.fx.Node] | None = ..., *, graph: torch.fx.Graph) -> None:
        ...
...
class _TargetArgsExpr(_TargetExpr):
    ...
    """
    def __init__(self, fns: torch.fx.node.Target | str | Sequence[Any], *args: Any, _users: int | Multiple = ..., **kwargs: Any) -> None:
        ...
...
class PatternEntry:
    ...
    def register(self, pass_dicts: _PassDictsType | Sequence[_PassDictsType], target: torch.fx.node.Target | None = ..., prepend: bool = ...) -> None:
        ...
...
class ReplacementPatternEntry(PatternEntry):
    ...
    @staticmethod
    def replace_with_graph(match: Match, graph: torch.fx.Graph, replacement_graph: torch.fx.Graph | torch.fx.GraphModule, args: Sequence[torch.fx.Node], pass_name: str | None = ...) -> None:
        """
...
def check_and_add_duplicate_pattern(pattern: PatternExpr, graph: torch.fx.Graph | None, seen_patterns: dict[str, list[str | None]], skip_duplicates: bool = ...) -> bool:
    """
...
def register_replacement(search_fn: SearchFn, replace_fn: ReplaceFn, example_inputs: list[Any] | tuple[Any, ...], trace_fn: TraceFn, pass_dicts: _PassDictsType | Sequence[_PassDictsType], extra_check: Callable[[Match], bool] = ..., scalar_workaround: dict[str, float | int] | None = ..., exclusive_arg_names: Sequence[str] = ..., search_fn_pattern: PatternExpr | None = ..., skip_duplicates: bool = ..., pattern_name: str | None = ..., get_decomp_fn: Callable[..., dict[Any, Callable[..., Any]]] = ...) -> bool:
    """
...
def gen_register_replacement(unique_name: str, search_fn: SearchFn, replace_fn: ReplaceFn, example_inputs: Iterable[Any], trace_fn: TraceFn, pass_dicts: _PassDictsType | Sequence[_PassDictsType], extra_check: Callable[[Match], bool] = ..., scalar_workaround: dict[str, float | int] | None = ..., exclusive_arg_names: Sequence[str] = ..., skip_duplicates: bool = ..., get_decomp_fn: Callable[..., dict[Any, Callable[..., Any]]] = ...) -> None:
    ...

@functorch_config.patch(functionalize_rng_ops=False)
def gen_pattern_and_search_gm(search_fn: SearchFn, example_inputs: Sequence[Any], trace_fn: TraceFn, scalar_workaround: dict[str, float | int] | None = ..., exclusive_arg_names: Sequence[str] = ..., get_decomp_fn: Callable[..., dict[Any, Callable[..., Any]]] = ...) -> tuple[PatternExpr, torch.fx.GraphModule]:
    ...

def gen_pattern(search_fn: SearchFn, example_inputs: Sequence[Any], trace_fn: TraceFn, scalar_workaround: dict[str, float | int] | None = ..., exclusive_arg_names: Sequence[str] = ...) -> PatternExpr:
    ...
...
class PatternMatcherPass:
    ...
    """
    def __init__(self, pass_name: str | None = ..., subsystem: str | None = ...) -> None:
        ...
...
def fx_to_pattern(gm: torch.fx.GraphModule | torch.fx.Graph, ignore_types: Sequence[type[Any]] = ..., argnames: Sequence[str] = ..., scalar_workaround: dict[str, float | int] | None = ..., exclusive_arg_names: Sequence[str] = ...) -> PatternExpr:
    """
...
@torch.no_grad()
def fwd_only(fn: Callable[..., Any], args: Sequence[Any], *, run_functional_passes: bool = ..., get_decomp_fn: Callable[..., Any] = ...) -> torch.fx.GraphModule:
    """Build a normalized inference graph, for use with fx_to_pattern"""
    ...

@torch.enable_grad()
def joint_fwd_bwd(fn: Callable[..., Any], args: Sequence[Any], *, get_decomp_fn: Callable[..., Any] = ...) -> torch.fx.GraphModule:

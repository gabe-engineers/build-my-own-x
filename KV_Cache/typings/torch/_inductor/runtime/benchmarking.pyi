...
def register_benchmarker(device_type: str, fn: Callable[..., Any], *, override: bool = ...) -> None:
    """
...
class Benchmarker:
    ...
    @time_and_count
    def benchmark(self: Self, fn: Callable[..., Any], fn_args: tuple[Any, ...] | None = ..., fn_kwargs: dict[str, Any] | None = ..., device: str | torch.device | None = ..., **kwargs: Any) -> float:
    ...
    @time_and_count
    def benchmark_gpu_with_cuda_graph(self: Self, _callable: Callable[[], Any], **kwargs: Any) -> float:

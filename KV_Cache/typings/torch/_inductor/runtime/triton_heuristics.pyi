...
if TYPE_CHECKING:
    LauncherType = Any
_KernelType = (CompiledKernel | StaticallyLaunchedCudaKernel | StaticallyLaunchedXpuKernel)
...
def triton_config(size_hints, x, y=..., z=..., num_stages=..., num_elements_per_warp=..., min_elem_per_thread=..., num_warps=..., matrix_instr=..., waves_per_eu=..., kpack=...) -> Config:
    """
...
class GridExpr:
    ...
    def generate(self, meta: dict[str, int], is_lazy: bool = ...) -> None:
        ...
    ...
    @classmethod
    def from_meta_lazy(cls, inductor_meta: dict[str, Any] | None, kernel_name: str) -> GridExpr:

...
class _RecordLoadStoreInner(V.MockHandler):
    ...
    def store(self, name: str, index: sympy.Expr, value: str, mode: str | None = ...) -> None:
        ...
    ...
    def bucketize(self, values: T, boundaries: tuple[str, sympy.Expr, sympy.Expr, sympy.Expr], boundary_indices: T, indexing_dtype: torch.dtype, right: bool, sorter: tuple[str, sympy.Expr] | None = ..., sorter_indices: T | None = ...) -> None:
...
class FreeSymbolsOpsHandler(DefaultHandler):
    ...
    def indirect_indexing(self, index_var: Any, size: int | sympy.Expr, check: bool = ..., wrap_neg: bool = ...) -> sympy.Symbol:
        ...
...
def extract_free_symbols(fn: Callable[..., Any], index: Sequence[sympy.Expr], rindex: Sequence[sympy.Expr] | None = ..., unbacked_only: bool = ...) -> OrderedSet[sympy.Symbol]:
    ...

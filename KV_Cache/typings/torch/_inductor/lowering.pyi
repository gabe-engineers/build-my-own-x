...
def tag_to_layout_constraint(tag: torch._C.Tag) -> Callable[..., tuple[Any, Any]] | None:
    ...

def assert_nyi(cond: bool, msg: str) -> None:
    ...

def add_needs_realized_inputs(fn: Collection[torch._ops.OpOverload | torch._ops.OpOverloadPacket] | torch._ops.OpOverload | torch._ops.OpOverloadPacket) -> list[Any] | None:
    ...

def add_layout_constraint(fn: torch._ops.OpOverloadPacket | torch._ops.OpOverload, constraint: Callable[..., tuple[Any, Any]]) -> None:
    ...
...
def in_namespace(op: Any | torch._ops.OpOverloadPacket | torch._ops.OpOverload, namespace: str) -> bool:
    ...
...
def register_lowering(aten_fn, broadcast=..., type_promotion_kind: ELEMENTWISE_TYPE_PROMOTION_KIND | None = ..., convert_input_to_bool=..., lowering_dict=...) -> Callable[[Callable[_P, _T]], Callable[_P, _T]]:
    """
...
def make_pointwise(fn, override_return_dtype=..., override_device=..., override_fn_when_input_bool=..., allow_alpha=..., use_fma_for_alpha=..., triton_fallback=...): # -> Callable[..., Any | TensorBox]:
    """Wraps a pointwise fn and returns a function representing the pointwise in
    the define-by-run IR."""
    ...

def make_foreach_pointwise(pw_fn, allow_alpha=..., scalar_kwarg=...): # -> Callable[..., Any]:
    ...
...
def to_dtype(x: TensorBox, dtype: torch.dtype, copy: bool = ..., use_compute_types: bool = ...): # -> TensorBox:
    ...
...
def register_pointwise(aten_fn, name=..., broadcast=..., type_promotion_kind=..., convert_input_to_bool=..., override_return_dtype=..., override_fn_when_input_bool=..., allow_alpha=..., use_fma_for_alpha=..., triton_fallback=...): # -> Callable[..., Any | TensorBox]:
...
def register_foreach_pointwise(aten_fn, pointwise_lowering_fn, allow_alpha=..., scalar_kwarg=...): # -> Callable[..., Any]:
    ...
...
def quantized_decomposed_dequantize_per_channel(input: TensorBox, scales: TensorBox, zero_points: TensorBox, axis: int, quant_min: int, quant_max: int, dtype: torch.dtype, *, out_dtype: torch.dtype | None = ...) -> TensorBox:
    ...
...
def quantized_decomposed_dequantize_per_tensor_default(input: TensorBox, scale: float, zero_point: int, quant_min: int, quant_max: int, dtype: torch.dtype, *, out_dtype: torch.dtype | None = ...) -> TensorBox:
    ...
...
def quantized_decomposed_dequantize_per_tensor_tensor(input: TensorBox, scale: TensorBox, zero_point: TensorBox, quant_min: int, quant_max: int, dtype: torch.dtype, *, out_dtype: torch.dtype | None = ...) -> TensorBox:
    ...
...
def make_fallback(op, layout_constraint=..., warn=..., override_decomp=..., get_decomp_fn=...): # -> None:
    ...
...
def get_threads_per_round(device: torch.device): # -> Literal[32768]:
    ...

@register_lowering(inductor_prims.random, type_promotion_kind=None)
def inductor_random(size: list[int], seed: TensorBox, mode: str, *, offset: int = ..., align_dtype: torch.dtype = ...): # -> TensorBox:
    ...
...
def searchsorted(sorted_sequence: TensorBox, self: TensorBox, *, out_int32: bool = ..., right: bool = ..., side: str | None = ..., sorter: TensorBox | None = ...) -> TensorBox:
    ...
...
def sdpa_constraint(fx_node, *args, **kwargs): # -> tuple[tuple[Any | IRNode | TensorBox, ...], dict[str, Any | IRNode | TensorBox]]:
...
def arange_start_step(start, end, step=..., *, dtype=..., device=..., layout=..., pin_memory=..., requires_grad=...): # -> TensorBox:
    ...
...
def scatter_fallback(op_overload: torch._ops.OpOverload, self, dim: int, index, src, *, reduce: str | None = ..., include_self: bool = ...): # -> None:
    ...
...
def upsample_nearestnd(x, output_size, scales_x: tuple[float | None, ...], n: int = ..., exact: bool = ...): # -> TensorBox:
    ...

@register_lowering(aten.upsample_nearest1d.default)
def upsample_nearest1d(x, output_size, scales: float | None = ...): # -> TensorBox:
    ...

@register_lowering(aten.upsample_nearest2d.default)
def upsample_nearest2d(x, output_size, scales_h: float | None = ..., scales_w: float | None = ...): # -> TensorBox:
    ...

@register_lowering(aten.upsample_nearest3d.default)
def upsample_nearest3d(x, output_size, scales_d: float | None = ..., scales_h: float | None = ..., scales_w: float | None = ...): # -> TensorBox:
    ...
...
def median_default(self): # -> PyTree | TensorBox:
    ...

@register_lowering(aten.median.dim, type_promotion_kind=None)
def median_dim(self, dim, keepdim=...): # -> PyTree | tuple[TensorBox, TensorBox]:
    ...

@register_lowering(aten.mode.default, type_promotion_kind=None)
def mode_default(self, dim=..., keepdim=...): # -> PyTree | tuple[TensorBox, TensorBox]:
    """Lower aten.mode via sort-based decomposition or fallback."""
    ...

@register_lowering(aten.topk.default, type_promotion_kind=None)
def topk(self, k, dim=..., largest=..., sorted=...): # -> PyTree | tuple[TensorBox, TensorBox] | tuple[Any, Any]:
    ...

@register_lowering(aten.kthvalue.default, type_promotion_kind=None)
def kthvalue(self, k, dim=..., keepdim=...): # -> PyTree | tuple[TensorBox, TensorBox]:
    ...
...
def addcmul(self, tensor1, tensor2, *, value=...): # -> TensorBox:
    """
...
def addcdiv(self, tensor1, tensor2, *, value=...): # -> TensorBox:
    """
    Computes self + value * (tensor1 / tensor2) using FMA for better precision.
...
def cond(pred, true_fn, false_fn, operands) -> list[ir.TensorBox | ir.ShapeAsConstantBuffer]:
    ...
...
_MISSING = ...
def process_subgraph_nodes(graph_module: torch.fx.GraphModule, args: list[Any]): # -> object | Any:
...
def control_deps_op_lowering(additional_deps, subgraph_fn, *args): # -> object | Any:
    """
...
@register_lowering(torch._higher_order_ops.inline_asm_elementwise, type_promotion_kind=None)
def lower_inline_asm_elementwise(*inputs, asm_str, constraints, dtype, is_pure=..., pack=...): # -> TensorBox:
    ...

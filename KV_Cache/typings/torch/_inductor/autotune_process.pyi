...
class _TestBenchmarkRequest(BenchmarkRequest):
    ...
    """
    def __init__(self, result: float = ..., device: int | None = ..., sleep: float | None = ..., exc: Exception | None = ..., crash: bool = ...) -> None:
        ...
...
class ExternKernelBenchmarkRequest(BenchmarkRequest):
    ...
    """
    def __init__(self, kernel_name: str, input_tensor_meta: TensorMeta | list[TensorMeta], output_tensor_meta: TensorMeta | list[TensorMeta], extra_args: Iterable[Any], callable_path: str, kwargs: dict[str, Any] | None = ..., has_out_variant: bool = ...) -> None:
        ...
...
class SubgraphBenchmarkRequest(BenchmarkRequest):
    ...
    """
    def __init__(self, kernel_name: str, input_tensor_meta: TensorMeta | list[TensorMeta], output_tensor_meta: TensorMeta | list[TensorMeta], extra_args: Iterable[Any], module_path: str, module_cache_key: str, sym_input_values: list[int]) -> None:
        ...
...
class CUTLASSBenchmarkRequest(GPUDeviceBenchmarkMixin, BenchmarkRequest):
    ...
    process boundaries. Do not put CUDA Tensors in here!
    """
    def __init__(self, kernel_name: str, input_tensor_meta: TensorMeta | list[TensorMeta], output_tensor_meta: TensorMeta | list[TensorMeta], extra_args: Iterable[Any], source_code: str, device_type: str = ...) -> None:
        ...
...
class CuteDSLBenchmarkRequest(GPUDeviceBenchmarkMixin, BenchmarkRequest):
    ...
    def __init__(self, kernel_name: str, input_tensor_meta: TensorMeta | list[TensorMeta], output_tensor_meta: TensorMeta | list[TensorMeta], extra_args: tuple[Any, ...], source_code: PartialRender) -> None:
        ...
...
class AutotuneProcessPool:
    ...
    """
    _instance: AutotuneProcessPool | None = ...
...
class PrecompileThreadPool:
    ...
    """
    _instance: PrecompileThreadPool | None = ...
    _lock = ...

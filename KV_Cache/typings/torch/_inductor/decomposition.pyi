...
def sym_constrain_range_for_size(symbol: torch.SymInt, *, min: torch.types.Number | None = ..., max: torch.types.Number | None = ...) -> None:
    ...

@register_decomposition([aten.clamp])
@pw_cast_for_opmath_non_tensor_args
def clamp(x: torch.Tensor, min: torch.types.Number | None = ..., max: torch.types.Number | None = ...) -> torch.Tensor:
    ...
...
@pw_cast_for_opmath
def addmm(self: torch.Tensor, mat1: torch.Tensor, mat2: torch.Tensor, out_dtype: torch.dtype | None = ..., beta: torch.types.Number = ..., alpha: torch.types.Number = ...) -> torch.Tensor:
    ...
...
def full_like(self: torch.Tensor, fill_value: int | float, *, dtype: torch.dtype | None = ..., layout: torch.layout | None = ..., device: torch.device | None = ..., pin_memory: bool = ..., requires_grad: bool = ..., memory_format: torch.memory_format = ...) -> torch.Tensor:
    ...
...
def linear_dynamic_fp16_unpacked_weight(input: torch.Tensor, weight: torch.Tensor, bias: torch.Tensor | None = ...) -> torch.Tensor:
    ...
...
def max_pool2d_with_indices(x: torch.Tensor, kernel_size: list[int], stride: int | list[int] | None = ..., padding: int | list[int] = ..., dilation: int | list[int] = ..., ceil_mode: bool = ...) -> tuple[torch.Tensor, torch.Tensor]:
    ...

@register_decomposition(aten.max_pool3d_with_indices)
def max_pool3d_with_indices(x: torch.Tensor, kernel_size: list[int], stride: int | list[int] | None = ..., padding: int | list[int] = ..., dilation: int | list[int] = ..., ceil_mode: bool = ...) -> tuple[torch.Tensor, torch.Tensor]:
    ...
...
def searchsorted_scalar(sorted_sequence: torch.Tensor, self: torch.types.Number, *, out_int32: bool = ..., right: bool = ..., side: str | None = ..., sorter: torch.Tensor | None = ...) -> torch.Tensor:
    ...
...
def rrelu_with_noise_functional(self: torch.Tensor, noise: torch.Tensor, lower: float = ..., upper: float = ..., training: bool = ..., generator: torch.Generator | None = ...) -> tuple[torch.Tensor, torch.Tensor]:
    ...
...
def conv1d_to_conv2d(input: torch.Tensor, weight: torch.Tensor, bias: torch.Tensor | None = ..., stride: tuple[int] = ..., padding: tuple[int] = ..., dilation: tuple[int] = ..., groups: int = ...) -> torch.Tensor:
    ...

...
class ConvolutionUnary(ExternKernelAlloc):
    ...
    @classmethod
    def create(cls, x: TensorBox, weight: TensorBox, bias: TensorBox, padding_: list[int], stride_: list[int], dilation_: list[int], groups: int, attr, scalars: list[Any] | None, algorithm): # -> MultiOutput:
        ...
...
class ConvolutionBinary(ExternKernelAlloc):
    ...
    @classmethod
    def create(cls, x: TensorBox, other: TensorBox, weight: TensorBox, bias: TensorBox, padding_: list[int], stride_: list[int], dilation_: list[int], groups: int, binary_attr: str, binary_alpha: float | None, unary_attr: str | None, unary_scalars: list[Any] | None, unary_algorithm: str | None): # -> MultiOutput:
        ...
...
class ConvolutionBinaryInplace(ExternKernelAlloc):
    ...
    @classmethod
    def create(cls, x: TensorBox, other: TensorBox, weight: TensorBox, bias: TensorBox, padding_: list[int], stride_: list[int], dilation_: list[int], groups: int, binary_attr: str, binary_alpha: float | None, unary_attr: str | None, unary_scalars: list[Any] | None, unary_algorithm: str | None): # -> Any:
        ...
...
class ConvolutionTransposeUnary(ExternKernelAlloc):
    ...
    @classmethod
    def create(cls, x: TensorBox, weight: TensorBox, bias: TensorBox, padding_: list[int], output_padding_: list[int], stride_: list[int], dilation_: list[int], groups_: int, attr, scalars: list[Any] | None, algorithm): # -> MultiOutput:
        ...

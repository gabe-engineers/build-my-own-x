...
class KernelTemplateChoice:
    ...
    """
    def __init__(self, template: KernelTemplate | ExternKernelChoice, params: KernelTemplateParams, extra_kwargs: dict[str, Any], layout: Layout, inputs: KernelInputs) -> None:
        ...
...
def make_ktc_generator(template: KernelTemplate | ExternKernelChoice, cs: Generator[KernelTemplateParams, None, None], extra_kwargs: dict[str, Any], overrides: dict[str, Any], layout: Layout, inputs: KernelInputs) -> Generator[KernelTemplateChoice, None, None]:
    """

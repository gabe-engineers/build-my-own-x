...
class NVUniversalGemmBenchmarkRequest(GPUDeviceBenchmarkMixin, BenchmarkRequest):
    ...
    def __init__(self, kernel_name: str, input_tensor_meta: TensorMeta | list[TensorMeta], output_tensor_meta: TensorMeta | list[TensorMeta], kernel, accumulator_type: torch.dtype, variant: GemmVariant, workspace_size: int = ..., scale_type_a: Any | None = ..., scale_type_b: Any | None = ..., swizzle_type_a: Any | None = ..., swizzle_type_b: Any | None = ...) -> None:
        ...
...
class NVUniversalGemmCaller(ChoiceCaller):
    ...
    """
    index_counter = ...
    def __init__(self, name: str, input_nodes: list[Buffer], layout: Layout, kernel, accumulator_type: torch.dtype, variant: GemmVariant, workspace_size: int = ..., scale_type_a: Any | None = ..., scale_type_b: Any | None = ..., swizzle_type_a: Any | None = ..., swizzle_type_b: Any | None = ...) -> None:
        ...
...
def add_nv_universal_gemm_choices(choices: list[ChoiceCaller], layout: Layout, inputs: MMKernelInputs, accumulator_type: torch.dtype | None = ...) -> None:
    """
...
def add_nv_universal_grouped_gemm_choices(choices: list[ChoiceCaller], layout: Layout, input_nodes: list[Buffer], accumulator_type: torch.dtype | None = ...) -> None:
    """
...
def add_nv_universal_scaled_gemm_choices(choices: list[ChoiceCaller], layout: Layout, input_nodes: list[Buffer], accumulator_type: torch.dtype | None = ..., kernel_inputs: MMKernelInputs | None = ...) -> None:
    """

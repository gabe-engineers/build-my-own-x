...
class CUTLASSGemmTemplate(CUTLASSTemplate, ABC):
    ...
    cache_clear = ...
    def __init__(self, input_nodes: list[Buffer], layout: Layout, alpha: float, beta: float, input_reorder: list[int] | None = ..., use_fast_accum: bool | None = ...) -> None:
        """
        Args:
    ...
    @staticmethod
    @abstractmethod
    def add_cutlass_gemm_choices(choices: list[ChoiceCaller], layout: ir.Layout, input_nodes: list[Buffer], alpha: float | int = ..., beta: float | int = ..., input_reorder: list[int] | None = ..., use_fast_accum: bool | None = ..., **extra_kwargs) -> None:
        ...
    ...
    def render(self, kernel: CUTLASSTemplateKernel, op: cutlass_gemm_op.GemmOperation = ..., template_buffer_node: CUTLASSTemplateBuffer | None = ..., epilogue_nodes: list[BaseSchedulerNode] | None = ..., **kwargs) -> str:
        """
...
class CUTLASS2xGemmTemplate(CUTLASSGemmTemplate):
    ...
    def __init__(self, input_nodes: list[Buffer], layout: Layout, alpha: float, beta: float, input_reorder: list[int] | None = ...) -> None:
        ...

...
class CUTLASSTemplate(KernelTemplate):
    ...
    cache_clear = ...
    def __init__(self, name: str, input_nodes: list[Buffer], layout: Layout, input_reorder: list[int] | None = ...) -> None:
        """
    ...
    def generate(self, name: str, description: str, input_key: str, layout_repr: str, input_tensor_meta: TensorMeta | list[TensorMeta], output_tensor_meta: TensorMeta | list[TensorMeta], **kwargs) -> CUTLASSTemplateCaller:
        """

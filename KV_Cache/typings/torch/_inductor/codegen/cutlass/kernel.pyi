...
class CUTLASSTemplateKernel(CUTLASSKernel):
    ...
    """
    def __init__(self, kernel_name: str, runtime_arg_info: list[ArgInfo], runtime_arg_values: list[Any], device_type: str = ...) -> None:
        """
    ...
    def def_kernel(self, inputs: list[IRNode], outputs: list[IRNode], names_str: str = ..., input_reorder: list[int] | None = ...) -> str:
        """
...
class CUTLASSTemplateCaller(ChoiceCaller):
    ...
    """
    def __init__(self, name: str, category: str, input_nodes: list[Buffer], layout: Layout, make_kernel_render: Callable[[CUTLASSTemplateBuffer, list[BaseSchedulerNode] | None], tuple[CUTLASSTemplateKernel, functools.partial[str]],], bmreq: CUTLASSBenchmarkRequest, supports_epilogue_fusion: bool, template: CUTLASSTemplate, info_kwargs: dict[str, PrimitiveInfoType | list[PrimitiveInfoType]] | None, description: str) -> None:
        ...

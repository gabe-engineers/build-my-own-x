...
if try_import_cutlass():
    ...
    def trace(fn_src: str, example_tensors: dict[str, CutlassTensor], accum_type: DataType, output_type: DataType, tile_description: TileDescription, epilogue_schedule: EpilogueScheduleType, name_to_buffer: dict[str, Buffer], size_hint_fn: Callable[[Expr | int], int], kernel_schedule: Any | None = ..., **kwargs: dict[str, Any]) -> tuple[str, str, str, EVTArgRenames]:
        ...

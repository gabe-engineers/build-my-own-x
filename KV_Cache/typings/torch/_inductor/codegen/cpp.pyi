...
def reduction_combine(reduction_type, var, next_value, helper_val=..., index: sympy.Symbol | None = ..., src_dtype=...): # -> str:
    ...
...
def reduction_prefix_array(acc_var: str | CSEVariable, acc_type: str, reduction_type: str, dtype: torch.dtype, len: str | int, init_fn): # -> IndentedBuffer:
    """
...
@functools.lru_cache
def stride_at_vec_range(index: sympy.Expr, var: sympy.Symbol, vec_length: int | None = ...): # -> Zero | Expr:
    ...
...
class CppOverrides(OpOverrides):
    ...
    @staticmethod
    def round_to_int(x, dtype, src_dtype=..., use_compute_types=...):
        ...
    ...
    @staticmethod
    def rand_eager(seed: sympy.Expr, base_offset: sympy.Expr, threads_per_round: sympy.Expr, tid: sympy.Expr, vec: sympy.Expr): # -> str:
        ...
...
class CppVecOverrides(CppOverrides):
    ...
    @staticmethod
    def masked(mask, body, other): # -> CppCSEVariable | CSEVariable:
        ...
...
class CppKernel(Kernel):
    ...
    def need_use_acc_helper(self, reduction_type, dtype, use_scalar): # -> Basic | bool:
        ...
    ...
    def get_to_dtype_expr(self, src, dtype, src_dtype, rounding=...): # -> str:
        ...
    
    def cache_dtype_convert(self, dst, dst_dtype, src, src_dtype): # -> None:
        ...
    
    def codegen_conditions(self, code: BracesBuffer, prefix: str | None = ..., var: sympy.Symbol | None = ...): # -> bool:
        ...
...
class CppVecKernel(CppKernel):
    ...
    def reduction_combine_vec(self, reduction_type, var, next_value, helper_val=..., index: sympy.Symbol | None = ..., horizontal_reduction: bool | None = ..., src_dtype: torch.dtype | None = ...): # -> str:
        ...

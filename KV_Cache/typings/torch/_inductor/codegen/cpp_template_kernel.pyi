...
class CppTemplateKernel(CppKernel):
    ...
    def def_kernel(self, inputs: dict[str, ir.Buffer], outputs: dict[str, ir.Buffer], aliases: dict[str, str] | None = ..., function_name: str = ..., extra_sizevars: list[sympy.Expr] | None = ..., placeholder: str = ...) -> str:
        ...
    ...
    def store_pointwise_nodes(self, dst: ir.Buffer, nodes: list[ir.IRNode], offsets: list[sympy.Expr] | None = ..., reindexers: list[Callable[[list[Any]], list[Any]] | None] | None = ...) -> str:
        ...
    ...
    def store_output(self, dst: ir.Buffer, src: ir.Buffer, orig_src: ir.Buffer | None = ..., epilogue_nodes: list[ir.IRNode] | None = ..., offsets: list[Any] | None = ..., reindexers: list[Callable[[list[Any]], list[Any]] | None] | None = ...): # -> str:
        """
    ...
    def store_outputs(self, dst: tuple[ir.Buffer], src: tuple[ir.IRNode], orig_src: tuple[ir.IRNode] | None = ..., epilogue_nodes: list[ir.IRNode] | None = ..., offsets: list[Any] | None = ..., reindexers: list[Callable[[list[Any]], list[Any]] | None] | None = ..., multi_output_buffers: tuple[ir.MultiOutput, ...] | None = ...): # -> str:
        ...
...
class CppTemplateCaller(ir.ChoiceCaller):
    ...
    """
    def __init__(self, name: str, category: str, input_nodes: list[ir.Buffer], layout: ir.Layout, make_kernel_render: Callable[[ir.CppTemplateBuffer, bool, list[ir.IRNode] | None], str,], bmreq: CppBenchmarkRequest, template: CppTemplate, info_kwargs: dict[str, ir.PrimitiveInfoType | list[ir.PrimitiveInfoType]] | None = ...) -> None:
        ...

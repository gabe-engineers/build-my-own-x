...
from torch._inductor.autotune_process import SubgraphCPUBenchmarkRequest, SubgraphGPUBenchmarkRequest
...
class SubgraphChoiceCaller(ir.ChoiceCaller):
    ...
    @property
    def bmreq(self) -> SubgraphGPUBenchmarkRequest | SubgraphCPUBenchmarkRequest:
...
class SubgraphTemplate(KernelTemplate):
    ...
    def generate_custom_op_choices(self, name: str, decompositions: list[Callable[..., Any]], input_nodes: list[Buffer], non_tensor_args: list[dict[str, Any]], default_impl: Callable[..., Any] | None = ..., input_gen_fns: dict[int, Callable[[Any], torch.Tensor]] | None = ..., config_patches_list: list[dict[str, Any]] | None = ...) -> list[SubgraphChoiceCaller]:
        """

...
from torch._inductor.scheduler import BaseSchedulerNode, BaseScheduling, FusedSchedulerNode, Scheduler, SchedulerNode
...
class XPUCombinedScheduling(BaseScheduling):
    ...
    def generate_kernel_code_from_nodes(self, nodes: Sequence[Any], benchmark_kernel: bool = ..., hint_override: int | None = ...) -> str:
        ...

...
from .. import config
from ..scheduler import BaseSchedulerNode, FusedExternTritonKernelSchedulerNode, Scheduler
...
class TritonOverrides(OpOverrides):
    ...
    @staticmethod
    def inline_asm_elementwise(*inputs, asm, constraints=..., dtype=..., is_pure=..., pack=..., input_dtypes=...): # -> str:
        ...
    ...
    @staticmethod
    def rand_eager(seed, base_offset, threads_per_round, tid, vec): # -> str:
        ...
...
class BlockParameters:
    ...
    class StrideSorter:
        ...
        @classmethod
        @abstractmethod
        def create(cls, original_strides: list[int | sympy.Expr], shape_env: ShapeEnv) -> BlockParameters.StrideSorter:
...
class TritonKernel(SIMDKernel[TritonCSEVariable]):
    ...
    def __init__(self, tiling: dict[str, sympy.Expr], min_elem_per_thread=..., optimize_mask=..., fixed_config: FixedTritonConfig | None = ..., hint_override: int | None = ..., is_combo_kernel: bool = ..., **kwargs) -> None:
        ...
    ...
    def indexing(self, index: sympy.Expr, *, copy_shape: str | tuple[str] | None = ..., dense_indexing=..., override_mask=..., block_ptr=..., tma_compatibility_checker: TMACompatibilityChecker | None = ...): # -> BlockDescriptorOptions | IndexingOptions:
        """
        Compute the index and mask to pass to tl.load() or tl.store()
        """
        ...
    
    def codegen_block_ptr(self, name: str, var: str, indexing: BlockPtrOptions | TensorDescriptorOptions, other=...) -> tuple[str, str]:
...
class FusedUserDefinedTritonKernel(TritonKernel):
    ...
    """
    def __init__(self, tiling: dict[str, sympy.Expr], features: SIMDKernelFeatures, scheduler_node: FusedExternTritonKernelSchedulerNode) -> None:
        ...

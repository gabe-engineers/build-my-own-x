...
TritonGrid = (tuple[int | sympy.Expr, ...] | Callable[[TritonMetaParams], tuple[int, ...]])
def user_defined_kernel_grid_fn_code(name: str, configs: list[triton.Config], grids: list[TritonGrid], wrapper: PythonWrapperCodegen | None = ..., original_fxnode_name: str | None = ...) -> tuple[str, str]:
    ...

def user_defined_triton_kernel_transitive_closure_source_code(kernel, epilogue_fusion: tuple[ir.ComputedBuffer, str] | None = ...) -> str:
    """
...
class PythonWrapperCodegen(CodeGen):
    ...
    @staticmethod
    def create(is_subgraph: bool, subgraph_name: str | None, parent_wrapper: PythonWrapperCodegen | None, partition_signatures: ir.GraphPartitionSignature | None = ...): # -> SubgraphPythonWrapperCodegen | PythonWrapperCodegen:
        ...
    ...
    def codegen_device_guard_enter(self, device_idx: int, num_streams: int = ..., stream_idx_to_user_obj_idx: dict[int, int] | None = ...) -> None:
        ...
    
    def codegen_device_guard_exit(self) -> None:
        ...
    
    def codegen_cuda_stream_enter(self, stream_idx: int) -> EnterCudaStreamContextLine:
    ...
    def define_kernel(self, kernel_name: str, kernel_body: str, metadata: str | None = ..., gpu: bool = ..., cpp_definition: str | None = ...): # -> None:
        ...
    
    def define_subgraph_launcher_fn(self, name: str, subgraph_code): # -> None:
        ...
    
    def define_user_defined_triton_kernel(self, kernel, configs, kwargs, restore_value_args, reset_to_zero_args, grids: list[list[int | sympy.Expr]], epilogue_fusion: tuple[ir.ComputedBuffer, str] | None): # -> tuple[str, dict[str, Any], dict[str, Any], list[Expr] | list[Symbol]]:
        ...
    ...
    def write_kernel_context_guard(self, kernel_name: str, node_schedule: Sequence[BaseSchedulerNode] | ExternKernel): # -> None:
        ...
...
class SubgraphPythonWrapperCodegen(PythonWrapperCodegen):
    ...
    """
    def __init__(self, subgraph_name: str, parent_wrapper: PythonWrapperCodegen, partition_signatures: ir.GraphPartitionSignature | None = ...) -> None:
        ...
    ...
    def get_graph_inputs(self) -> dict[str, ir.TensorBox | ir.TorchBindObject | sympy.Expr | None]:
        ...

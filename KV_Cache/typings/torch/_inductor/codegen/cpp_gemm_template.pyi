...
class CppGemmTemplate(CppTemplate):
    ...
    """
    def __init__(self, input_nodes, layout: ir.Layout, num_threads: int, register_blocking: GemmBlocking, beta=..., alpha=..., has_bias=..., epilogue_creator: Callable[[ir.Buffer], ir.Pointwise] | None = ..., should_block_weights: bool = ..., name=...) -> None:
        ...
    ...
    @classmethod
    def add_choices(cls, choices, layout, input_nodes, beta=..., alpha=..., has_bias=..., trans_w=..., input_indices=..., epilogue_creator: Callable[[ir.Buffer], ir.Pointwise] | None = ..., act_mapping: dict[int, ir.IRNode] | None = ...): # -> DataProcessorTemplateWrapper:
        """
    ...
    def get_options(self, kernel: CppTemplateKernel, template_buffer_node: ir.CppTemplateBuffer | None = ..., flag_template_buffer_has_other_users: bool | None = ..., epilogue_nodes: list[ir.IRNode] | None = ...) -> dict[str, Any]:
        ...
    ...
    def render(self, kernel: CppTemplateKernel, template_buffer_node: ir.CppTemplateBuffer | None = ..., flag_template_buffer_has_other_users: bool | None = ..., epilogue_nodes: list[ir.IRNode] | None = ..., **kwargs) -> str:
        ...

...
class IterationRangesRoot(IterationRanges):
    ...
    """
    def __init__(self, name: str, numel: sympy.Expr, prefix: str, index: int, kernel: SIMDKernel, pid_cache: dict[str, str] | None = ..., *, is_loop: bool, tensor_dim: int | None, grid_dim: int | None, has_zdim: bool) -> None:
        ...
...
class SIMDKernel(Kernel[CSEVariableType], Generic[CSEVariableType]):
    ...
    kernel_name: str
    def __init__(self, tiling: dict[str, sympy.Expr], features: SIMDKernelFeatures, pid_cache: dict[str, str] | None = ..., override_persistent_reduction: bool | None = ..., override_cooperative_reduction: bool | None = ..., tiling_scores: dict[str, sympy.Expr] | None = ..., mix_order_reduction: bool = ...) -> None:
        ...
    ...
    def call_kernel(self, name: str, node: IRNode | None = ..., deallocate_ws: bool = ...) -> None:
        ...
...
class SIMDScheduling(BaseScheduling):
    ...
    def benchmark_codegened_module(self, mod, n_spills_threshold=..., node_names: OrderedSet[str] | None = ...) -> tuple[float, str]:
        ...
    ...
    def codegen_template(self, template_node, epilogue_nodes, prologue_nodes, *, only_gen_src_code=..., hint_override: int | None = ...) -> str | None:
        """
    ...
    def generate_combo_kernel_code(self, subkernel_nodes: list[BaseSchedulerNode], custom_part_algorithm: bool, enable_autotune: bool, mixed_sizes: bool, only_gen_src_code: bool = ...) -> list[tuple[str | None, Any, Any]]:
        """
    ...
    @classmethod
    def select_tiling(cls, node_schedule, numel, reduction_numel=..., coalesce_analysis: CoalesceVarAnalysis | None = ...) -> dict[str, sympy.Expr]:
        ...
    
    @classmethod
    def get_tiling_and_scores(cls, node_schedule, numel, reduction_numel=..., coalesce_analysis: CoalesceVarAnalysis | None = ...) -> tuple[dict[str, sympy.Expr], dict[str, sympy.Expr] | None]:
        """
    ...
    def generate_kernel_code_from_nodes(self, nodes, benchmark_kernel=..., hint_override: int | None = ...): # -> str | Any:
        ...

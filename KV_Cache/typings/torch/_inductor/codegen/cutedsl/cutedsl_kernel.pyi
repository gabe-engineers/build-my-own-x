...
class CuteDSLTemplateKernel(Kernel):
    ...
    """
    def __init__(self, kernel_name: str, input_nodes: list[Buffer], output_node: Buffer, subgraphs: list[Buffer] | None = ...) -> None:
        ...
    ...
    def modification(self, subgraph_number: int, output_name: str | None, mask: str | None = ..., **fixed_inputs) -> str:

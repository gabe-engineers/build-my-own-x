...
class CppWrapperCpu(PythonWrapperCodegen):
    ...
    @staticmethod
    def create(is_subgraph: bool, subgraph_name: str | None, parent_wrapper: PythonWrapperCodegen | None, partition_signatures: ir.GraphPartitionSignature | None = ...): # -> CppWrapperCpu:
        ...
    ...
    def generate_c_shim_extern_kernel_call(self, kernel: str, args: list[str], device: str, *, debug_args: list[str] | None = ..., stack_traces: OrderedSet[str] | None = ...) -> None:
    ...
    def generate_extern_kernel_args_decl_if_needed(self, op_overload: torch._ops.OpOverload | torch._ops.HigherOrderOperator, raw_args: Sequence[Any], output_args: _OUTPUT_ARGS_TYPE, raw_outputs: Sequence[ir.Buffer]): # -> tuple[list[Any], list[Any]]:
        """

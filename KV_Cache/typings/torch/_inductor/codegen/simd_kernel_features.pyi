...
class SIMDKernelFeatures:
    ...
    """
    def __init__(self, node_schedule: list[NodeScheduleEntry], numel: sympy.Expr, reduction_numel: sympy.Expr = ..., coalesce_analysis: CoalesceVarAnalysis | None = ...) -> None:
        ...
    ...
    def get_reduction_hint(self, tiling_scores: dict[str, int] | None = ...) -> ReductionHint:
        ...

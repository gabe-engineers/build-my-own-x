...
class CppWrapperMps(CppWrapperGpu):
    ...
    @staticmethod
    def create(is_subgraph: bool, subgraph_name: str | None, parent_wrapper: PythonWrapperCodegen | None, partition_signatures: GraphPartitionSignature | None = ...) -> CppWrapperMps:
        ...

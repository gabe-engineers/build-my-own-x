...
class WrapperFxCodegen(PythonWrapperCodegen):
    ...
    def define_subgraph_launcher_fn(self, name: str, subgraph_code: ValueWithLineMap | FileBackedGraphModule) -> None:
        """
    ...
    def get_fx_graph_inputs(self) -> dict[str, ir.TensorBox | ir.TorchBindObject | sympy.Expr | None]:
        """
    ...
    @classmethod
    def create(cls: type[WrapperFxCodegen], is_subgraph: bool, subgraph_name: str | None, parent_wrapper: PythonWrapperCodegen | None, partition_signatures: ir.GraphPartitionSignature | None = ...) -> WrapperFxCodegen:
        ...

...
from typing import Any, ClassVar, Generic, NamedTuple, TYPE_CHECKING
...
class DeviceOpOverrides:
    ...
    def cpp_scratch(self, idx: int, workspace: TritonScratchWorkspace, prefix: str | None = ...) -> tuple[list[str], str] | None:
        ...
...
def register_backend_for_device(device: str, device_scheduling: SchedulingConstructor, device_wrapper_codegen: WrapperConstructor, device_cpp_wrapper_codegen: WrapperConstructor | None = ..., device_fx_wrapper_codegen: WrapperConstructor | None = ..., device_custom_pass: CustomGraphModulePass | None = ..., device_custom_config: ConfigModule | None = ...) -> None:
    ...
...
def get_wrapper_codegen_for_device(device: str, cpp_wrapper: bool = ..., fx_wrapper: bool = ...) -> WrapperConstructor | None:
    ...
...
class OpOverrides(BasicMathOpsMixin, OpDecompositions, OpsHandler[Any]):
    ...
    def indirect_indexing(self, var: OpVarT, size: sympy.Expr | int, check: bool = ..., wrap_neg: bool = ...) -> sympy.Symbol:
        ...
    ...
    def bucketize(self, values: OpVarT, boundaries: tuple[str, sympy.Expr, sympy.Expr, sympy.Expr], boundary_indices: OpVarT, indexing_dtype: torch.dtype, right: bool, sorter: tuple[str, sympy.Expr] | None = ..., sorter_indices: OpVarT | None = ...) -> OpVarT:
        ...
    ...
    def inline_asm_elementwise(self, *inputs: OpVarT, asm: str, constraints: str | None = ..., dtype: torch.dtype = ..., is_pure: bool = ..., pack: int = ..., input_dtypes: tuple[torch.dtype, ...] | None = ...) -> OpVarT:
        ...
...
class KernelArgs:
    ...
    def cpp_argdefs(self, dtype_to_cpp_type: dict[torch.dtype, str] | None = ...) -> tuple[list[str], list[str], list[str]]:
        ...
...
class CSEVariable:
    ...
    """
    def __init__(self, name: str, bounds: ValueRanges[Any], dtype: torch.dtype | None = ..., shape: BlockShapeType = ...) -> None:
        ...
...
class CSE(Generic[CSEVariableType, AugmentedKeyT]):
    ...
    def __init__(self, prefix: str = ..., suffix: str = ..., name_prefix: str = ..., iter_buffers: itertools.count[int] | None = ..., store_cache: MutableMapping[str, CSEVariableType] | None = ..., reduction_cache: MutableMapping[ReductionCacheKey, CSEVariableType] | None = ..., varname_map: dict[str, CSEVariableType] | None = ...) -> None:
        ...
    ...
    def generate(self, buffer: IndentedBuffer, expr: str | CSEVariable | OpsValue | IndentedBuffer | DeferredLineBase, *, bounds: ValueRanges[Any] = ..., write: bool = ..., assignment: bool = ..., dtype: torch.dtype | None = ..., shape: BlockShapeType = ...) -> CSEVariableType:
        ...
    
    def newvar(self, bounds: ValueRanges[Any] = ..., dtype: torch.dtype | None = ..., shape: BlockShapeType = ...) -> CSEVariableType:
        ...
    
    def namedvar(self, name: str, bounds: ValueRanges[Any] = ..., dtype: torch.dtype | None = ..., shape: BlockShapeType = ...) -> CSEVariableType:
        ...
...
class Kernel(CodeGen, Generic[CSEVariableType]):
    ...
    @contextlib.contextmanager
    def swap_buffers(self, lb: IndentedBuffer, cb: IndentedBuffer | None = ..., sb: IndentedBuffer | None = ...) -> Iterator[None]:
        ...
    ...
    def bucketize(self, values: CSEVariable, boundaries: tuple[str, sympy.Expr, sympy.Expr, sympy.Expr], boundary_indices: CSEVariable, indexing_dtype: torch.dtype, right: bool, sorter: tuple[str, sympy.Expr] | None = ..., sorter_indices: CSEVariable | None = ...) -> CSEVariable:
        """
    ...
    def indirect_assert(self, var: CSEVariable | str, lower: str | None, upper: str | None, mask: CSEVariable | str | None = ...) -> str:
        ...
...
class CSEProxy(DefaultHandler):
    ...
    def indirect_indexing(self, var: CSEVariable, size: sympy.Expr | int, check: bool = ..., wrap_neg: bool = ...) -> sympy.Symbol:
        ...

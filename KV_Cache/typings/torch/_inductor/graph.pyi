...
class GraphLowering(torch.fx.Interpreter):
    ...
    def __init__(self, gm: torch.fx.GraphModule, example_inputs: Sequence[object] | None = ..., shape_env: ShapeEnv | None = ..., graph_id: int | None = ..., cpp_wrapper: bool = ..., aot_mode: bool = ..., layout_opt: bool | None = ..., extern_node_serializer: Callable[[list[ir.ExternKernelNode]], Any] | None = ..., is_inference: bool = ..., is_backward: bool = ..., is_const_graph: bool = ..., const_output_index: dict[str, int] | None = ..., const_wrapper_code: str | None = ..., const_kernel_code: str | None = ..., const_module: GraphLowering | None = ..., name: str | None = ..., inputs_to_check: Sequence[int] | None = ..., fx_wrapper: bool = ..., get_decomp_fn: Callable[..., dict[Any, Callable[..., Any]]] | None = ...) -> None:
        ...
    ...
    def add_tensor_constant(self, data: Tensor, name: str | None = ...) -> TensorBox:
        ...
    ...
    def get_attr(self, target: str, args: tuple[()], kwargs: dict[str, object]) -> Constant | TensorBox | ShapeAsConstantBuffer | ir.Subgraph | TorchBindObject:
        ...
    ...
    @typing_extensions.override
    def output(self, target: torch.fx.node.Target, args: tuple[torch.fx.node.Argument, ...], kwargs: dict[str, object]) -> None:
        ...
    ...
    def init_wrapper_code(self, is_subgraph: bool = ..., subgraph_name: str | None = ..., parent_wrapper_code: PythonWrapperCodegen | None = ..., partition_signatures: GraphPartitionSignature | None = ...) -> None:
        ...

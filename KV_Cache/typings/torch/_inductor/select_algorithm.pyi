...
class AutotuneArgs:
    ...
    @classmethod
    def from_choice_args(cls, example_inputs: list[torch.Tensor], example_inputs_extern: list[torch.Tensor], out: torch.Tensor, out_extern: torch.Tensor, expected: torch.Tensor | None = ...) -> Self:
...
class SubgraphInfo:
    ...
    template_out_shape: str | tuple[str] | None = ...
    ...
    range_tree_nodes: dict[sympy.Symbol, IterationRangesEntry] | None = ...
    numels: dict[str, sympy.Expr] | None = ...
    root_var_renames: dict[str, str] = ...
...
class ModificationWrapper(V.WrapperHandler):
    ...
    def __init__(self, kernel, subgraph_number: int, fixed_inputs: dict[str, Any], mask: str | None, input_shapes: dict[str, tuple[str, ...]] | None = ...) -> None:
        ...
...
class TritonTemplateKernel(TritonKernel):
    ...
    def size(self, name: str | None, index: int): # -> str:
        """
    ...
    def modification(self, subgraph_number: int, output_name: str | None, mask: str | None = ..., input_shapes: dict[str, tuple[str, ...]] | None = ..., **fixed_inputs) -> str:
    ...
    def load_input(self, input_name: str, output_name: str, indices: list[Any] | tuple[Any], mask: str | None = ..., other: float | int | None = ..., indent_width: int = ..., index_shape: tuple[str] | None = ...): # -> str:
    ...
    def store_output(self, indices: list[Any] | tuple[Any], val: str, mask: str | None = ..., indent_width: int = ..., val_shape: tuple[str] | None = ..., block_indexing: bool = ...): # -> str:
    ...
    def indexing(self, index: sympy.Expr, *, dense_indexing=..., copy_shape=..., override_mask=..., block_ptr=..., tma_compatibility_checker: TMACompatibilityChecker | None = ...): # -> BlockDescriptorOptions | IndexingOptions:
        """
    ...
    def call_kernel(self, name: str, node: ir.IRNode | None = ..., deallocate_ws: bool = ...): # -> None:
        ...
    ...
    def codegen_template_body(self, scheduling, template_node, epilogue_nodes, prologue_nodes, buf_name_to_prologue_group, prologue_preserves_zero_mask_fn, render) -> str:
    ...
    def codegen_prologues_in_subgraphs(self, buf_name_to_prologue_group, prologue_preserves_zero_mask_fn): # -> None:
...
class ExternalTritonTemplateKernel(TritonTemplateKernel):
    ...
    def call_kernel(self, name, node=..., deallocate_ws=...): # -> None:
        """Emit the kernel call, multi-output unpacking, and unfused epilogues."""
        ...
    
    def emit_kernel_override(self, wrapper, src_code, kernel_name, node_schedule, kernel_path, get_kernel_metadata): # -> Literal[True]:
        ...
...
class GeneratedCodeCache:
    ...
    def make_key(self, input_nodes: tuple[ir.IRNode, ...], num_stages: int, num_warps: int, call_sizes: Sequence[sympy.core.symbol.Symbol], prefix_args: int, suffix_args: int, epilogue_fn: Callable[..., Any] | None, epilogue_fn_hash: str | None, tma_store: bool, transpose_discontiguous_tensor_descriptors_override: bool | None, subgraphs: list[ir.Buffer] | None, workspace_arg: WorkspaceArg | None, layout: ir.Layout, num_consumer_groups: int, num_buffers_warp_spec: int, kwargs: dict[str, Any], hint_override: int | None = ..., triton_meta: dict[str, Any] | None = ...) -> str | None:
        ...
...
class TritonTemplate(KernelTemplate):
    ...
    def __init__(self, name: str, grid: Any, source: str, debug=..., cache_codegen_enabled_for_template=..., prologue_loads_all_inputs=..., always_freeze_layout: bool = ...) -> None:
        ...
    ...
    def generate_and_load(self, input_nodes: tuple[ir.IRNode, ...], num_stages: int, num_warps: int, call_sizes: Sequence[sympy.core.symbol.Symbol], prefix_args: int, suffix_args: int, epilogue_fn: Callable[..., Any] | None, epilogue_fn_hash: str | None, subgraphs: list[ir.Buffer] | None, workspace_arg: WorkspaceArg | None, num_consumer_groups: int, num_buffers_warp_spec: int, layout: ir.Layout, kwargs: dict[str, Any], generate_with_caching, hint_override: int | None = ..., tma_store: bool = ..., transpose_discontiguous_tensor_descriptors_override: bool | None = ..., triton_meta: dict[str, Any] | None = ...) -> GenerateAndLoadResult | None:
        """Generate the python code and load it into the current process"""
        ...
    
    def generate(self, input_nodes: tuple[ir.IRNode, ...], layout: ir.Layout, num_stages: int, num_warps: int, num_consumer_groups: int = ..., num_buffers_warp_spec: int = ..., prefix_args: int = ..., suffix_args: int = ..., epilogue_fn: Callable[..., Any] | None = ..., epilogue_fn_hash: str | None = ..., subgraphs: list[ir.Buffer] | None = ..., mutated_inputs: list[ir.IRNode] | None = ..., call_sizes: Sequence[sympy.core.symbol.Symbol] | None = ..., workspace_arg: WorkspaceArg | None = ..., generate_with_caching=..., hint_override: int | None = ..., tma_store: bool = ..., transpose_discontiguous_tensor_descriptors_override: bool | None = ..., triton_meta: dict[str, Any] | None = ..., **kwargs): # -> TritonTemplateCaller | None:
...
class TritonTemplateCaller(ir.TritonTemplateCallerBase):
    ...
    """
    def __init__(self, name, input_nodes, layout, make_kernel_render, description, bmreq, log_info: dict[str, PrimitiveInfoType | list[PrimitiveInfoType]] | None = ..., mutated_inputs=..., workspace_arg: WorkspaceArg | None = ..., allowed_prologue_inps: OrderedSet[str] | None = ..., hint_override: int | None = ...) -> None:
        ...
...
class AlgorithmSelectorCache(PersistentCache):
    ...
    def __call__(self, name, choices: list[ChoiceCaller], input_nodes, layout, input_gen_fns: dict[int, Callable[[ir.Buffer], torch.Tensor]] | None = ..., precompilation_timeout_seconds: int = ..., return_multi_template=..., best_config_future=..., is_collective=..., min_speedup_threshold: float = ..., benchmark_with_cudagraphs: bool = ...): # -> tuple[TensorBox, ChoiceCaller] | tuple[Any, None] | tuple[ShapeAsConstantBuffer, ExternKernelCaller] | tuple[TensorBox, CUTLASSTemplateCaller | ChoiceCaller] | tuple[TensorBox | Any, Any | ChoiceCaller]:
        ...
    
    def benchmark(self, choices, input_nodes, layout, input_gen_fns, hint_override: int | None = ..., is_collective=...): # -> dict[ChoiceCaller, float]:
        ...
    
    def autotune(self, name, input_nodes, layout, input_gen_fns, choices, hint_override: int | None = ..., is_collective=...): # -> dict[ChoiceCaller, float]:
        ...
    
    def do_autotuning(self, name, input_nodes, layout, input_gen_fns, inputs_key, choices, precompile_fn, hint_override: int | None = ..., best_config_future=..., is_collective=...): # -> dict[Any, Any] | dict[ChoiceCaller, float] | None:
    ...
    def make_precompile_fn(self, choices, name: str, inputs_key: str, precompilation_timeout_seconds: int | None = ...) -> Callable[[], dict[ChoiceCaller, float]]:
        """
    ...
    @classmethod
    def get_inputs(cls, choices: Sequence[ChoiceCaller], input_nodes: list[ir.IRNode], layout: ir.Layout, input_gen_fns: dict[int, Callable[[ir.Buffer], torch.Tensor]] | None, hint_override: int | None = ...) -> AutotuneArgs:
        """
    ...
    @classmethod
    def benchmark_in_current_process(cls, choices: Sequence[ChoiceCaller], input_nodes: list[ir.IRNode], layout: ir.Layout, input_gen_fns: dict[int, Callable[[ir.Buffer], torch.Tensor]] | None, hint_override: int | None = ..., is_collective=...) -> dict[ChoiceCaller, float]:
        ...
    
    @classmethod
    def benchmark_in_sub_process(cls, choices: Sequence[ChoiceCaller], input_nodes: list[ir.IRNode], layout: ir.Layout, input_gen_fns: dict[int, Callable[[ir.Buffer], torch.Tensor]] | None, hint_override: int | None = ...): # -> dict[ChoiceCaller, float]:
        ...
    
    @classmethod
    def make_benchmark_fn(cls, choices: Sequence[ChoiceCaller], input_nodes: list[ir.IRNode], layout: ir.Layout, input_gen_fns: dict[int, Callable[[ir.Buffer], torch.Tensor]] | None, hint_override: int | None = ..., is_collective=...): # -> partial[dict[ChoiceCaller, float]]:
        ...
    ...
    @staticmethod
    def maybe_log_mm_results(name: str, input_nodes: list[ir.IRNode], timings: dict[ChoiceCaller, float]) -> None:
        """Log matrix multiplication autotuning results."""
        ...
    
    @staticmethod
    def maybe_log_conv_results(name: str, input_nodes: list[ir.IRNode], timings: dict[ChoiceCaller, float]) -> None:
    ...
    @staticmethod
    def log_results(name: str, input_nodes: list[ir.IRNode], timings: dict[ChoiceCaller, float], elapse: float, precompile_elapse: float, prescreening_elapse: float | None = ..., hint_override: int | None = ..., is_collective: bool = ...): # -> None:
...
def autotune_select_algorithm(*args, **kwargs): # -> tuple[TensorBox, ChoiceCaller] | tuple[Any, None] | tuple[ShapeAsConstantBuffer, ExternKernelCaller] | tuple[TensorBox, CUTLASSTemplateCaller | ChoiceCaller] | tuple[TensorBox | Any, Any | ChoiceCaller]:
    ...
...
def get_strides_with_layout_constraints(node): # -> Sequence[Expr]:
    ...

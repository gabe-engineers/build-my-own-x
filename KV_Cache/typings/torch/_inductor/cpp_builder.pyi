...
def batch_convert_cubins_to_obj(cubins: list[tuple[str, str]], output_dir: str, cpp_compiler: str = ...) -> str:
...
class BuildOptionsBase:
    ...
    """
    def __init__(self, compiler: str = ..., definitions: list[str] | None = ..., include_dirs: list[str] | None = ..., cflags: list[str] | None = ..., ldflags: list[str] | None = ..., libraries_dirs: list[str] | None = ..., libraries: list[str] | None = ..., passthrough_args: list[str] | None = ..., aot_mode: bool = ..., use_relative_path: bool = ..., compile_only: bool = ..., precompiling: bool = ..., preprocessing: bool = ...) -> None:
        ...
...
class CppTorchDeviceOptions(CppTorchOptions):
    ...
    """
    def __init__(self, vec_isa: VecISA = ..., include_pytorch: bool = ..., device_type: str = ..., aot_mode: bool = ..., compile_only: bool = ..., use_relative_path: bool = ..., use_mmap_weights: bool = ..., use_mmap_weights_external: bool = ..., shared: bool = ..., extra_flags: Sequence[str] = ..., min_optimize: bool = ..., precompiling: bool = ..., preprocessing: bool = ..., compiler: str = ...) -> None:
        ...

...
def estimate_collective_time(n: fx.Node, override_size: int | None = ..., custom_runtime_estimation: Callable[[fx.Node, int | None], float | None] | None = ..., collective_estimator: Literal["analytical", "benchmark"] = ...) -> float:
...
class OverlapScheduler:
    ...
    """
    def __init__(self, gm: torch.fx.GraphModule, max_in_flight_gb: float, max_compute_pre_fetch: int, collective_bucketing: bool, insert_overlap_deps: bool, compute_overlap_multipler: float, max_coll_distance: int, custom_runtime_estimation: Callable[[fx.Node, int | None], float | None] | None = ..., collective_estimator: Literal["analytical", "benchmark"] = ..., compute_estimator: Literal["analytical", "benchmark"] = ..., max_memory_increase_gb: float | None = ..., max_memory_increase_ratio: float | None = ..., log_final_collectives_estimations: bool = ..., bucket_exposed_first: bool | None = ..., enable_fusion_regions: bool = ..., bucket_only_internode_comms: bool = ..., bucket_mode: BucketMode | None = ..., max_off_bucket_gb: float | None = ..., prioritize_bucketing_during_scheduling: bool = ...) -> None:
        ...
...
def gather_node_runtime_estimations(gm: torch.fx.GraphModule, custom_runtime_estimation: Callable[[fx.Node, int | None], float | None] | None = ..., collective_estimator: Literal["analytical", "benchmark"] = ..., enable_fusion_regions: bool = ..., log_estimations: bool = ...) -> tuple[dict[fx.Node, float], dict[fx.Node, Any]]:
...
def align_estimations_across_ranks(estimations: dict[fx.Node, float]) -> dict[fx.Node, float]:
...
def schedule_overlap_bucketing(gm: torch.fx.GraphModule, max_in_flight_gb: float = ..., max_compute_pre_fetch: int = ..., collective_bucketing: bool = ..., insert_overlap_deps: bool = ..., compute_overlap_multipler: float = ..., max_coll_distance: int = ..., custom_runtime_estimation: Callable[[fx.Node, int | None], float | None] | None = ..., collective_estimator: Literal["analytical", "benchmark"] = ..., compute_estimator: Literal["analytical", "benchmark"] = ..., max_memory_increase_gb: float | None = ..., max_memory_increase_ratio: float | None = ..., log_final_collectives_estimations: bool = ..., bucket_exposed_first: bool | None = ..., enable_fusion_regions: bool = ..., bucket_only_internode_comms=..., prioritize_bucketing_during_scheduling: bool = ..., max_off_bucket_gb: float | None = ..., bucket_mode: BucketMode | None = ...) -> torch.fx.GraphModule:

...
class OverlapPreservingBucketer:
    ...
    """
    def __init__(self, graph: fx.Graph, collective_info: dict[fx.Node, CollectiveInfo], scheduled: OrderedSet[fx.Node], max_bucket_memory_gb: float = ..., max_coll_distance: int = ..., insert_overlap_deps: bool = ..., collective_bucketing: bool = ..., bucket_mode: BucketMode | None = ..., bucket_exposed_first: bool | None = ..., region_of: dict[fx.Node, Any] | None = ..., bucket_only_internode_comms: bool = ...) -> None:
        ...
    ...
    def restore_to_event(self, node: fx.Node, prev_event: PGEvent | None, next_event: PGEvent | None) -> None:
        """Restore node to timeline after failed merge attempt."""
        ...
    


def finalize_overlap_scheduling(gm: fx.GraphModule, collective_info: dict[fx.Node, CollectiveInfo], scheduled: OrderedSet[fx.Node], *, collective_bucketing: bool = ..., insert_overlap_deps: bool = ..., max_bucket_memory_gb: float = ..., max_coll_distance: int = ..., region_of: dict[fx.Node, Any] | None = ..., bucket_exposed_first: bool | None = ..., bucket_only_internode_comms: bool = ..., bucket_mode: BucketMode | None = ...) -> None:
    """

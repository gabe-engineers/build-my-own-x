...
aten = ...
log = ...
def set_chunking_meta(node: Node, meta: ChunkingMeta | None = ..., **kwargs: Any) -> bool:
    """
...
def set_chunking_meta_if_none(nodes: Sequence[Node], meta: ChunkingMeta, filter_for_nop: Callable[[Node], bool] | None = ...) -> bool:
    """

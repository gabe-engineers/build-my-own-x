...
class AsyncCompile:
    ...
    _metal_sources: list[tuple[str, str, list[str]]] | None = ...
    ...
    def cutlass(self, cache_cls, source_code, dst_file_ext, aot_compile=...): # -> Any:
        ...
    
    def cuda(self, source_code, dst_file_ext, aot_compile=...): # -> Any:
        ...
    
    def xpu(self, source_code, dst_file_ext, aot_compile=...): # -> Any:
        ...

...
class InductorChoices:
    ...
    def get_conv_configs(self, device_type: str | None = ...) -> partial[Generator[TritonConfig, None, None]]:
        ...
    
    def get_depthwise_conv_configs(self, device_type: str | None = ...) -> list[Any]:
        ...
    
    def get_flex_attention_fwd_configs(self, head_dim: int, dtype: torch.dtype, device_type: str | None = ...) -> list[Any]:
        ...
    
    def get_flex_attention_bwd_configs(self, head_dim: int, dtype: torch.dtype, device_type: str | None = ...) -> list[Any]:
        ...
    
    def get_flex_decode_configs(self, head_dim: int, dtype: torch.dtype, device_type: str | None = ...) -> list[Any]:
        ...
    
    def get_ktc(self, kernel_inputs: KernelInputs, template: KernelTemplate | ExternKernelChoice, op_name: str, kwarg_overrides: dict[str, Any] | None = ...) -> Generator[KernelTemplateChoice, None, None]:
        """
    ...
    def get_template_configs(self, kernel_inputs: KernelInputs, templates: list[KernelTemplate | ExternKernelChoice], op_name: str, kwarg_overrides: dict[str, dict[str, Any]] | None = ...) -> list[ChoiceCaller]:
        """
    ...
    def override_best_choice(self, best_choice: ChoiceCaller, timings: dict[ChoiceCaller, float]) -> ChoiceCaller:

...
def cudagraphify(model: ModelType, inputs: list[InputType], static_input_idxs: Sequence[int] = ..., *, device_index: int, is_backward: bool, is_inference: bool, stack_traces: StackTraces | None = ..., constants: tuple[torch.Tensor, ...] = ..., placeholders: tuple[PlaceholderInfo, ...] = ..., mutated_input_idxs: tuple[int, ...] = ..., compile_id: CompileId | None = ...) -> tuple[ModelType, OutputType]:
    ...
...
class StorageWeakRefWrapper:
    ...
    @classmethod
    def from_weakref_and_data_ptr(cls: type[StorageWeakRefWrapper], cdata: Any, data_ptr: int, extra_ref_check: Callable[[], bool] | None = ...) -> StorageWeakRefWrapper:
        ...
...
class CUDAGraphNode:
    ...
    """
    def __init__(self, wrapped_function: WrappedFunction, id: GraphID, parent: CUDAGraphNode | None, inputs: list[InputType], cuda_graphs_pool: _POOL_HANDLE, device_index: int, stack_traces: StackTraces | None, stream: torch.cuda.Stream, mode: CompilationMode | None, compile_id: CompileId | None) -> None:
        ...

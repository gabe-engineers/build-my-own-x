...
def find_broadcast_var(index: sympy.Expr, var_ranges: dict[sympy.Expr, int]) -> sympy.Expr | None:
    """
...
def get_pw_red_splits(n: SchedulerNode, pointwise_numel: sympy.Expr, red_numel: sympy.Expr, none_if_not_divisible: bool = ...) -> tuple[VarsAndRanges, VarsAndRanges] | None:
    ...
...
def extract_normalized_read_writes(node: Union[FusedSchedulerNode, SchedulerNode]) -> FusedNormalizedReadsWrites | None:
...
def analyze_memory_coalescing(fused_node: Union[FusedSchedulerNode, SchedulerNode]) -> CoalesceVarAnalysis | None:
    """

...
def update_orig_fx_node_name_to_buf_name(nodes: SchedulerNodeList | None, node_name_to_buf_name: dict[str, str], parent_buf_name: str | None = ..., n_origins: int = ...) -> None:
    ...
...
save_args_cnt = ...
def create_mapping_pre_post_grad_nodes(pre_grad_graph_id: int | None, post_to_pre_grad_nodes_json: dict[str, Any]) -> dict[str, dict[str, list[str]]]:
    """
...
def set_kernel_post_grad_provenance_tracing(node_schedule: Sequence[BaseSchedulerNode] | ExternKernel, kernel_name: str, is_extern: bool = ...) -> int | None:
    """
...
def aot_inductor_minifier_wrapper(func: Callable[..., str], exported_program: torch.export.ExportedProgram, *, inductor_configs: dict[str, Any], package_path: FileLike | None = ...) -> str:
    ...

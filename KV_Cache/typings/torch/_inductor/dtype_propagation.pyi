...
T = TypeVar("T")
_MISSING_SHAPE = ...
_UNSIGNED_INT_DTYPES: frozenset[torch.dtype] = ...
...
@functools.cache
def get_promoted_dtype(*args: Sequence[tuple[torch.dtype, bool]], type_promotion_kind: ELEMENTWISE_TYPE_PROMOTION_KIND | None = ...):
    ...
...
class DtypePropagationOpsHandler:
    ...
    @staticmethod
    def to_dtype(x: DTypeArg, dtype: torch.dtype, src_dtype: torch.dtype | None = ..., use_compute_types=...) -> torch.dtype:
        ...
    ...
    @staticmethod
    def bucketize(values: DTypeArg, boundaries: tuple[str, sympy.Expr, sympy.Expr, sympy.Expr], boundary_indices: DTypeArg, indexing_dtype: torch.dtype, right: bool, sorter: tuple[str, sympy.Expr] | None = ..., sorter_indices: T | None = ...) -> torch.dtype:
        ...
    ...
    @staticmethod
    def inline_asm_elementwise(*inputs, asm, constraints=..., dtype=..., is_pure=..., pack=..., input_dtypes=...): # -> dtype:
        ...

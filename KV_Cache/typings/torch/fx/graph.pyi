...
class CodeGen:
    ...
    def generate_output(self, output_args: Argument, *, descs: Any | None = ..., repr_fn: Any | None = ...) -> str:
        """
...
class _PyTreeCodeGen(CodeGen):
    ...
    def generate_output(self, output_args, *, descs: Any | None = ..., repr_fn: Any | None = ...): # -> str:
        ...
    


class _ExportCodeGen(_PyTreeCodeGen):
    def __init__(self, pytree_info: _PyTreeInfo, in_shuffle_graph: GraphModule, out_shuffle_graph: GraphModule, tree_leaf_names: list[str], root: torch.nn.Module | None) -> None:
        ...
...
class Graph:
    ...
    """
    @compatibility(is_backward_compatible=True)
    def __init__(self, owning_module: Optional[GraphModule] = ..., tracer_cls: type[Tracer] | None = ..., tracer_extras: dict[str, Any] | None = ...) -> None:
        """
    ...
    @compatibility(is_backward_compatible=True)
    def create_node(self, op: str, target: Target, args: tuple[Argument, ...] | None = ..., kwargs: dict[str, Argument] | None = ..., name: str | None = ..., type_expr: Any | None = ...) -> Node:
        """
    ...
    @compatibility(is_backward_compatible=True)
    def call_module(self, module_name: str, args: tuple[Argument, ...] | None = ..., kwargs: dict[str, Argument] | None = ..., type_expr: Any | None = ...) -> Node:
        """
    ...
    @compatibility(is_backward_compatible=True)
    def call_method(self, method_name: str, args: tuple[Argument, ...] | None = ..., kwargs: dict[str, Argument] | None = ..., type_expr: Any | None = ...) -> Node:
        """
    ...
    @compatibility(is_backward_compatible=True)
    def call_function(self, the_function: Callable[..., Any], args: tuple[Argument, ...] | None = ..., kwargs: dict[str, Argument] | None = ..., type_expr: Any | None = ..., name: str | None = ...) -> Node:
        """
    ...
    @compatibility(is_backward_compatible=True)
    def python_code(self, root_module: str, *, verbose: bool = ..., include_stride: bool = ..., include_device: bool = ..., colored: bool = ..., expanded_def: bool = ..., record_func: bool = ..., additional_meta: list[str] | None = ...) -> PythonCode:
        """
    ...
    @compatibility(is_backward_compatible=False)
    def on_generate_code(self, make_transformer: Callable[[TransformCodeFunc | None], TransformCodeFunc]): # -> _GeneratorContextManager[None, None, None]:

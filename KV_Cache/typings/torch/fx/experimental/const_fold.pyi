...
class FoldedGraphModule(torch.fx.GraphModule):
    ...
    on which attrs.
    """
    def __init__(self, root: torch.nn.Module, graph: torch.fx.Graph, const_subgraph: torch.fx.Graph | None = ..., fx_const_folded_attrs_name: str | None = ..., device_for_folded_attrs: str = ...) -> None:
        ...
...
def split_const_subgraphs(module: torch.nn.Module | torch.fx.GraphModule, skip_folding_node_fn: Callable[[torch.fx.Node], bool] | None = ..., device_for_folded_attrs: str = ...) -> FoldedGraphModule:
    """

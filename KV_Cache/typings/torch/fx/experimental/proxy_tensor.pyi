...
from typing import Any, Literal, Protocol, TYPE_CHECKING, TypeAlias, TypeVar, Union, overload
...
log = ...
not_implemented_log = ...
CURRENT_DECOMPOSITION_TABLE: contextvars.ContextVar[Mapping[OpOverload, Callable[..., Any]]] = ...
...
@contextmanager
def decompose(decomposition_table: Mapping[OpOverload, Callable[..., Any]] | None) -> Generator[Mapping[OpOverload, Callable[..., Any]], None, None]:
    ...
...
@overload
def set_proxy_slot(obj: _AnyScriptObjectType | OpaqueBase, tracer: _ProxyTracer, proxy: Proxy) -> None:
    ...
...
def set_proxy_slot(obj: PySymType | _AnyScriptObjectType | Tensor | OpaqueBase, tracer: _ProxyTracer, proxy: object) -> None:
    ...
...
@overload
def get_proxy_slot(obj: Tensor, tracer: _ProxyTracer, default: U) -> _ProxyTensor | U:
    ...

@overload
def get_proxy_slot(obj: Tensor, tracer: _ProxyTracer, default: U, transform: Callable[[_ProxyTensor], R]) -> R | U:
    ...
...
@overload
def get_proxy_slot(obj: _AnyScriptObjectType, tracer: _ProxyTracer, default: U) -> Proxy | U:
    ...

@overload
def get_proxy_slot(obj: _AnyScriptObjectType, tracer: _ProxyTracer, default: U, transform: Callable[[Proxy], R]) -> R | U:
    ...
...
@overload
def get_proxy_slot(obj: PySymType, tracer: _ProxyTracer, default: T) -> T | _PySymProxyType:
    ...

@overload
def get_proxy_slot(obj: OpaqueBase, tracer: _ProxyTracer, default: T) -> T | _OpaqueObjectProxyType:
    ...

@overload
def get_proxy_slot(obj: PySymType, tracer: _ProxyTracer, default: U, transform: Callable[[_PySymProxyType], R]) -> R | U:
    ...

def get_proxy_slot(obj: Tensor | _AnyScriptObjectType | PySymType | OpaqueBase, tracer: _ProxyTracer, default: object = ..., transform: Callable[..., Any] = ...) -> object:
    ...

def snapshot_fake(val: Tensor, include_real: bool = ...) -> Tensor | None:
    ...

_ExtractValType: TypeAlias = (None | PySymType | OpaqueBase | _AnyScriptObjectType | BackwardState | list["_ExtractValType"] | tuple["_ExtractValType", ...] | dict[str, "_ExtractValType"] | Tensor | int | float | bool)
...
def track_tensor_tree(inner_res: T, proxy_res: _NestedProxys, *, constant: _NestedTensors | None, tracer: _ProxyTracer) -> T:
    ...
...
@overload
def fetch_object_proxy(tracer: _ProxyTracer, t: OpaqueBase) -> _OpaqueObjectProxyType | PySymType:
    ...

def fetch_object_proxy(tracer: _ProxyTracer, t: Tensor | _AnyScriptObjectType | PySymType | OpaqueBase) -> object:
    ...
...
class PythonKeyTracer(Tracer):
    ...
    def create_node(self, kind: str, target: Target, args: tuple[Argument, ...], kwargs: dict[str, Argument], name: str | None = ..., type_expr: Any | None = ...) -> torch.fx.Node:
        ...
    


@torch._disable_dynamo
def dispatch_trace(root: Module | Callable[..., Any], tracer: Tracer, concrete_args: tuple[object, ...] | None = ...) -> GraphModule:
    ...

def wrap_key(f: Callable[[Unpack[_Ts]], R], tensors: tuple[Unpack[_Ts]], tracer: _ProxyTracer, pre_dispatch: bool) -> Callable[_P, R]:
    ...

ORIGINAL_ATEN: contextvars.ContextVar[object | None] = ...
@contextmanager
...
class TorchFunctionMetadataMode(TorchFunctionMode):
    ...
    def __torch_function__(self, func: OpOverload, types: tuple[torch._C._TensorMeta, ...], args: tuple[object, ...] = ..., kwargs: dict[str, object] | None = ...) -> object:
        ...
...
class PreDispatchTorchFunctionMode(TorchFunctionMode):
    ...
    def __torch_function__(self, func: OpOverload | Callable[..., Any], types: tuple[torch._C._TensorMeta, ...], args: tuple[object, ...] = ..., kwargs: dict[str, object] | None = ...) -> object:
        ...
...
class ProxyTorchDispatchMode(TorchDispatchMode):
    ...
    def __init__(self, tracer: _ProxyTracer, tracing_mode: _TracingMode, pre_dispatch: bool = ..., _allow_fake_constant: bool = ..., _error_on_data_dependent_ops: bool = ...) -> None:
        ...
    
    @count
    def __torch_dispatch__(self, func: OpOverload, types: tuple[torch._C._TensorMeta, ...], args: tuple[object, ...] = ..., kwargs: dict[str, object] | None = ...) -> object:
        ...
...
class DecompositionInterpreter(fx.Interpreter):
    def __init__(self, module: fx.GraphModule, new_graph: fx.Graph, decomposition_table: Mapping[OpOverload, Callable[..., Any]] | None = ..., **kwargs: object) -> None:
        ...
...
class _SelectiveDecomposeInterpreter(fx.Interpreter):
    def __init__(self, module: fx.GraphModule, should_decompose: Callable[[fx.Node], bool], decomposition_table: Mapping[OpOverload, Callable[..., Any]] | None, **kwargs: object) -> None:
        """
    ...
    @staticmethod
    def recursive_wrap(gm: fx.GraphModule, should_decompose: Callable[[fx.Node], bool], decomposition_table: Mapping[OpOverload, Callable[..., Any]] | None, **kwargs: object) -> _SelectiveDecomposeInterpreter:
        """
...
def selective_decompose(joint_gm: fx.GraphModule, *args: object, decomposition: Mapping[OpOverload, Callable[..., Any]] | None, should_decompose: Callable[..., bool], trace_joint_graph: bool) -> fx.GraphModule:
...
class _ModuleStackTracer(PythonKeyTracer):
    ...
    def trace(self, root: Module | Callable[..., Any], concrete_args: dict[str, object] | None) -> fx.Graph:
        ...
    
    def call_module(self, m: Module, forward: Callable[..., Any], args: tuple[object, ...], kwargs: dict[str, object]) -> None:
...
class _MakefxTracer:
    def __init__(self, decomposition_table: Mapping[OpOverload, Callable[..., Any]] | None, tracing_mode: _TracingMode, _allow_non_fake_inputs: bool, pre_dispatch: bool, record_module_stack: bool, _allow_fake_constant: bool, _error_on_data_dependent_ops: bool, record_stack_traces: bool = ..., parent_tracer: _MakefxTracer | None = ..., proxy_module_inputs: bool = ..., _disable_torch_fn_metadata_mode: bool = ...) -> None:
        ...
    ...
    def trace_subgraph_custom_decomp(self, f: Callable[..., Any], decomp_table: Mapping[OpOverload, Callable[..., Any]], *args: object) -> GraphModule:
        ...
    


_CURRENT_MAKE_FX_TRACER: _MakefxTracer | None = ...
def make_fx(f: Callable[..., Any], decomposition_table: Mapping[OpOverload, Callable[..., Any]] | None = ..., tracing_mode: _TracingMode = ..., _allow_non_fake_inputs: bool = ..., *, pre_dispatch: bool = ..., record_module_stack: bool = ..., _allow_fake_constant: bool = ..., _error_on_data_dependent_ops: bool = ..., record_stack_traces: bool = ..., proxy_module_inputs: bool = ..., _disable_torch_fn_metadata_mode: bool = ...) -> Callable[..., GraphModule]:
    """
...
def get_isolated_graphmodule(func: Callable[..., Any], args: tuple[object, ...], kwargs: dict[str, object], tracing_mode: _TracingMode = ..., decomposition_table: Mapping[OpOverload, Callable[..., Any]] | None = ...) -> GraphModule:

...
from typing import Any, Generic, NamedTuple, NoReturn, TYPE_CHECKING, TypeAlias, TypeGuard, TypeVar
...
DimList = list
log = ...
def guarding_hint_or_throw(a: torch.SymInt | torch.SymBool | int | bool | SymNode) -> int | bool:
    """
...
def optimization_hint(a: torch.SymInt | int, fallback: int | None = ...) -> int:
    """
...
aten = ...
__all__ = ["optimization_hint", "guarding_hint_or_throw", "guard_or_false", "guard_or_true", "has_symbolic_sizes_strides", "create_contiguous", "ShapeEnv", "is_concrete_int", "is_concrete_float", "is_concrete_bool", "has_static_value", "guard_int", "guard_float", "guard_scalar", "canonicalize_bool_expr", "SYMPY_INTERP", "free_symbols", "is_symbol_binding_fx_node", "is_nested_int", "SHAPEENV_EVENT_KEY", "CURRENT_NODE_KEY", "has_free_symbols", "has_free_unbacked_symbols", "sym_and", "sym_eq", "sym_or", "SymbolicContext", "StatelessSymbolicContext", "StatefulSymbolicContext", "SubclassSymbolicContext", "SymIntSymbolicContext", "TrackedFake", "statically_known_true", "statically_known_false", "guard_size_oblivious", "check_consistent", "compute_unbacked_bindings", "ConvertIntKey", "rebind_unbacked", "resolve_unbacked_bindings", "is_accessor_node", "ValueRangesSLoc", "SymIntEqByExpr", "Specialization"]
SHAPEENV_EVENT_KEY = ...
CURRENT_NODE_KEY = ...
...
def compute_unbacked_bindings(shape_env: ShapeEnv | None, example_value: object, old_example_value: object | None = ..., peek: bool = ...) -> dict[sympy.Symbol, pytree.KeyPath] | None:
    """
...
class StatelessSymbolicContext(SymbolicContext, Generic[_P1, _T1]):
    ...
    shape_ids: dict[int, str | None] | None = ...
    unbacked_bounds: dict[int, tuple[int | None, int | None]] | None = ...
    def __post_init__(self) -> None:
        ...
...
class StatefulSymbolicContext(StatelessSymbolicContext[..., Any]):
    ...
    excluded_sizes: tuple[int | None, ...] | None = ...
...
def is_symbolic(val: int | SymInt | float | SymFloat | bool | SymBool) -> TypeGuard[SymInt | SymFloat | SymBool]:
    ...
...
class ShapeEnv:
    def __init__(self, *, should_record_events: bool | None = ..., tracked_fakes: list[Any] | None = ..., **kwargs: Any) -> None:
        ...
    ...
    @contextmanager
    def patch_source_specialization(self, source: Source, check_fn: Callable[[sympy.Symbol], sympy.Expr]) -> Generator[None, None, None]:
        """
    ...
    def set_real_tensor_prop_unbacked_vals(self, k: sympy.Symbol, v: int | float | torch.Tensor) -> None:
    ...
    def create_symbolic_sizes_strides_storage_offset(self, ex: torch.Tensor, source: Source, *, symbolic_context: SymbolicContext | None = ...) -> tuple[tuple[IntLikeType, ...], tuple[IntLikeType, ...], IntLikeType,]:
        """
    ...
    @record_shapeenv_event()
    def create_symintnode(self, sym: sympy.Expr, *, hint: int | float | bool | torch.SymInt | None, source: Source | None = ...) -> IntLikeType:
    ...
    @record_shapeenv_event()
    def create_symfloatnode(self, sym: sympy.Expr, *, hint: int | float | bool | torch.SymInt | None, source: Source | None = ...) -> FloatLikeType:
        """Create a SymFloat value from a symbolic expression"""
        ...
    
    @record_shapeenv_event()
    def create_unspecified_symint_and_symbol(self, value: int, source: Source, dynamic_dim: DimDynamic, excluded_value: int | None = ...) -> IntLikeType:
    ...
    @record_shapeenv_event()
    def create_unspecified_symbol(self, val: int | SymInt | float | SymFloat, source: Source, dynamic_dim: DimDynamic = ..., constraint_dim: DimConstraint = ..., symbolic_context: SymbolicContext | None = ...) -> sympy.Expr:
        """
    ...
    @record_shapeenv_event()
    def create_symbol(self, val: IntLikeType | FloatLikeType, source: Source, dynamic_dim: DimDynamic = ..., constraint_dim: DimConstraint = ..., positive: bool | None = ..., do_not_specialize_zero_one: bool = ..., symbolic_context: SymbolicContext | None = ...) -> sympy.Expr:
    ...
    def produce_guards_verbose(self, placeholders: Sequence[FakeTensor], sources: Sequence[Source], source_ref: Callable[[Source], str] = ..., *, guards: list[ShapeGuard] | None = ..., input_contexts: DimList[SymbolicContext] | None = ..., equalities_inputs: EqualityConstraint | None = ..., _simplified: bool = ..., ignore_static: bool = ..., langs: tuple[str, ...] = ...) -> list[_ShapeGuardsHelper]:
        """
    ...
    def produce_guards_expression(self, placeholders: Sequence[SymInt | FakeTensor], *, guards: list[ShapeGuard] | None = ..., ignore_static: bool = ...) -> str | None:
        """
    ...
    def bound_sympy(self, expr: sympy.Expr, size_oblivious: bool = ...) -> ValueRanges[sympy.Expr]:
        """Given a sympy expression, computes a ValueRanges bound for what values it can be"""
        ...
    
    @_lru_cache
    def get_axioms(self, symbols: tuple[sympy.Symbol] | None = ..., compute_hint: bool = ...) -> tuple[SympyBoolean, ...]:
        """
    ...
    @deprecated("use guarding_hint_or_throw or optimization_hint instead", category=FutureWarning)
    @lru_cache(256)
    ...
    def optimization_hint(self, expr: sympy.Expr | int, fallback: int | None = ...) -> int:
        """
    ...
    def evaluate_sym_node(self, sym_node: SymNode, size_oblivious: bool = ..., fallback_value: bool | None = ...) -> sympy.Basic:
        """
        Given a a SymNode, evaluates sym_node.expr, adding guards if necessary.
        """
        ...
    
    def evaluate_expr(self, orig_expr: sympy.Basic, hint: int | bool | float | None = ..., fx_node: torch.fx.Node | None = ..., size_oblivious: bool = ..., fallback_value: bool | None = ..., *, forcing_spec: bool = ...) -> sympy.Basic:
        """
    ...
    def guard_or_defer_runtime_assert(self, orig_expr: SympyBoolean, msg: str, fx_node: torch.fx.Node | None = ...) -> bool:
        """

...
from typing import Any, NamedTuple, ParamSpec, TypeAlias, TypeVar, overload
...
_P = ParamSpec("_P")
_T = TypeVar("_T")
_orig_module_call: Callable[..., Any] = ...
_orig_module_getattr: Callable[..., Any] = ...
...
class Tracer(TracerBase):
    ...
    """
    @compatibility(is_backward_compatible=True)
    def __init__(self, autowrap_modules: tuple[ModuleType] = ..., autowrap_functions: tuple[Callable[..., Any], ...] = ..., param_shapes_constant: bool = ...) -> None:
        """
    ...
    @compatibility(is_backward_compatible=False)
    def getattr(self, attr: str, attr_val: Any, parameter_proxy_cache: dict[str, Proxy]) -> Any:
        """
    ...
    @compatibility(is_backward_compatible=False)
    def create_args_for_root(self, root_fn: Callable[..., Any], is_module: bool, concrete_args: dict[str, Any] | tuple[Any, ...] | None = ...) -> tuple[Any, list[Any]]:
        """
...
class _Patcher:
    ...
    def patch(self, frame_dict: dict[str, Any], name: str, new_fn: Callable[..., Any], deduplicate: bool = ...) -> None:
        """
        Replace frame_dict[name] with new_fn until we exit the context manager.
        """
        ...
    
    def patch_method(self, cls: type, name: str, new_fn: Callable[..., Any], deduplicate: bool = ...) -> None:
        """
...
@compatibility(is_backward_compatible=True)
def symbolic_trace(root: torch.nn.Module | Callable[..., Any], concrete_args: dict[str, Any] | None = ...) -> GraphModule:
    """

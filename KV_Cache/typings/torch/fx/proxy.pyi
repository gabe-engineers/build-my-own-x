...
class TracerBase:
    ...
    @compatibility(is_backward_compatible=True)
    def create_node(self, kind: str, target: Target, args: tuple[Argument, ...], kwargs: dict[str, Argument], name: str | None = ..., type_expr: Any | None = ...) -> Node:
        """
    ...
    @compatibility(is_backward_compatible=True)
    def create_proxy(self, kind: str, target: Target, args: tuple[Any, ...], kwargs: dict[str, Any], name: str | None = ..., type_expr: Any | None = ..., proxy_factory_fn: Callable[[Node], Proxy] | None = ...) -> Proxy:
        """
...
class Proxy:
    ...
    @classmethod
    def __torch_function__(cls, orig_method: Callable[..., Any], types: tuple[type, ...], args: tuple[Any, ...] | None = ..., kwargs: dict[str, Any] | None = ...) -> Proxy:
        ...
...
class MetaProxy(Proxy):
    ...
    """
    def __init__(self, node: Node, tracer: TracerBase | None = ..., fake_mode: Any = ...) -> None:
        ...
    ...
    @classmethod
    def __torch_function__(cls, orig_method: Callable[..., Any], types: tuple[type, ...], args: tuple[Any, ...] | None = ..., kwargs: dict[str, Any] | None = ...) -> MetaProxy:
        ...
...
class ParameterProxy(Proxy):
    ...
    """
    def __init__(self, tracer: TracerBase, node: Node, name: str, param: torch.nn.Parameter) -> None:
        ...

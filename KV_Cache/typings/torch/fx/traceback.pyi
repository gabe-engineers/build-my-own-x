...
class NodeSource:
    ...
    def __init__(self, node: Node | None, pass_name: str = ..., action: Union[NodeSourceAction, list[NodeSourceAction]] | None = ...) -> None:
        ...
    ...
    def print_readable(self, indent: int = ...) -> str:
        ...
...
@compatibility(is_backward_compatible=False)
@contextmanager
def preserve_node_meta(enable: bool = ...) -> Iterator[None]:
    ...

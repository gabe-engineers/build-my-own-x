...
class Node(_NodeBase):
    ...
    meta: dict[str, Any]
    @compatibility(is_backward_compatible=True)
    def __init__(self, graph: Graph, name: str, op: str, target: Target, args: tuple[Argument, ...], kwargs: dict[str, Argument], return_type: Any | None = ...) -> None:
        """
    ...
    @compatibility(is_backward_compatible=True)
    def format_node(self, placeholder_names: list[str] | None = ..., maybe_return_typename: list[str] | None = ..., *, include_tensor_metadata: bool = ...) -> str | None:
        """
    ...
    @compatibility(is_backward_compatible=True)
    def replace_all_uses_with(self, replace_with: Node, delete_user_cb: Callable[[Node], bool] | None = ..., *, propagate_meta: bool = ...) -> list[Node]:
        """
    ...
    @compatibility(is_backward_compatible=False)
    def normalized_arguments(self, root: torch.nn.Module, arg_types: tuple[Any] | None = ..., kwarg_types: dict[str, Any] | None = ..., normalize_to_only_use_kwargs: bool = ...) -> ArgsKwargsPair | None:
        """

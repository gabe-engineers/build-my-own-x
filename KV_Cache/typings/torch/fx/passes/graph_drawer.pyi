...
if HAS_PYDOT:
    ...
    class FxGraphDrawer:
        ...
        """
        def __init__(self, graph_module: torch.fx.GraphModule, name: str, ignore_getattr: bool = ..., ignore_parameters_and_buffers: bool = ..., skip_node_names_in_args: bool = ..., parse_stack_trace: bool = ..., dot_graph_shape: str | None = ..., normalize_args: bool = ...) -> None:
            ...

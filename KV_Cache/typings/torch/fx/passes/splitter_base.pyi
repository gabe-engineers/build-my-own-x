...
class _SplitterBase:
    ...
    """
    PCIe_BW = ...
    def __init__(self, module: torch.fx.GraphModule, sample_input: Sequence[Any], operator_support: OperatorSupportBase, settings: _SplitterSettingBase, non_acc_submodule_name: str = ..., return_tuple: bool = ..., nodes_finder: FxNetAccNodesFinder | None = ...) -> None:
        """

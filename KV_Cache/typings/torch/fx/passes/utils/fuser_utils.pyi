...
@compatibility(is_backward_compatible=False)
def fuse_as_graphmodule(gm: GraphModule, nodes: NodeList, module_name: str, partition_lookup_table: dict[Node, int | None] | None = ..., *, always_return_tuple: bool = ...) -> tuple[GraphModule, tuple[Node, ...], tuple[Node, ...]]:
    """
...
@compatibility(is_backward_compatible=False)
def insert_subgm(gm: GraphModule, sub_gm: GraphModule, orig_inputs: tuple[Node, ...], orig_outputs: tuple[Node, ...], insertion_point: Node | None = ...) -> GraphModule:
    ...
...
@compatibility(is_backward_compatible=False)
def fuse_by_partitions(gm: GraphModule, partitions: list[dict[Node, int | None]], prefix: str = ..., always_return_tuple: bool = ...) -> GraphModule:
    ...

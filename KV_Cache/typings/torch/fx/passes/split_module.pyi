...
@compatibility(is_backward_compatible=True)
def split_module(m: GraphModule, root_m: torch.nn.Module, split_callback: Callable[[Node], int], qualname_map: dict[str, str] | None = ..., keep_original_order: bool | None = ..., keep_original_node_name: bool | None = ..., keep_original_input_name: bool = ..., *, partition_affix: str | None = ..., tuple_return: bool = ...): # -> GraphModule:
    """

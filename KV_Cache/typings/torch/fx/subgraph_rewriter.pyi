...
@compatibility(is_backward_compatible=True)
def replace_pattern(gm: GraphModule, pattern: Callable[..., Any] | GraphModule, replacement: Callable[..., Any] | GraphModule) -> list[Match]:
    """
...
@compatibility(is_backward_compatible=False)
def replace_pattern_with_filters(gm: GraphModule, pattern: Callable[..., Any] | Graph | GraphModule, replacement: Callable[..., Any] | Graph | GraphModule | None = ..., match_filters: list[Callable[[InternalMatch, Graph, Graph], bool]] | None = ..., ignore_literals: bool = ..., replacement_callback: Callable[[InternalMatch, Graph, Graph], Graph] | None = ..., node_name_match: str = ...) -> list[ReplacedPatterns]:
    """

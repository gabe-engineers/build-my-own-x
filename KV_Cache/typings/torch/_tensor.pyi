...
class Tensor(torch._C.TensorBase):
    ...
    def __reduce_ex__(self, proto): # -> tuple[Callable[..., Any], tuple[Any, type[Tensor], Any, Any]]:
        ...
    ...
    def backward(self, gradient=..., retain_graph=..., create_graph=..., inputs=...): # -> None:
    ...
    def index(self, positions, dims): # -> _Tensor:
        """
    ...
    def norm(self, p: float | str | None = ..., dim=..., keepdim=..., dtype=...): # -> Tensor:
    ...
    def lu(self, pivot=..., get_infos=...): # -> tuple[Tensor, Tensor, Tensor] | tuple[Tensor, Tensor]:
        r"""See :func:`torch.lu`"""
        ...
    
    def stft(self, n_fft: int, hop_length: int | None = ..., win_length: int | None = ..., window: Tensor | None = ..., center: bool = ..., pad_mode: str = ..., normalized: bool = ..., onesided: bool | None = ..., return_complex: bool | None = ..., align_to_window: bool | None = ...): # -> Tensor:
    ...
    def istft(self, n_fft: int, hop_length: int | None = ..., win_length: int | None = ..., window: Tensor | None = ..., center: bool = ..., normalized: bool = ..., onesided: bool | None = ..., length: int | None = ..., return_complex: bool = ...):
    ...
    def split(self, split_size, dim=...): # -> tuple[Tensor, ...]:
    ...
    @property
    def __cuda_array_interface__(self): # -> property | dict[str, str | tuple[int, ...] | int | None]:
    ...
    def unflatten(self, dim, sizes): # -> Tensor:
        r"""
    ...
    def dim_order(self, *, ambiguity_check: bool | list[torch.memory_format] = ...): # -> tuple[int, ...]:
        """

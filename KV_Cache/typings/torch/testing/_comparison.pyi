...
_DTYPE_PRECISIONS = ...
def default_tolerances(*inputs: torch.Tensor | torch.dtype, dtype_precisions: dict[torch.dtype, tuple[float, float]] | None = ...) -> tuple[float, float]:
...
def make_scalar_mismatch_msg(actual: bool | int | float | complex, expected: bool | int | float | complex, *, rtol: float, atol: float, identifier: str | Callable[[str], str] | None = ...) -> str:
...
def make_tensor_mismatch_msg(actual: torch.Tensor, expected: torch.Tensor, matches: torch.Tensor, *, rtol: float, atol: float, identifier: str | Callable[[str], str] | None = ...): # -> str:
...
class NumberPair(Pair):
    ...
    _TYPE_TO_DTYPE = ...
    _NUMBER_TYPES = ...
    def __init__(self, actual: Any, expected: Any, *, id: tuple[Any, ...] = ..., rtol: float | None = ..., atol: float | None = ..., equal_nan: bool = ..., check_dtype: bool = ..., **other_parameters: Any) -> None:
        ...
...
class TensorLikePair(Pair):
    ...
    """
    def __init__(self, actual: Any, expected: Any, *, id: tuple[Any, ...] = ..., allow_subclasses: bool = ..., rtol: float | None = ..., atol: float | None = ..., equal_nan: bool = ..., check_device: bool = ..., check_dtype: bool = ..., check_layout: bool = ..., check_stride: bool = ..., **other_parameters: Any) -> None:
        ...
...
def assert_close(actual: Any, expected: Any, *, allow_subclasses: bool = ..., rtol: float | None = ..., atol: float | None = ..., equal_nan: bool = ..., check_device: bool = ..., check_dtype: bool = ..., check_layout: bool = ..., check_stride: bool = ..., msg: str | Callable[[str], str] | None = ...): # -> None:
...
def assert_allclose(actual: Any, expected: Any, rtol: float | None = ..., atol: float | None = ..., equal_nan: bool = ..., msg: str = ...) -> None:
    """
    .. warning::

...
class ops(_TestParametrizer):
    def __init__(self, op_list, *, dtypes: OpDTypes | Sequence[torch.dtype] = ..., allowed_dtypes: Sequence[torch.dtype] | None = ..., skip_if_dynamo=...) -> None:
        ...
...
class onlyOn:
    def __init__(self, device_type: str | list) -> None:
        ...
...
def onlyCPU(fn): # -> _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any | None]:
    ...

def onlyCUDA(fn): # -> _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any | None]:
    ...

def onlyMPS(fn): # -> _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any | None]:
    ...

def onlyXPU(fn): # -> _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any | None]:
    ...

def onlyHPU(fn): # -> _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any | None]:
    ...

def onlyPRIVATEUSE1(fn): # -> _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any | None]:
    ...
...
def expectedFailureMeta(fn): # -> _Wrapped[Callable[..., Any], Any, Callable[..., Any], None] | type:
    ...
...
def expectedFailureMPSComplex(fn): # -> _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any | None]:
    ...
...
def skipCUDAIfNoCusolverROCMIfNoMagma(fn): # -> _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any]:
    ...
...
def skipCUDAIfRocmHipBlasltVersionLessThan(version=...): # -> Callable[..., _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any]]:
    ...

def skipCUDAIfNotMiopenSuggestNHWC(fn): # -> _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any]:
    ...

def skipCUDAVersionIn(versions: list[tuple[int, int]] | None = ...): # -> Callable[..., _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any]]:
    ...

def skipCUDAIfVersionLessThan(versions: tuple[int, int] | None = ...): # -> Callable[..., _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any]]:
    ...
...
def skipXPU(fn): # -> _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any]:
    ...

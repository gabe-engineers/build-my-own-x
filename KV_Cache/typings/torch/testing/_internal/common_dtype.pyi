...
_all_mps_types = ...
def all_mps_types(): # -> _dispatch_dtypes:
    ...

def all_mps_types_and(*dtypes): # -> _dispatch_dtypes:
    ...
...
def highest_precision_float(device): # -> dtype:
    ...

def highest_precision_complex(device): # -> dtype:
    ...

...
def safe_schema_check(op: torch._ops.OpOverload, args: tuple[Any, ...], kwargs: dict[str, Any], *, copy_inputs: bool = ..., rtol: float | None = ..., atol: float | None = ...) -> Any:
    ...

def safe_autograd_registration_check(op: torch._ops.OpOverload, args: tuple[Any, ...], kwargs: dict[str, Any], *, copy_inputs: bool = ..., rtol: float | None = ..., atol: float | None = ...) -> None:
    ...

def safe_fake_check(op: torch._ops.OpOverload, args: tuple[Any, ...], kwargs: dict[str, Any], *, copy_inputs: bool = ..., rtol: float | None = ..., atol: float | None = ...) -> None:
    ...

def safe_aot_autograd_check(op: torch._ops.OpOverload, args: tuple[Any, ...], kwargs: dict[str, Any], dynamic: bool, *, copy_inputs: bool = ..., rtol: float | None = ..., atol: float | None = ...) -> Any:
    ...
...
def generate_opcheck_tests(testcase: Any, namespaces: list[str], failures_dict_path: str | None = ..., additional_decorators: dict[str, Callable] | None = ..., test_utils: list[str] = ...) -> None:
...
def opcheck(op: torch._ops.OpOverload | torch._ops.OpOverloadPacket | CustomOpDef, args: tuple[Any, ...], kwargs: dict[str, Any] | None = ..., *, test_utils: str | Sequence[str] = ..., raise_exception: bool = ..., rtol: float | None = ..., atol: float | None = ...) -> dict[str, str]:
...
class FailuresDict:
    ...
    def set_status(self, qualname: str, test_name: str, status: str, *, comment: str | None = ...): # -> None:
        ...

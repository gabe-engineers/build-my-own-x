...
DISABLED_TESTS_FILE = ...
GRAPH_EXECUTOR: ProfilingMode | None = ...
LOG_SUFFIX = ...
PYTEST_SINGLE_TEST = ...
REPEAT_COUNT = ...
...
skipIfNoTritonDSL = ...
skipIfNoCuteDSL = ...
def skipIfDSLUnavailable(dsl_name: str, reason: str | None = ...): # -> Callable[[_FT], _FT]:
    """Skip test if specific DSL is not available"""
    ...

def skipUnlessDSLAvailable(dsl_name: str, reason: str | None = ...): # -> Callable[[_FT], _FT]:
...
def skipIfFreeThreaded(msg=...): # -> Callable[[_FT], _FT]:
    ...
...
def getRocmArchName(device_index: int = ...):
    ...

def isRocmArchAnyOf(arch: tuple[str, ...]): # -> bool:
    ...
...
def skipIfWindowsXPU(func=..., *, msg=...): # -> _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any] | Callable[..., _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any]]:
    ...
...
class TestCase(expecttest.TestCase):
    ...
    def compile_fn(self, fn, backend, nopython): # -> Any | Callable[..., Any]:
        ...
    ...
    def assertEqual(self, x, y, msg: str | Callable[[str], str] | None = ..., *, atol: float | None = ..., rtol: float | None = ..., equal_nan=..., exact_dtype=..., exact_device=..., exact_layout=..., exact_stride=..., exact_is_coalesced=...): # -> None:
        ...
    
    def assertNotEqual(self, x, y, msg: str | None = ..., *, atol: float | None = ..., rtol: float | None = ..., **kwargs) -> None:
        ...
...
def random_matrix_with_scaled_reduction_dim(rows, columns, *batch_dims, **kwargs): # -> Tensor:
    """Return rectangular matrix or batches of rectangular matrices
...
@functools.lru_cache
def get_cycles_per_ms(device: str = ...) -> float:
...
def skipIfPythonVersionMismatch(predicate): # -> Callable[..., _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any]]:
    ...

def patch_test_members(updates: dict[str, Any]): # -> Callable[..., _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any]]:
    ...

def get_gcc_major_version(): # -> int | None:
    """

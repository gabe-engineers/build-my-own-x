...
def make_tensor(*shape: int | torch.Size | list[int] | tuple[int, ...], dtype: torch.dtype, device: str | torch.device, low: float | None = ..., high: float | None = ..., requires_grad: bool = ..., noncontiguous: bool = ..., exclude_zero: bool = ..., memory_format: torch.memory_format | None = ...) -> torch.Tensor:

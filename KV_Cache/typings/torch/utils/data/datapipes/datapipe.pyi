...
class IterDataPipe(IterableDataset[_T_co], metaclass=_IterDataPipeMeta):
    ...
    def collate(self, conversion: Callable[..., Any] | dict[str | Any, Callable | Any] | None = ..., collate_fn: Callable | None = ...) -> IterDataPipe:
        r"""
    ...
    def demux(self, num_instances: int, classifier_fn: Callable[[_T_co], int | None], drop_none: bool = ..., buffer_size: int = ...) -> list[IterDataPipe]:
        r"""
    ...
    def fork(self, num_instances: int, buffer_size: int = ..., copy: Literal["shallow", "deep"] | None = ...) -> list[IterDataPipe]:
        r"""
    ...
    def groupby(self, group_key_fn: Callable[[_T_co], Any], *, keep_key: bool = ..., buffer_size: int = ..., group_size: int | None = ..., guaranteed_group_size: int | None = ..., drop_remaining: bool = ...) -> IterDataPipe:
        r"""
    ...
    def list_files(self, masks: str | list[str] = ..., *, recursive: bool = ..., abspath: bool = ..., non_deterministic: bool = ..., length: int = ...) -> IterDataPipe:
        r"""

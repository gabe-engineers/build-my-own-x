...
class DataLoader(Generic[_T_co]):
    ...
    __initialized = ...
    def __init__(self, dataset: Dataset[_T_co], batch_size: int | None = ..., shuffle: bool | None = ..., sampler: Sampler | Iterable | None = ..., batch_sampler: Sampler[list] | Iterable[list] | None = ..., num_workers: int = ..., collate_fn: _collate_fn_t | None = ..., pin_memory: bool = ..., drop_last: bool = ..., timeout: float = ..., worker_init_fn: _worker_init_fn_t | None = ..., multiprocessing_context=..., generator=..., *, prefetch_factor: int | None = ..., persistent_workers: bool = ..., pin_memory_device: str = ..., in_order: bool = ...) -> None:
        ...

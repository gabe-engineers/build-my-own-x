...
if TYPE_CHECKING:
    def Config(default: T | object = ..., justknob: str | None = ..., env_name_default: str | list[str] | None = ..., env_name_force: str | list[str] | None = ..., value_type: type | None = ..., alias: str | None = ..., deprecated: bool = ..., deprecation_message: str | None = ...) -> T:
        ...

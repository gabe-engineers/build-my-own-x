...
from torch.utils._pytree import Context, FlattenFn, FlattenWithKeysFn, FromDumpableContextFn, KeyPath, PyTree, ToDumpableContextFn, UnflattenFn
...
UnflattenFunc = UnflattenFn
FlattenWithKeysFunc = FlattenWithKeysFn
def register_pytree_node(cls: type[Any], flatten_fn: FlattenFn, unflatten_fn: UnflattenFn, *, serialized_type_name: str | None = ..., to_dumpable_context: ToDumpableContextFn | None = ..., from_dumpable_context: FromDumpableContextFn | None = ..., flatten_with_keys_fn: FlattenWithKeysFn | None = ...) -> None:

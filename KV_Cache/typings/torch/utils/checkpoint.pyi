...
def set_checkpoint_debug_enabled(enabled: bool | None): # -> Generator[None, Any, None]:
    """
...
def checkpoint(function, *args, use_reentrant: bool | None = ..., context_fn: Callable[[], Tuple[ContextManager, ContextManager]] = ..., determinism_check: str = ..., debug: bool = ..., early_stop: bool = ..., **kwargs): # -> Any | None:
...
class _CheckpointFrame:
    ...
    def get_inputs(self): # -> list[Tensor | Any]:
        ...
...
class SelectiveCheckpointContext:
    ...
    Example:
        ...
        >>> )
    """
    def __init__(self, *, is_recompute, op_output=...) -> None:
        ...
...
class _CachingTorchDispatchMode(TorchDispatchMode):
    ...
    def __init__(self, policy_fn, storage, ac_graph_id=...) -> None:
        ...

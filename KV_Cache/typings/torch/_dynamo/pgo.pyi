...
class CodeId:
    ...
    @staticmethod
    def make(code: types.CodeType, closure: tuple[types.CellType, ...] | None = ...) -> CodeId:
        ...
...
def lookup_remote_cache_entry(remote_cache: RemoteCache[JsonDataTy], cache_key: str, event_name: str | None = ...) -> defaultdict[CodeId, CodeState] | None:
    ...

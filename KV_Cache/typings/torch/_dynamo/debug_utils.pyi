...
class NopInputReader:
    ...
    def storage(self, storage_hash: str | None, nbytes: int, *, device: torch._prims_common.DeviceLikeType | None = ..., dtype_hint: torch.dtype | None = ...) -> None:
        ...
...
class InputReader:
    ...
    def storage(self, storage_hash: str | None, nbytes: int, *, device: torch._prims_common.DeviceLikeType | None = ..., dtype_hint: torch.dtype | None = ...) -> UntypedStorage:
        ...
    
    def tensor(self, storage: UntypedStorage, shape: torch._prims_common.ShapeType, stride: torch._prims_common.StrideType | None = ..., *, storage_offset: int | None = ..., dtype: torch.dtype | None = ..., requires_grad: bool | None = ..., is_leaf: bool | None = ..., **metadata: Any) -> torch.Tensor:
        ...
...
class InputWriter:
    ...
    def storage(self, untyped_storage: UntypedStorage, *, device_hint: torch._prims_common.DeviceLikeType | None = ..., dtype_hint: torch.dtype | None = ...) -> str:
        ...
...
def aot_graph_input_parser(func: Callable[[list[Tensor]], list[Tensor]], device: str = ..., sym_shapes: dict[str, int] | None = ..., default_sym_shape: int | None = ...) -> dict[str, Any]:
    """

...
from typing import Any, ClassVar, Generic, Literal, TypeAlias, TypeGuard, TypeVar, overload
...
class CompileEventLogger:
    ...
    """
    @staticmethod
    def log_instant_event(event_name: str, metadata: dict[str, Any], time_ns: int | None = ..., log_level: CompileEventLogLevel = ...) -> None:
        ...
...
@contextmanager
def dynamo_timed(key: str, phase_name: str | None = ..., log_pt2_compile_event: bool = ..., metadata: dict[str, object] | None = ..., dynamo_compile_column_us: str | None = ..., compile_id: CompileId | None = ..., is_backward: bool | None = ..., log_waitcounter: bool = ..., waitcounter_name_override: str | None = ...) -> Generator[Any, None, None]:
    """
...
@overload
def istype(obj: object, allowed_types: tuple[type[T1], type[T2]]) -> TypeIs[T1 | T2]:
    ...

@overload
def istype(obj: object, allowed_types: tuple[type[T1], type[T2], type[T3]]) -> TypeIs[T1 | T2 | T3]:
    ...

@overload
def istype(obj: object, allowed_types: tuple[type[T1], type[T2], type[T3], type[T4]]) -> TypeIs[T1 | T2 | T3 | T4]:
    ...

@overload
def istype(obj: object, allowed_types: tuple[type[T1], type[T2], type[T3], type[T4], type[T5]]) -> TypeIs[T1 | T2 | T3 | T4 | T5]:
    ...

@overload
def istype(obj: object, allowed_types: tuple[type[T1], type[T2], type[T3], type[T4], type[T5], type[T6]]) -> TypeIs[T1 | T2 | T3 | T4 | T5 | T6]:
    ...

@overload
def istype(obj: object, allowed_types: tuple[type[T1], type[T2], type[T3], type[T4], type[T5], type[T6], type[T7]]) -> TypeIs[T1 | T2 | T3 | T4 | T5 | T6 | T7]:
    ...

@overload
def istype(obj: object, allowed_types: tuple[type[T1], type[T2], type[T3], type[T4], type[T5], type[T6], type[T7], type[T8]]) -> TypeIs[T1 | T2 | T3 | T4 | T5 | T6 | T7 | T8]:
    ...

@overload
def istype(obj: object, allowed_types: tuple[type[T1], type[T2], type[T3], type[T4], type[T5], type[T6], type[T7], type[T8], type[T9],]) -> TypeIs[T1 | T2 | T3 | T4 | T5 | T6 | T7 | T8 | T9]:
    ...

@overload
def istype(obj: object, allowed_types: tuple[type[T1], type[T2], type[T3], type[T4], type[T5], type[T6], type[T7], type[T8], type[T9], type[T10],]) -> TypeIs[T1 | T2 | T3 | T4 | T5 | T6 | T7 | T8 | T9 | T10]:
    ...

@overload
def istype(obj: object, allowed_types: tuple[type, ...] | list[type] | set[type]) -> bool:
    ...
...
def get_inputs_devices(inputs: collections.abc.Sequence[object], model: torch.fx.GraphModule) -> list[torch.device | None]:
    ...
...
class CompilationMetrics:
    ...
    inductor_fx_local_cache_hit_count: int | None = ...
    inductor_fx_local_cache_miss_count: int | None = ...
    aotautograd_remote_cache_hit_count: int | None = ...
    aotautograd_remote_cache_miss_count: int | None = ...
    aotautograd_local_cache_hit_count: int | None = ...
    aotautograd_local_cache_miss_count: int | None = ...
    ...
    inductor_provenance: set[str] | None = ...
    @classmethod
...
def record_compilation_metrics(start_time_ns: int, end_time_ns: int, metrics: dict[str, Any], exc_type: type[BaseException] | None, exc_value: BaseException | None) -> None:
    ...
...
class ChromiumEventLogger:
    ...
    def log_event_start(self, event_name: str, time_ns: int, metadata: dict[str, Any], log_pt2_compile_event: bool = ..., compile_id: CompileId | None = ...) -> None:
        """
    ...
    def log_event_end(self, event_name: str, time_ns: int, metadata: dict[str, Any], start_time_ns: int, log_pt2_compile_event: bool, compile_id: CompileId | None = ...) -> None:
        """
    ...
    def log_instant_event(self, event_name: str, time_ns: int, metadata: dict[str, Any] | None = ..., log_pt2_compile_event: bool = ...) -> None:
        """
...
def is_jit_model(model0: Any) -> TypeIs[torch.jit._trace.TopLevelTracedModule | torch.jit._script.RecursiveScriptModule | torch.jit.ScriptFunction[Any, Any] | torch.jit.ScriptModule]:
    ...
...
def enumerate_items_with_dict_position(obj: dict[K, V]) -> Iterable[tuple[int, K, V | Any]]:

...
class set_stance(_DecoratorContextManager):
    ...
    """
    _dynamo_forbidden = ...
    def __init__(self, stance: str = ..., *, skip_guard_eval_unsafe: bool = ..., force_backend: str | Callable[..., Any] | None = ...) -> None:
        ...
...
@overload
def leaf_function(*, mutates_args: set[str]) -> Callable[[Callable[_P, _R]], Callable[_P, _R]]:
    ...

def leaf_function(fn: Callable[_P, _R] | None = ..., *, mutates_args: set[str] | None = ...) -> Callable[_P, _R] | Callable[[Callable[_P, _R]], Callable[_P, _R]]:
    """
...
@forbid_in_graph
def mark_unbacked(t: Any, index: int | list[Any] | tuple[Any], hint_override: int | None = ..., strict: bool = ..., specialize_on: list[Any] | None = ..., shape_id: str | None = ..., min: int | None = ..., max: int | None = ...) -> None:
    """
...
@forbid_in_graph
def mark_dynamic(t: Any, index: int | list[Any] | tuple[Any], *, hint_override: int | None = ..., min: int | None = ..., max: int | None = ..., specialize_on: list[Any] | None = ...) -> None:
    """
...
def patch_dynamo_config(arg1: str | dict[str, Any] | tuple[tuple[str, Any], ...] | None = ..., arg2: Any = ..., **kwargs: Any) -> DynamoConfigPatchProxy:
    """
...
def disable_nested_graph_breaks(fn: Any | None = ...) -> Any:
    """
...
class CudagraphOverrideContextManager:
    ...
    def __init__(self, fwd: bool | None = ..., bwd: bool | None = ...) -> None:
        ...
...
def override_cudagraphs(fwd: bool | None = ..., bwd: bool | None = ...) -> CudagraphOverrideContextManager:
    """

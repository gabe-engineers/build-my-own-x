...
class CompilePackage:
    ...
    """
    def __init__(self, fn: Callable[..., Any] | None, dynamo: _DynamoCacheEntry | None = ..., ignore_inlined_sources: bool = ...) -> None:
        ...
    
    def is_initialized(self) -> bool:
        ...
    
    def initialize(self, fn: Any, dynamo: _DynamoCacheEntry | None = ..., ignore_inlined_sources: bool = ...) -> None:
        ...
    ...
    def add_resume_function(self, python_code: types.CodeType, python_module: str, function_name: str) -> None:
        ...

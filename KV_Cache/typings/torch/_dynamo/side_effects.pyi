...
class SideEffects:
    ...
    def __init__(self, output_graph: OutputGraph, id_to_variable: dict[int, VariableTracker] | None = ..., store_attr_mutations: dict[VariableTracker, dict[str, VariableTracker]] | None = ..., mutation_user_stacks: dict[VariableTracker, list[traceback.StackSummary]] | None = ..., keepalive: list[Any] | None = ..., save_for_backward: list[tuple[AutogradFunctionContextVariable, list[VariableTracker]]] | None = ..., tensor_hooks: dict[int, tuple[variables.TensorVariable, VariableTracker, variables.RemovableHandleVariable, str,],] | None = ...) -> None:
        ...
    ...
    def track_cell_existing(self, source: Source | None, cell: CellType, contents: VariableTracker) -> VariableTracker:
        ...

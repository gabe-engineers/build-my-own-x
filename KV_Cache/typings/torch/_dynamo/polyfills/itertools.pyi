...
if TYPE_CHECKING:
    ...
__all__ = ["accumulate", "chain", "chain_from_iterable", "compress", "cycle", "dropwhile", "filterfalse", "islice", "pairwise", "starmap", "takewhile", "tee", "zip_longest"]
_T = TypeVar("_T")
_U = TypeVar("_U")
...
def accumulate(iterable: Iterable[_T], func: Callable[[_T, _T], _T] | None = ..., *, initial: _T | None = ...) -> Iterator[_T]:
    ...
...
@substitute_in_graph(itertools.takewhile, is_embedded_type=True)
def takewhile(predicate: _Predicate[_T], iterable: Iterable[_T], /) -> Iterator[_T]:
    ...

@overload
def starmap(function: Callable[[], _U], iterable: Iterable[tuple[()]], /) -> itertools.starmap[_U]:
    ...

@overload
def starmap(function: Callable[[_T], _U], iterable: Iterable[tuple[_T]], /) -> itertools.starmap[_U]:
    ...

@overload
def starmap(function: Callable[[_T, _T1], _U], iterable: Iterable[tuple[_T, _T1]], /) -> itertools.starmap[_U]:
    ...

@overload
def starmap(function: Callable[[_T, _T1, _T2], _U], iterable: Iterable[tuple[_T, _T1, _T2]], /) -> itertools.starmap[_U]:
    ...

@substitute_in_graph(itertools.starmap, is_embedded_type=True)

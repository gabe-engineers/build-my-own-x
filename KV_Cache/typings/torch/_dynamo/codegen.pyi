...
class PyCodegen:
    ...
    """
    def __init__(self, tx: InstructionTranslatorBase, root: torch.nn.Module | None = ..., graph_output_var: str | None = ..., tempvars: dict[VariableTracker | Source, Any] | None = ..., overridden_sources: dict[Source, Source] | None = ...) -> None:
        ...
    ...
    def __call__(self, value: VariableTracker | Source | None, allow_cache: bool = ...) -> None:
        """

...
class ExportMetaData:
    ...
    module_call_spec: dict[str, dict[str, torch.utils._pytree.TreeSpec | torch.utils._pytree.LeafSpec],] = ...
...
class OutputGraphCommon(OutputGraphGuardsState):
    ...
    """
    def __init__(self, output_graph_guards_state: OutputGraphGuardsState, import_sources: dict[str, str] | None = ..., shape_env: ShapeEnv | None = ..., export_metadata: ExportMetaData | None = ..., tracked_fakes_id_to_source: dict[int, list[Source]] | None = ...) -> None:
        ...
...
class OutputGraph(OutputGraphCommon):
    ...
    def __init__(self, code_options: dict[str, Any], compiler_fn: CompilerFn | None, root_tx: InstructionTranslatorBase, export: bool, export_constraints: Sequence[_ConstraintTarget], frame_state: Any, local_scope: Scope, global_scope: Scope, f_code: CodeType, torch_function_mode_stack: list[torch.overrides.TorchFunctionMode], package: Optional[CompilePackage], one_graph: bool = ...) -> None:
        ...
    
    def get_replayed_side_effect_source_refs(self, *, populate_export_metadata: bool = ...) -> list[str]:
    ...
    def synthetic_graph_input(self, fn: Callable[..., Any], args: tuple[Any, ...], ctor_arg_sources: tuple[Source | None, ...] | None = ...) -> VariableTracker:
        """
    ...
    def check_input_mutation_on_current_stream(self, tx: InstructionTranslatorBase) -> None:
    ...
    def subtracer(self, source_target: Target | None, prior_tracer: Optional[SubgraphTracer], description: str | None = ...) -> Generator[SubgraphTracer, None, None]:
        ...
    ...
    def register_attr_or_module(self, target: torch.nn.Module | torch.Tensor | Any, *names: Any, **options: Any) -> VariableTracker:
        ...
    ...
    def install_resume_function_global(self, name: str, code: types.CodeType, f_globals: dict[str, Any]) -> None:
...
class SubgraphTracer(fx.Tracer):
    ...
    """
    def __init__(self, output_graph: OutputGraph, parent: Optional[SubgraphTracer] = ..., is_export: bool = ..., source_target: Target | None = ..., description: str | None = ...) -> None:
        ...
    
    def record_proxyable_vt(self, vt: VariableTracker) -> None:
        ...
    
    def create_proxy(self, kind: str, target: Any, args: Any, kwargs: Any, name: str | None = ..., type_expr: Any | None = ..., proxy_factory_fn: Callable[[fx.Node], fx.Proxy] | None = ...) -> fx.Proxy:
        ...
    
    def create_node(self, kind: str, target: Target, args: Any = ..., kwargs: Any = ..., name: str | None = ..., type_expr: Any | None = ...) -> fx.Node:
        ...
    
    def remove_node(self, node: fx.Node) -> None:
        ...
    
    def create_graph_input(self, name: str, type_expr: Any, example_value: Any, before: bool = ..., source: Source | None = ...) -> fx.Proxy:
        ...

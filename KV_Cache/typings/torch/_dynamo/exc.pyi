...
class Unsupported(TorchDynamoException):
    def __init__(self, msg: str, gb_type: str = ..., skip_frame: bool = ..., *, case_name: str | None = ..., real_stack: StackSummary | None = ...) -> None:
        ...
...
class ObservedException(TorchDynamoException):
    def __init__(self, *args: Any, real_stack: StackSummary | None = ..., **kwargs: Any) -> None:
        ...
...
def raise_observed_exception(exc_type: type[Exception], tx: InstructionTranslatorBase, *, args: list[VariableTracker] | list[str] | None = ..., kwargs: dict[str, VariableTracker] | None = ...) -> NoReturn:
    ...
...
def format_error_msg_verbose(exc: Exception, code: types.CodeType, record_filename: str | None = ..., frame: DynamoFrameType | None = ...) -> str:
    ...
...
def format_error_msg(exc: Exception, code: types.CodeType, record_filename: str | None = ..., frame: DynamoFrameType | None = ...) -> str:
    ...

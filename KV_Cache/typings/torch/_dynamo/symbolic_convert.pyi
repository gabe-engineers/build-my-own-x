...
from .exc import StepUnsupported, Unsupported, UserError
...
class SpeculationLog:
    ...
    autograd_grad_leaked_tensors: list[str] = ...
    graph_break_on_requires_grad_: bool = ...
...
def format_tensor_computation_trace(value: VariableTracker, max_lines: int = ...) -> str:
...
class InstructionTranslatorBase(metaclass=BytecodeDispatchTableMeta):
    ...
    def enter_ctx(self, ctx: ContextWrappingVariable | GenericContextWrappingVariable, inst: Instruction) -> VariableTracker:
        ...
    ...
    def log_graph_break(self, code_options: dict[str, Any], reason: str, exc: Unsupported | UserError | StepUnsupported) -> None:
        ...
    
    @staticmethod
    def raise_loop_graph_break(code: types.CodeType, exc: Unsupported | UserError) -> NoReturn:
        ...
    
    def __init__(self, output: OutputGraph, instructions: list[Instruction], f_locals: dict[str, Any], f_globals: dict[str, Any], f_builtins: dict[str, Any], code_options: dict[str, Any], symbolic_locals: dict[str, VariableTracker], symbolic_globals: dict[str, VariableTracker], symbolic_torch_function_state: SymbolicTorchFunctionState, symbolic_stream_state: SymbolicStreamState, f_code: types.CodeType, export: bool, inline_depth: int, speculation_log: SpeculationLog, exn_vt_stack: ExceptionStack, distributed_state: DistributedState | None, closure: tuple[types.CellType] | None = ..., package: CompilePackage | None = ..., indexof: dict[Instruction, int] | None = ...) -> None:
        ...
...
class InstructionTranslator(InstructionTranslatorBase):
    ...
    def __init__(self, instructions: list[Instruction], f_code: types.CodeType, f_locals: dict[str, Any], f_globals: dict[str, Any], f_builtins: dict[str, Any], closure: tuple[Any, ...] | None, torch_function_mode_stack: Any, code_options: dict[str, Any], compiler_fn: Any, one_graph: bool, export: bool, export_constraints: Any, frame_state: Any, speculation_log: SpeculationLog, exn_vt_stack: ExceptionStack, distributed_state: DistributedState | None, package: CompilePackage | None) -> None:
        ...

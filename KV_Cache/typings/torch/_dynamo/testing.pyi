...
def standard_test(self: Any, fn: Callable[..., Any], nargs: int, expected_ops: int | None = ..., expected_ops_dynamic: int | None = ..., expected_frame_count: int = ...) -> None:
    ...
...
def rand_strided(size: Sequence[int], stride: Sequence[int], dtype: torch.dtype = ..., device: str | torch.device = ..., extra_size: int = ...) -> torch.Tensor:
    ...
...
def make_test_cls_with_patches(cls: type, cls_prefix: str, fn_suffix: str, *patches: Any, xfail_prop: str | None = ..., decorator: Callable[[Callable[..., Any]], Callable[..., Any]] = ...) -> type:
    ...

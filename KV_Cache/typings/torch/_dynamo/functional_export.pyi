...
class DynamoGraphTransformer(torch.fx.Transformer):
    ...
    def __init__(self, module: torch.fx.GraphModule, flat_inputs: list[Any], flat_args_dynamic_dims: list[set[int]], graph_input_order: dict[int, int], graph_output_map: dict[int, tuple[str, Any]], fake_mode: Any | None = ..., graph_inputs: dict[int, Any] | None = ...) -> None:
        ...
...
class _DynamoBytecodeCodeGen(torch.fx.graph.CodeGen):
    ...
    def generate_output(self, output_args: torch.fx.node.Argument, *, descs: object | None = ..., repr_fn: Any | None = ...) -> str:
        ...
    


def dynamo_graph_capture_for_export(fn: Callable[..., Any], constraints: list[Constraint] | None = ...) -> Callable[..., Any]:
    ...

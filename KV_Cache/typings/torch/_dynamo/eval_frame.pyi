...
class _TorchDynamoContext:
    def __init__(self, callback: DynamoCallback, on_enter: Callable[[], Any] = ..., backend_ctx_ctor: Callable[[], contextlib.AbstractContextManager[Any]] = ..., patch_fn: Callable[[], Any] = ..., first_ctx: bool = ..., *, fullgraph: bool = ..., error_on_graph_break: bool | None = ..., export: bool = ..., dynamic: bool | None = ..., compiler_config: Any | None = ..., package: CompilePackage | None = ..., hooks: Hooks | None = ...) -> None:
        ...
...
class OptimizeContext(_TorchDynamoContext):
    def __init__(self, callback: DynamoCallback, backend_ctx_ctor: Callable[[], contextlib.AbstractContextManager[Any]], first_ctx: bool = ..., *, fullgraph: bool = ..., error_on_graph_break: bool | None = ..., export: bool = ..., dynamic: bool | None = ..., compiler_config: Any | None = ..., rebuild_ctx: Callable[[], OptimizeContext | _NullDecorator] | None = ..., package: CompilePackage | None = ..., hooks: Hooks | None = ...) -> None:
        ...
...
def argument_names(f_sig: inspect.Signature, args: list[Any] | tuple[Any, ...], kwargs: dict[str, Any]) -> list[str]:
    ...
...
class FlattenInputOutputSignature(torch.fx.Transformer):
    def __init__(self, m: torch.fx.GraphModule, flat_args: list[Any], matched_input_elements_positions: list[int], flat_results: Sequence[Any], matched_output_elements_positions: list[int], example_fake_inputs: list[torch.Tensor], flat_args_dynamic_dims: list[set[int]], fake_mode: fake_tensor.FakeTensorMode | None = ...) -> None:
        ...
...
def rewrite_signature(f_sig: inspect.Signature, graph: torch.fx.GraphModule, fake_mode: fake_tensor.FakeTensorMode | None, flat_args: list[Any], in_spec: pytree.TreeSpec, example_fake_inputs: list[Any], graph_captured_input: Iterable[Any], graph_captured_output: Iterable[Any] | None, dynamo_traced_result: Any, flat_args_dynamic_dims: list[set[int]]) -> torch.fx.GraphModule:
    ...

def export(f: Callable[..., Any], *extra_args: Any, aten_graph: bool = ..., pre_dispatch: bool = ..., decomposition_table: dict[torch._ops.OpOverload, Callable[..., Any]] | None = ..., tracing_mode: str = ..., dynamic_shapes: dict[str, Any] | tuple[Any] | list[Any] | None = ..., specialize_float: bool = ..., assume_static_by_default: bool = ..., same_signature: bool = ..., disable_constraint_solver: bool = ..., prefer_deferred_runtime_asserts_over_guards: bool = ..., _log_export_usage: bool = ..., constraints: list[Constraint] | None = ..., **extra_kwargs: Any) -> Callable[..., ExportResult]:
    """

...
class TorchFunctionModeVariable(GenericContextWrappingVariable):
    ...
    def __init__(self, value: TorchFunctionMode | None, source: Source | None = ..., **kwargs: Any) -> None:
        ...
...
def call_torch_function(tx: InstructionTranslator, torch_function_var: VariableTracker, fn: VariableTracker, types: TupleVariable, args: Iterable[Any], kwargs: dict[str, Any], *, is_subclass_dispatch: bool = ...) -> Any:
    ...

...
class ExceptionVariable(VariableTracker):
    _cpython_type = ...
    def __init__(self, exc_type: Any, args: list[VariableTracker], init_kwargs: dict[str, VariableTracker] | None = ..., source: Source | None = ..., mutation_type: MutationType | None = ...) -> None:
        ...

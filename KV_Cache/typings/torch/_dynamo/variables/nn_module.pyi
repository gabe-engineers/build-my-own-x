...
def guard_to_detect_forward_monkeypatching(source: Source | None, mod: torch.nn.Module) -> None:
    ...
...
class UnspecializedNNModuleVariable(UserDefinedObjectVariable):
    ...
    def getattr_helper(self, tx: InstructionTranslator, field: str, name_vt: VariableTracker) -> VariableTracker | None:
        ...

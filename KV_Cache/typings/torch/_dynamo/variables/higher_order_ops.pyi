...
class SubgraphTracingInfo:
    ...
    """
    side_effect_stack: traceback.StackSummary | None = ...
...
def add_call_function(tx: InstructionTranslator, fn: Any, args: tuple[Any, ...], kwargs: dict[str, Any], flat_example_value: Any, config: NestedCompileRegionOptions | None = ...) -> VariableTracker:
    ...
...
def speculate_subgraph_with_auto_output_flattening(tx: InstructionTranslator, f: VariableTracker, sub_args: Sequence[VariableTracker], sub_kwargs: dict[str, VariableTracker] | None, description: str, *, source_target: HigherOrderOperator | None = ..., enable_grad: bool | None = ..., set_subgraph_inputs: Literal["automatic", "automatic_with_forced_inputs", "flatten_manual", "manual"] = ..., allow_side_effects: bool = ..., filter_aliased_intermediates: bool = ..., supports_input_mutation: bool = ..., supports_aliasing: bool = ..., tracer: Optional[SubgraphTracer] = ...) -> tuple[VariableTracker, torch.fx.Graph, dict[torch.fx.Proxy, torch.fx.Proxy], VariableTracker | tuple[VariableTracker, ...], SubgraphTracingInfo,]:
    """
...
class WrapHigherOrderVariable(TorchHigherOrderOperatorVariable):
    ...
    def create_wrapped_node(self, tx: InstructionTranslator, fn_vt: VariableTracker, fn_args_vt: Sequence[VariableTracker], kwargs: dict[str, VariableTracker], description: str, *, subgraph_name: str = ...) -> tuple[tuple[Proxy, ...], dict[str, VariableTracker], Any, VariableTracker, GraphModule, str, VariableTracker | tuple[VariableTracker, ...], SubgraphTracingInfo,]:
        ...
...
class FlexAttentionBackwardHighOrderVariable(TorchHigherOrderOperatorVariable):
    ...
    def create_wrapped_node(self, tx: InstructionTranslator, query: VariableTracker, fn: VariableTracker, fn_name: str, other_buffers: Sequence[VariableTracker]) -> tuple[Proxy, tuple[Proxy, ...], torch.fx.GraphModule]:
        ...

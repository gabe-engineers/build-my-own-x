...
class TorchScriptObjectVariable(UserDefinedObjectVariable):
    ...
    @staticmethod
    def create(proxy: Proxy, value: Any, ctor_args_kwargs: Any = ..., ctor_arg_sources: tuple[Source | None, ...] | None = ..., **options: Any) -> TorchScriptObjectVariable:
        ...
    
    def __init__(self, proxy: Proxy, value: Any, ctor_args_kwargs: Any = ..., source: Source | None = ..., ctor_arg_sources: tuple[Source | None, ...] | None = ..., **kwargs: Any) -> None:
        ...

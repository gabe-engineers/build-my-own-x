...
class OptimizerVariable(UserDefinedObjectVariable):
    _nonvar_fields = ...
    def __init__(self, value: torch.optim.Optimizer, grad_to_source: dict[Any, GradSource] | None = ..., static_tensor_names: set[str] | None = ..., tensor_to_source: dict[torch.Tensor, Source] | None = ..., **kwargs: Any) -> None:
        ...

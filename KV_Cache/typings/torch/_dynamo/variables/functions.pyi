...
class BaseUserFunctionVariable(VariableTracker):
    def __init__(self, dict_vt: DunderDictVariable | None = ..., **kwargs: Any) -> None:
        ...
    ...
    def var_getattr(self, tx: InstructionTranslator, name: str): # -> VariableTracker | DunderDictVariable:
        ...
...
class NestedUserFunctionVariable(BaseUserFunctionVariable):
    _nonvar_fields = ...
    def __init__(self, fn_name: VariableTracker, code: VariableTracker, f_globals: dict[str, Any], defaults: VariableTracker | None, kwdefaults: VariableTracker | None, closure: VariableTracker | None, wrapped_fn: VariableTracker | None = ..., **kwargs: Any) -> None:
        ...
...
def emit_noargs_leaf_function_to_graph(tx: InstructionTranslator, real_impl: Callable[[], None], name: str) -> None:

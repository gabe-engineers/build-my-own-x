...
def fake_crossref_boxed_nop(fx_g: torch.fx.GraphModule, example_inputs: list[torch.Tensor], ignore_op_fn: Callable[[torch._ops.OpOverload], bool] | None = ...) -> Callable[..., Any]:
    ...
...
def aot_eager(gm: torch.fx.GraphModule, fake_tensor_inputs: list[torch.Tensor], fw_compiler: Callable[..., Any] | None = ..., bw_compiler: Callable[..., Any] | None = ..., **kwargs: Any) -> Callable[..., Any]:
    ...

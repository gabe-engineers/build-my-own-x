...
def generate_dynamo_fx_repro_string(gm: torch.fx.GraphModule, args: Sequence[Any], compiler_name: str | None, check_accuracy: bool = ..., *, stable_output: bool = ..., save_dir: str | None = ..., command: str = ...) -> str:
    """
    Generate a repro string for backend-agnostic minified version.
    """
    ...

def dump_backend_repro_as_file(gm: torch.fx.GraphModule, args: Sequence[Any], compiler_name: str | None, check_accuracy: bool = ...) -> None:
    """
    Saves the repro to a repro.py file
    """
    ...

def dump_backend_state(gm: torch.fx.GraphModule, args: Sequence[Any], compiler_name: str | None, check_accuracy: bool = ...) -> None:
    """
...
def dynamo_minifier_backend(gm: fx.GraphModule, example_inputs: Sequence[Any], compiler_name: str | None) -> fx.GraphModule:
    ...

@register_debug_backend
def dynamo_accuracy_minifier_backend(gm: fx.GraphModule, example_inputs: Sequence[Any], compiler_name: str | None) -> fx.GraphModule:
    ...
...
def run_repro(mod: torch.nn.Module, load_args: Any, *, command: str = ..., accuracy: bool | str = ..., save_dir: str | None = ..., autocast: bool = ..., backend: str = ..., **kwargs: Any) -> None:
    ...

...
class AutogradCompilerInstance:
    ...
    def begin_capture(self, inputs: list[torch.Tensor], sizes: list[int], scalars: list[IntLikeType | FloatLikeType], origins: list[list[tuple[int, str]]], accumulate_grad: bool, check_nans: bool) -> tuple[str, list[torch.Tensor], list[IntLikeType], list[FloatLikeType]]:
        ...
    
    def log_compile_reasons(self, compile_reasons: list[str]) -> None:
        ...
    
    def proxy_call_aot_backward(self, pinputs: Sequence[Any], psaved_tensors: Sequence[torch.Tensor], saved_tensors: Sequence[torch.Tensor], pctx: Any, ctx: Any, maybe_backward_state_idx: int | None, opaque_object_indices: list[int]) -> Sequence[Any]:
        ...
    
    def proxy_call_backward(self, inputs: Sequence[Any], output_metadatas: Sequence[Any], saved_tensors: Sequence[torch.Tensor], backward_idx: int, ctx: torch.autograd.function.BackwardCFunction, maybe_backward_state_idx: int | None, opaque_object_indices: list[int]) -> tuple[torch.Tensor | None, ...]:
        ...
    ...
    def bind_objects_to_proxies(self, objects: Sequence[Any], proxies: Any, origins: list[tuple[int, str]] | None = ...) -> Sequence[Any]:
        ...
...
def copy_slices_epilogue(needs_input_grad: Sequence[bool], result: torch.Tensor, res: Sequence[torch.Tensor | None], grad_slice: torch.Tensor) -> list[torch.Tensor | None]:
    ...

...
if sys.version_info >= (3, 12):
    ...
    ...
def create_instruction(name: str, *, arg: int | None = ..., argval: Any | None = ..., target: Instruction | None = ...) -> Instruction:
    """
...
def fix_vars(instructions: list[Instruction], code_options: dict[str, Any], varname_from_oparg: Callable[..., Any] | None = ...) -> None:
    ...
...
def bytecode_from_template(fn: Callable[..., Any], varname_map: Mapping[Any, Any] | None = ..., noreturn: bool = ..., noprefix: bool = ...) -> list[Instruction]:

...
class Graph(_acceleratorGraph):
    ...
    Example::
        ...
        >>> graph.replay()
    """
    def __new__(cls, keep_graph: bool = ..., *, pool: tuple[int, int] | None = ..., capture_error_mode: Literal["default", "global", "thread_local", "relaxed"] = ...) -> Self:
        ...
    
    def __init__(self, keep_graph: bool = ..., *, pool: tuple[int, int] | None = ..., capture_error_mode: Literal["default", "global", "thread_local", "relaxed"] = ...) -> None:
        ...

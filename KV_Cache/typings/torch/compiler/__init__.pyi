...
def set_stance(stance: str = ..., *, skip_guard_eval_unsafe: bool = ..., force_backend: str | Callable[..., Any] | None = ...): # -> set_stance:
    """
...
_is_non_strict_tracing_flag: bool = ...
...
def nested_compile_region(fn=..., *, options: NestedCompileRegionOptions | None = ..., max_reuse_entries: int = ..., reuse_hash_fn=...): # -> Callable[..., Any] | Callable[..., Callable[..., Any]]:
    """

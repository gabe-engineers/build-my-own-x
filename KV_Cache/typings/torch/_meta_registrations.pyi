...
def meta_philox_key_fold_in(key, data): # -> Tensor:
    ...

@register_meta(aten._philox_normal_.default)
def meta_philox_normal_(self, key, mean=..., std=...):
    ...

@register_meta(aten._philox_uniform_.default)
def meta_philox_uniform_(self, key, low=..., high=...):
    ...

@register_meta([aten._fft_c2r.default, aten._fft_c2r.out])
@out_wrapper()
def meta_fft_c2r(self: Tensor, dim: list[int], normalization: int, lastdim: int): # -> Tensor:
    ...
...
def meta_quantize_per_tensor(input: torch.Tensor, scale: float, zero_point: int, dtype: torch.dtype) -> torch.Tensor:
    ...
...
def meta__scaled_dot_product_fused_attention_overrideable_backward(grad_out: Tensor, query: Tensor, key: Tensor, value: Tensor, attn_bias: Tensor, grad_input_mask: list[bool], out: Tensor, logsumexp: Tensor, cum_seq_q: Tensor, cum_seq_k: Tensor, max_q: int, max_k: int, dropout_p: float, is_causal: bool, philox_seed: Tensor, philox_offset: Tensor, *, scale: float | None = ...): # -> tuple[Tensor, Tensor, Tensor, Tensor | None]:
    ...
...
def meta__scaled_dot_product_attention_math_for_mps(query: Tensor, key: Tensor, value: Tensor, attn_mask: Tensor | None = ..., dropout_p: float = ..., is_causal: bool = ..., dropout_mask: Tensor | None = ..., scale: float | None = ..., enable_gqa: bool = ...) -> tuple[Tensor, Tensor]:
    ...
...
def meta__flash_attention_forward(query: Tensor, key: Tensor, value: Tensor, cum_seq_q: Tensor | None, cum_seq_k: Tensor | None, max_q: int, max_k: int, dropout_p: float, is_causal: bool, return_debug_mask: bool, scale: float | None = ..., window_size_left: int | None = ..., window_size_right: int | None = ..., seqused_k: Tensor | None = ..., alibi_slopes: Tensor | None = ..., block_table: Tensor | None = ..., num_splits: int | None = ...): # -> tuple[Tensor, Tensor, Tensor, Tensor, Tensor]:
    ...

@register_meta([aten._flash_attention_forward_no_dropout_inplace.default])
def meta__flash_attention_forward_no_dropout_inplace(out: Tensor, query: Tensor, key: Tensor, value: Tensor, cum_seq_q: Tensor | None, cum_seq_k: Tensor | None, max_q: int, max_k: int, dropout_p: float, is_causal: bool, return_debug_mask: bool, scale: float | None = ..., window_size_left: int | None = ..., window_size_right: int | None = ..., seqused_k: Tensor | None = ..., alibi_slopes: Tensor | None = ..., block_table: Tensor | None = ..., num_splits: int | None = ...): # -> Tensor:
    ...
...
@register_meta([aten._upsample_bilinear2d_aa.default, aten._upsample_bicubic2d_aa.default, aten._upsample_lanczos2d_aa.default])
def meta_upsample_bimode2d_aa(input, output_size, align_corners, scales_h=..., scales_w=...):
    ...

@register_meta([aten._upsample_bilinear2d_aa_backward.default, aten._upsample_lanczos2d_aa_backward.default])

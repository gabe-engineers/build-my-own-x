...
def register_multi_grad_hook(tensors: Sequence[torch.Tensor], fn: Callable[[Sequence[torch.Tensor | None]], None] | Callable[[torch.Tensor], None], *, mode: Literal["all", "any"] = ...) -> RemovableHandle:
...
class _CloneArgBeforeMutateMode(TorchDispatchMode):
    ...
    def __torch_dispatch__(self, func: OpOverload, types: Iterable[type], args: tuple[Any, ...] = ..., kwargs: dict[Any, Any] | None = ...) -> Any:
        ...

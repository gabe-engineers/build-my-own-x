...
__all__ = ["EventList", "EventMetadata", "FormattedTimesMixin", "Interval", "Kernel", "FunctionEvent", "FunctionEventAvg", "StringTable", "MemRecordsAcc"]
...
class FunctionEvent(FormattedTimesMixin):
    ...
    """
    def __init__(self, id, name, thread, start_us, end_us, overload_name=..., fwd_thread=..., input_shapes=..., stack=..., scope=..., use_device=..., cpu_memory_usage=..., device_memory_usage=..., is_async=..., is_remote=..., sequence_nr=..., node_id=..., device_type=..., device_index=..., device_resource_id=..., is_legacy=..., flops=..., trace_name=..., concrete_inputs=..., kwinputs=..., is_user_annotation=..., is_python_function=..., activity_type=..., metadata_json=..., flow_id=..., flow_type=..., flow_start=..., external_id=..., linked_correlation_id=..., extra_meta=..., structured_input_shapes=..., structured_input_strides=..., input_dtypes=..., python_id=..., python_parent_id=..., python_module_id=...) -> None:
        ...
    ...
    @property
    @deprecated("`metadata_json` is deprecated. Use `event_metadata` instead.", category=FutureWarning)
    def metadata_json(self): # -> None:
        ...

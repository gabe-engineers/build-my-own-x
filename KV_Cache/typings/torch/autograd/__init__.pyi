...
def backward(tensors: _TensorOrTensorsOrGradEdge, grad_tensors: _TensorOrOptionalTensors | None = ..., retain_graph: bool | None = ..., create_graph: bool = ..., grad_variables: _TensorOrOptionalTensors | None = ..., inputs: _TensorOrTensorsOrGradEdge | None = ...) -> None:
...
def grad(outputs: _TensorOrTensorsOrGradEdge, inputs: _TensorOrTensorsOrGradEdge, grad_outputs: _TensorOrOptionalTensors | None = ..., retain_graph: bool | None = ..., create_graph: bool = ..., only_inputs: bool = ..., allow_unused: bool | None = ..., is_grads_batched: bool = ..., materialize_grads: bool = ...) -> tuple[torch.Tensor, ...]:

...
class profile(_KinetoProfile):
    ...
    """
    def __init__(self, *, activities: Iterable[ProfilerActivity | dict[ProfilerActivity, list[str]]] | None = ..., schedule: Callable[[int], ProfilerAction] | None = ..., on_trace_ready: Callable[..., Any] | None = ..., record_shapes: bool = ..., profile_memory: bool = ..., with_stack: bool = ..., with_flops: bool = ..., with_modules: bool = ..., experimental_config: _ExperimentalConfig | None = ..., execution_trace_observer: _ITraceObserver | None = ..., acc_events: bool = ..., use_cuda: bool | None = ..., custom_trace_id_callback: Callable[[], str] | None = ..., post_processing_timeout_s: float | None = ...) -> None:
        ...

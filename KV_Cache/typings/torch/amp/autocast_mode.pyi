...
class autocast:
    ...
    Args:
        ...
        cache_enabled(bool, optional):  Whether the weight cache inside autocast should be enabled.
            Default: ``True``
    """
    def __init__(self, device_type: str, dtype: _dtype | None = ..., enabled: bool = ..., cache_enabled: bool | None = ...) -> None:
        ...
    ...
    def __call__(self, func): # -> _Wrapped[Callable[..., Any], object, Callable[..., Any], object]:
        ...
...
def custom_fwd(fwd=..., *, device_type: str, cast_inputs: _dtype | None = ...): # -> partial[Any] | _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any]:
    """

...
log_state = ...
DEFAULT_LOGGING = ...
def set_logs(*, all: int | None = ..., dynamo: int | None = ..., aot: int | None = ..., autograd: int | None = ..., dynamic: int | None = ..., inductor: int | None = ..., distributed: int | None = ..., c10d: int | None = ..., ddp: int | None = ..., fsdp: int | None = ..., dtensor: int | None = ..., onnx: int | None = ..., bytecode: bool = ..., aot_graphs: bool = ..., aot_joint_graph: bool = ..., ddp_graphs: bool = ..., graph: bool = ..., graph_code: bool = ..., graph_code_verbose: bool = ..., graph_breaks: bool = ..., side_effects: bool = ..., graph_sizes: bool = ..., guards: bool = ..., recompiles: bool = ..., recompiles_verbose: bool = ..., trace_source: bool = ..., trace_call: bool = ..., trace_bytecode: bool = ..., output_code: bool = ..., kernel_code: bool = ..., schedule: bool = ..., perf_hints: bool = ..., pre_grad_graphs: bool = ..., post_grad_graphs: bool = ..., ir_pre_fusion: bool = ..., ir_post_fusion: bool = ..., onnx_diagnostics: bool = ..., fusion: bool = ..., overlap: bool = ..., export: int | None = ..., modules: dict[str, int | bool] | None = ..., cudagraphs: bool = ..., sym_node: bool = ..., compiled_autograd: bool = ..., compiled_autograd_verbose: bool = ..., cudagraph_static_inputs: bool = ..., benchmarking: bool = ..., autotuning: bool = ..., graph_region_expansion: bool = ..., inductor_metrics: bool = ..., hierarchical_compile: bool = ..., compute_dependencies: bool = ..., caching: bool = ...) -> None:
    """
...
def trace_structured_artifact(name: str, encoding: str, payload_fn: Callable[[], str | object | None] = ..., compile_id: CompileId | None = ...) -> None:
    ...

def trace_structured(name: str, metadata_fn: Callable[[], dict[str, Any] | tuple[str, int]] = ..., *, payload_fn: Callable[[], str | object | None] = ..., suppress_context: bool = ..., expect_trace_id: bool = ..., record_logging_overhead: bool = ..., compile_id: CompileId | None = ...) -> None:
    """
...
def dtrace_structured(name: str, metadata_fn: Callable[[], dict[str, Any] | tuple[str, int]] = ..., *, payload_fn: Callable[[], str | object | None] = ..., suppress_context: bool = ..., expect_trace_id: bool = ..., record_logging_overhead: bool = ...) -> None:
    """

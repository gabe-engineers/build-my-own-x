...
from typing import Any, ClassVar, Generic, NewType, Protocol, TYPE_CHECKING, TypeGuard, TypeVar
...
def assert_metadata_eq(assert_eq: Callable[[object, object], None], m1: MetaTensorDesc[Any] | torch.Tensor, m2: torch.Tensor, *, skip_symbolic: bool = ..., skip_leaf: bool = ...) -> None:
    ...
...
class ViewFunc(Generic[_TensorT]):
    @abstractmethod
    def apply(self, t: _TensorT, new_base: _TensorT, symint_visitor_fn: Callable[[int], int] | None = ..., tensor_visitor_fn: Callable[[torch.Tensor], _TensorT] | None = ...) -> _TensorT:
        ...
...
class _FakeTensorViewFunc(ViewFunc["FakeTensor"]):
    @override
    def apply(self, t: torch.Tensor, new_base: torch.Tensor, symint_visitor_fn: Callable[[int], int] | None = ..., tensor_visitor_fn: Callable[[torch.Tensor], FakeTensor] | None = ...) -> FakeTensor:
        ...
...
class _CustomViewFunc(ViewFunc[_TensorT], Generic[_TensorT]):
    ...
    @override
    def apply(self, t: torch.Tensor, new_base: torch.Tensor, symint_visitor_fn: Callable[[int], int] | None = ..., tensor_visitor_fn: Callable[[torch.Tensor], _TensorT] | None = ...) -> _TensorT:
        ...
...
class MetaTensorDesc(Generic[_TensorT]):
    ...
    crow_indices: MetaTensorDesc[Any] | None = ...
    col_indices: MetaTensorDesc[Any] | None = ...
    ccol_indices: MetaTensorDesc[Any] | None = ...
    row_indices: MetaTensorDesc[Any] | None = ...
    values: MetaTensorDesc[Any] | None = ...
    unwrapped: MetaTensorDesc[Any] | None = ...
    bdim: int | None = ...
    base: MetaTensorDesc[Any] | None = ...
    attrs: dict[str, MetaTensorDesc[Any]] | None = ...
    opaque_attrs: dict[str, OpaqueBase] | None = ...
    creation_meta: CreationMeta | None = ...
    grad: MetaTensorDesc[Any] | None = ...
    _UNSERIALIZABLE: ClassVar[set[str]] = ...
    ctx: object | None = ...
    type: type | None = ...
    fake_mode: FakeTensorMode | None = ...
    view_func: ViewFunc[Any] | None = ...
    level: int | None = ...
...
class MetaConverter(Generic[_TensorT]):
    ...
    def meta_tensor(self, t: MetaTensorDesc[Any], shape_env: ShapeEnv | None, callback_: _MetaTensorCallback[_TensorT], source: Source | None, symbolic_context: SymbolicContext | None) -> _TensorT:
        ...
    
    def __call__(self, t: torch.Tensor, shape_env: ShapeEnv | None = ..., *, callback: _MetaTensorCallback[_TensorT] | None = ..., source: Source | None = ..., symbolic_context: SymbolicContext | None = ..., trace: bool = ...) -> _TensorT:
        ...

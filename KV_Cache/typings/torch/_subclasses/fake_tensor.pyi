...
def get_plain_tensors(subclass: Tensor, *, out: list[Tensor | int | SymInt | OpaqueBase]) -> list[Tensor | int | SymInt | OpaqueBase]:
    ...
...
class FakeTensorConverter:
    ...
    def from_real_tensor(self, fake_mode: FakeTensorMode, t: Tensor, make_constant: bool = ..., shape_env: ShapeEnv | None = ..., *, source: Source | None = ..., symbolic_context: SymbolicContext | None = ..., trace: bool = ...) -> FakeTensor:
        ...
    
    def from_meta_and_device(self, fake_mode: FakeTensorMode, t: Tensor, device: torch.device, pytype: type[torch.Tensor] | None = ..., dispatch_keys: torch.DispatchKeySet | None = ...) -> FakeTensor:
        ...
...
class SymNumberMemoDescriptor:
    ...
    def __get__(self, obj: FakeTensor, objtype: type[FakeTensor] | None = ...) -> torch.SymInt | torch.SymFloat | None:
        ...
    
    def __set__(self, obj: FakeTensor, value: torch.SymInt | torch.SymFloat | torch.SymBool | int | float | None) -> None:
        ...
...
class FakeTensor(Tensor):
    ...
    @staticmethod
    def __new__(cls, fake_mode: FakeTensorMode, elem: Tensor, device: torch.device, constant: Tensor | None = ..., real_tensor: Tensor | None = ..., pytype: type[Tensor] | None = ..., dispatch_keys: torch.DispatchKeySet | None = ...) -> Self:
        ...
...
class FakeTensorMode(TorchDispatchMode):
    ...
    def __init__(self, *, allow_fallback_kernels: bool = ..., allow_non_fake_inputs: bool = ..., shape_env: ShapeEnv | None = ..., static_shapes: bool | None = ..., export: bool = ...) -> None:
        ...
    ...
    def create_symbolic_nested_int(self, *, nt_tensor_id: int | None = ...) -> IntLikeType:
        ...
    ...
    def from_tensor(self, tensor: Tensor, *, static_shapes: bool | None = ..., source: Source | None = ..., symbolic_context: SymbolicContext | None = ..., trace: bool = ...) -> FakeTensor:
        ...
...
class FakeCopyMode(TorchFunctionMode):
    ...
    def __torch_function__(self, func: OpOverload, types: Sequence[type], args: Sequence[object] = ..., kwargs: Mapping[str, object] | None = ...) -> FakeTensor:
        ...

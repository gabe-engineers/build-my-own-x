...
from typing import Any as _Any, TYPE_CHECKING, TypeGuard as _TypeGuard, TypeVar as _TypeVar, get_origin as _get_origin, overload as _overload
...
from torch.random import get_rng_state, initial_seed, manual_seed, seed, set_rng_state, thread_safe_generator
from torch.serialization import load, save
from torch._C._VariableFunctions import empty as empty
...
class SymInt:
    ...
    def __truediv__(self, other): # -> SymFloat | NotImplementedType:
        ...
    
    def __rtruediv__(self, other): # -> SymFloat | NotImplementedType:
        ...
    
    def __floordiv__(self, other): # -> SymFloat | float | NotImplementedType:
        ...
    
    def __rfloordiv__(self, other): # -> SymFloat | float | NotImplementedType:
        ...
    
    def __pow__(self, other): # -> NotImplementedType | SymFloat | SymInt:
        ...
    
    def __rpow__(self, other): # -> NotImplementedType | SymFloat | SymInt:
        ...
...
class SymFloat:
    ...
    def __floordiv__(self, other): # -> NotImplementedType | SymFloat | float:
        ...
    
    def __rfloordiv__(self, other): # -> NotImplementedType | SymFloat | float:
        ...
...
class SymBool:
    ...
    def __sym_float__(self): # -> SymInt | SymFloat | SymBool | int | float | bool:
        """
...
def sym_float(a): # -> SymFloat | float:
...
def sym_min(a, b): # -> float:
    """SymInt-aware utility for min()."""
    ...

def sym_sum(*args): # -> int | SymInt | SymFloat | SymBool | float | bool:
    """
...
class _TorchCompileInductorWrapper:
    ...
    def __call__(self, model_, inputs_, *, config_patches=...): # -> CompileFxOutput:
        ...
...
@_overload
def compile(model: _Callable[_InputT, _RetT], *, fullgraph: builtins.bool = ..., dynamic: builtins.bool | None = ..., backend: str | _Callable = ..., mode: str | None = ..., options: dict[str, str | builtins.int | builtins.bool | _Callable] | None = ..., name: str | None = ..., disable: builtins.bool = ...) -> _Callable[_InputT, _RetT]:
    ...

@_overload
def compile(model: None = ..., *, fullgraph: builtins.bool = ..., dynamic: builtins.bool | None = ..., backend: str | _Callable = ..., mode: str | None = ..., options: dict[str, str | builtins.int | builtins.bool | _Callable] | None = ..., name: str | None = ..., disable: builtins.bool = ...) -> _Callable[[_Callable[_InputT, _RetT]], _Callable[_InputT, _RetT]]:
    ...

def compile(model: _Callable[_InputT, _RetT] | None = ..., *, fullgraph: builtins.bool = ..., dynamic: builtins.bool | None = ..., backend: str | _Callable = ..., mode: str | None = ..., options: dict[str, str | builtins.int | builtins.bool | _Callable] | None = ..., name: str | None = ..., disable: builtins.bool = ..., recompile_limit: builtins.int | None = ...) -> (_Callable[[_Callable[_InputT, _RetT]], _Callable[_InputT, _RetT]] | _Callable[_InputT, _RetT]):
    """

...
def aot_compile(f: Callable, args: tuple[Any, ...], kwargs: dict[str, Any] | None = ..., *, dynamic_shapes: dict[str, Any] | None = ..., options: dict[str, Any] | None = ..., remove_runtime_assertions: bool = ..., disable_constraint_solver: bool = ..., same_signature: bool = ...) -> list[Any] | str:
    """

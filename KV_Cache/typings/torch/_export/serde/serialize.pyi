...
def deserialize_torch_artifact(serialized: dict[str, Any] | tuple[Any, ...] | bytes): # -> dict[str, Any] | tuple[Any, ...] | dict[Any, Any]:
    ...
...
def get_triton_kernel_and_cache_entry(node: torch.fx.Node): # -> tuple[Any, Any]:
    ...
...
class ExportedProgramSerializer(metaclass=Final):
    ...
    def serialize(self, exported_program: ep.ExportedProgram, *, serialize_state_dict: bool = ..., serialize_constants: bool = ..., serialize_example_inputs: bool = ...) -> _SerializedProgram:
        """
        Args:
...
class GraphModuleDeserializer(metaclass=Final):
    ...
    def deserialize(self, serialized_graph_module: GraphModule, serialized_state_dict: dict[str, torch.Tensor] | bytes, constants: dict[str, Any] | bytes, example_inputs: tuple[tuple[torch.Tensor, ...], dict[str, Any]] | bytes | None = ..., symbol_name_to_range: dict[str, symbolic_shapes.ValueRanges] | None = ...) -> Result:
        ...
    ...
    def generate_getitem(self, meta_val, fx_node: torch.fx.Node, arg: TensorArgument | SymIntArgument | SymFloatArgument, idx: int, deserialized_metadata: dict[str, Any]): # -> None:
        ...
...
class ExportedProgramDeserializer(metaclass=Final):
    ...
    def deserialize(self, exported_program: ExportedProgram, state_dict: dict[str, torch.Tensor] | bytes, constants: dict[str, torch.Tensor] | bytes, example_inputs: tuple[tuple[torch.Tensor, ...], dict[str, Any]] | bytes | None = ..., *, _unsafe_skip_version_check=...) -> ep.ExportedProgram:
        ...
...
def serialize(exported_program: ep.ExportedProgram, opset_version: dict[str, int] | None = ..., pickle_protocol: int = ..., *, serialize_state_dict: bool = ..., serialize_constants: bool = ..., serialize_example_inputs: bool = ...) -> SerializedArtifact:
    ...

def deserialize(artifact: SerializedArtifact, expected_opset_version: dict[str, int] | None = ..., *, _unsafe_skip_version_check=...) -> ep.ExportedProgram:
    ...

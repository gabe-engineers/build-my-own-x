...
from torch.utils._pytree import FlattenFn, FromDumpableContextFn, KeyPath, ToDumpableContextFn, UnflattenFn
...
def register_dataclass_as_pytree_node(cls: type[Any], flatten_fn: FlattenFn | None = ..., unflatten_fn: UnflattenFn | None = ..., *, serialized_type_name: str | None = ..., to_dumpable_context: ToDumpableContextFn | None = ..., from_dumpable_context: FromDumpableContextFn | None = ..., return_none_fields: bool = ...) -> None:
    ...
